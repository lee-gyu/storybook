...
document.querySelector('.button--outline').addEventListener('click', () => {
    document.querySelector('.menu').classList.add('is-visible');
        ...
        \`} />\r
    </Doc>`,...(o=(n=i.parameters)==null?void 0:n.docs)==null?void 0:o.source}}};const _=["Trigger"];export{i as Trigger,_ as __namedExportsOrder,d as default};
