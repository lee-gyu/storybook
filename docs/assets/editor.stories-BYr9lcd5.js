import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{D as t,a as e,L as r}from"./version-tag-DYWb7goF.js";import"./iframe-MfDS26RN.js";import"./index-BoKU7Xug.js";const o=`import { IREditor } from "@innorules/ir-style/lib/esm/editor.js";
...
`;function O(){return n.jsxs(t,{children:[n.jsx(e,{children:"IREditor"}),n.jsxs("p",{children:[n.jsx("code",{children:"getSearchCursor"}),"를 검색 기능을 이용합니다."]}),n.jsx(r,{css:w,htmlRaw:I,code:T})]})}O.__docgenInfo={description:"",methods:[],displayName:"Search"};const B={title:"JS Components/IREditor"},N=["Basic","DBRule","HandlingCursor","KeyEvents","LineGutter","RuleSyntax","Search"];export{c as Basic,u as DBRule,h as HandlingCursor,g as KeyEvents,S as LineGutter,j as RuleSyntax,O as Search,N as __namedExportsOrder,B as default};
