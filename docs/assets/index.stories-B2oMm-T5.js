import{j as n}from"./jsx-runtime-Y5Ju2SGo.js";import{D as e,a as t,L as a}from"./version-tag-D9L4qBs8.js";import"./index-eCxJ45ll.js";const o=`import { downloadDataURL, createLoadingHandler } from "@innorules/ir-style";
...
function createBulkData( rowCnt, colCnt, styles = true )
{
    ...
    return arrData;
}`;function u(){return n.jsxs(e,{children:[n.jsx(t,{children:"엑셀 메인 스레드에서 호출(리소스 프로파일링용)"}),n.jsx(a,{fixedHeight:150,html:n.jsx(n.Fragment,{children:n.jsxs("div",{id:"btn_container",className:"flex mb--lg gap-x--lg gap-y--lg flex--wrap",children:[n.jsx("button",{className:"button",id:"btn_export1",children:"셀별 Style (느림)"}),n.jsx("button",{className:"button",id:"btn_export2",children:"컬럼별 Style"}),n.jsx("button",{className:"button",id:"btn_export3",children:"No Style"})]})}),code:g})]})}u.__docgenInfo={description:"",methods:[],displayName:"PerformanceProfile"};const p={title:"Data Exporting/Excel"},f=["AutoFit","Basic","Merge","MultipleSheets","PerformanceProfile"];export{l as AutoFit,i as Basic,c as Merge,m as MultipleSheets,u as PerformanceProfile,f as __namedExportsOrder,p as default};
