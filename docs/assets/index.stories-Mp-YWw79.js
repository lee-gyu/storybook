import{j as n}from"./jsx-runtime-u17CrQMm.js";import{D as r,a as t,c as o,L as e}from"./version-tag-DqccibA3.js";import"./iframe-D3tc5L3-.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DQMUxHhF.js";const a=`import { createLoadingHandler } from "@innorules/ir-style";\r
\r
...
</div>`,s=[["/functions/_innorules_ir-style.dataExport.requestExportingData.html","requestExportingData"],["/functions/_innorules_ir-style.index.downloadDataURL.html","downloadDataURL"],["/variables/_innorules_ir-style.index.createLoadingHandler.html","createLoadingHandler"]];function c(){return n.jsxs(r,{children:[n.jsx(t,{children:"Data Exporting"}),n.jsx("p",{children:"excel auto-fit 예제"}),n.jsx(o,{docList:s}),n.jsx(e,{fixedHeight:150,htmlRaw:i,code:a,exampleCode:l})]})}c.__docgenInfo={description:"",methods:[],displayName:"AutoFit"};const d=`\r
const commonStyle = {\r
    border: {\r
        top: {\r
            style: "thin",\r
...
</div>`,g=[["/functions/_innorules_ir-style.dataExport.requestExportingData.html","requestExportingData"],["/functions/_innorules_ir-style.index.downloadDataURL.html","downloadDataURL"],["/variables/_innorules_ir-style.index.createLoadingHandler.html","createLoadingHandler"]];function x(){return n.jsxs(r,{children:[n.jsx(t,{children:"Data Exporting"}),n.jsx("p",{children:"excel 예제"}),n.jsx(o,{docList:g}),n.jsx(e,{fixedHeight:150,htmlRaw:m,code:d,exampleCode:u})]})}x.__docgenInfo={description:"",methods:[],displayName:"Basic"};const b=`import { createLoadingHandler } from "@innorules/ir-style";\r
\r
async function setLoading( fn )\r
{\r
    const loading = createLoadingHandler( {\r
...
};`,h=`<div id="btn_container" class="flex mb--lg gap-x--lg gap-y--lg flex--wrap">\r
    <button class="button" id="btn_export">병합된 셀 처리</button>\r
</div>`,f=[["/functions/_innorules_ir-style.dataExport.requestExportingData.html","requestExportingData"],["/functions/_innorules_ir-style.index.downloadDataURL.html","downloadDataURL"],["/variables/_innorules_ir-style.index.createLoadingHandler.html","createLoadingHandler"]];function y(){return n.jsxs(r,{children:[n.jsx(t,{children:"Data Exporting"}),n.jsx("p",{children:"셀 병합 예제"}),n.jsx(o,{docList:f}),n.jsx(e,{fixedHeight:150,htmlRaw:h,code:b,exampleCode:p})]})}y.__docgenInfo={description:"",methods:[],displayName:"CellMerge"};const L=`import { createLoadingHandler } from "@innorules/ir-style";\r
\r
async function setLoading( fn )\r
{\r
    const loading = createLoadingHandler( {\r
...
</div>`,A=[["/functions/_innorules_ir-style.dataExport.requestExportingData.html","requestExportingData"],["/functions/_innorules_ir-style.index.downloadDataURL.html","downloadDataURL"],["/variables/_innorules_ir-style.index.createLoadingHandler.html","createLoadingHandler"]];function R(){return n.jsxs(r,{children:[n.jsx(t,{children:"Data Exporting"}),n.jsx("p",{children:"다중 시트 예제"}),n.jsx(o,{docList:A}),n.jsx(e,{fixedHeight:150,htmlRaw:D,code:L,exampleCode:w})]})}R.__docgenInfo={description:"",methods:[],displayName:"MultipleSheets"};const k=`const borderStyle = {\r
    border: {\r
        top: {\r
            style: "thin",\r
            color: { argb: "00000000" },\r
