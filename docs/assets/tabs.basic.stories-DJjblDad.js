import{j as s}from"./jsx-runtime-D_zvdyIk.js";import{D as i,a as c,L as r}from"./version-tag-9vMQgyJG.js";import"./iframe-CKHoihc2.js";import"./index-Dprm-oae.js";const m={title:"HTML Components/Tabs"},o=`
#live_editor_wrapper {
    background: var(--light-active);
}
`,a=()=>s.jsxs(i,{children:[s.jsx(c,{children:"Tabs Basic"}),s.jsx("p",{children:"탭은 다양한 컨텐츠의 전환을 표현합니다."}),s.jsx(r,{css:o,html:s.jsxs("div",{className:"tabs tabs--basic",children:[s.jsxs("div",{className:"tabs__nav",children:[s.jsx("button",{type:"button",className:"tabs__nav-button is-active",children:"First"}),s.jsx("button",{type:"button",className:"tabs__nav-button",children:"Second"}),s.jsx("button",{type:"button",className:"tabs__nav-button",children:"Third"})]}),s.jsxs("div",{className:"tabs__content",children:[s.jsx("div",{className:"tabs__panel is-active",children:"First Panel"}),s.jsx("div",{className:"tabs__panel",children:"Second Panel"}),s.jsx("div",{className:"tabs__panel",children:"Third Panel"})]})]})})]});a.__docgenInfo={description:"",methods:[],displayName:"Basic"};var t,e,n;a.parameters={...a.parameters,docs:{...(t=a.parameters)==null?void 0:t.docs,source:{originalSource:`() => <Doc>\r
    ...
    </Doc>`,...(n=(e=a.parameters)==null?void 0:e.docs)==null?void 0:n.source}}};const v=["Basic"];export{a as Basic,v as __namedExportsOrder,m as default};
