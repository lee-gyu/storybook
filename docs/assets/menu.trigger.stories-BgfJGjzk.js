...
document.querySelector('.button--outline').addEventListener('click', () => {
    document.querySelector('.menu').classList.add('is-visible');
        ...
        \`} />\r
    </Doc>`,...(o=(t=u.parameters)==null?void 0:t.docs)==null?void 0:o.source}}};const b=["Trigger"];export{u as Trigger,b as __namedExportsOrder,_ as default};
