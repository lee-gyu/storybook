import{j as e}from"./jsx-runtime-u17CrQMm.js";import{D as n,a as t,L as i}from"./version-tag-u3GxDBUd.js";import"./iframe-9F64GLpK.js";import"./preload-helper-PPVm8Dsz.js";import"./index-F4J0AwFl.js";const d=`import { IRDatePicker } from "@innorules/ir-style";
...
new IRDatePicker( {
    ...
    format: "MM/DD/YYYY",
} );`,c=`<div id="date_picker" style="width: 300px"></div>
<br />
<div id="date_picker2" style="width: 200px"></div>`;function s(){return e.jsxs(n,{children:[e.jsx(t,{children:"DatePicker"}),e.jsxs("p",{children:[e.jsx("code",{children:"IRDatePicker"})," 컴포넌트를 활용하여 날짜를 선택하는 입력 컨트롤을 표현할 수 있으며 ",e.jsx("code",{children:"format"})," 속성으로 날짜 서식을 지정할 수 있습니다. (기본 값 : YYYY-MM-DD)"]}),e.jsx(i,{fixedHeight:400,htmlRaw:c,code:d})]})}s.__docgenInfo={description:"",methods:[],displayName:"Basic"};const o=`import { IRDatePicker } from "@innorules/ir-style";
