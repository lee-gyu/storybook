import{j as n}from"./jsx-runtime-Y5Ju2SGo.js";import{D as t,a as o,L as e}from"./version-tag-D9L4qBs8.js";import"./index-eCxJ45ll.js";const r=`import { IRVirtualDOM } from "@innorules/ir-style";
...
<div id="virtual_dom"></div>`;function s(){return n.jsxs(t,{children:[n.jsx(o,{children:"IRVirtualDOM"}),n.jsxs("p",{children:[n.jsx("code",{children:"IRVirtualDOM"})," 클래스를 이용하여 bulk 데이터를 표시해야 하는 경우, 브라우저 성능 문제를 최소화 할 수 있습니다."]}),n.jsx(e,{fixedHeight:400,htmlRaw:i,code:r})]})}s.__docgenInfo={description:"",methods:[],displayName:"Basic"};const c={title:"JS Components/IRVirtualDOM"},u=["Basic"];export{s as Basic,u as __namedExportsOrder,c as default};
