...
`})]});b.__docgenInfo={description:"",methods:[],displayName:"Finder"};const p=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsx(i,{html:e.jsx("div",{id:"ir_grid",style:{height:500,width:1300}}),code:`
import * as libGrid from "./dist/grid.js";
...
`})]});p.__docgenInfo={description:"",methods:[],displayName:"Rows2000"};const w=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsx("p",{children:"헤더를 드래그하여 행/열 이동"}),e.jsx(i,{html:e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex mb--lg",style:{alignItems:"center",columnGap:"4px"},children:["source: ",e.jsx("div",{className:"input",style:{display:"inline-block",width:100},children:e.jsx("input",{id:"input_source",className:"input__native"})}),"target: ",e.jsx("div",{className:"input",style:{display:"inline-block",width:100},children:e.jsx("input",{id:"input_target",className:"input__native"})}),e.jsx("button",{type:"button",id:"btn_move_row",className:"button",children:"행 이동"}),e.jsx("button",{type:"button",id:"btn_move_col",className:"button",children:"열 이동"}),e.jsx("button",{type:"button",id:"btn_on",className:"button ml--xl",children:"Row Drag On"}),e.jsx("button",{type:"button",id:"btn_off",className:"button",children:"Row Drag Off"}),e.jsx("button",{type:"button",id:"btn_merge",className:"button ml--xl",children:"셀 병합"}),e.jsx("button",{type:"button",id:"btn_freeze",className:"button",children:"행 고정"}),e.jsx("button",{type:"button",id:"btn_freeze_col",className:"button",children:"열 고정"})]}),e.jsx("div",{id:"ir_grid",style:{height:500,width:800}})]}),code:`
import * as libGrid from "./dist/grid.js";
...
`})]});w.__docgenInfo={description:"",methods:[],displayName:"HeaderMove"};const _=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsx(i,{html:e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
                    .grid-wrapper {
                        height: 600px;
                        display: grid;
                        gap: 8px;
...
`})]});C.__docgenInfo={description:"",methods:[],displayName:"OverflowPanel"};const R=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsx("p",{}),e.jsx(i,{html:e.jsx("div",{id:"ir_grid",style:{height:500,width:1300}}),code:`
import * as libGrid from "./dist/grid.js";
...
`})]});G.__docgenInfo={description:"",methods:[],displayName:"SelectMapping"};const I={title:"JS Components/IRGrid"},S=["APIDemo","Basic","CellRenderer","BulkData","NoHeader","CellDrag","ColumnFill","GridConfig","ContextMenu","CustomRenderer","DragDrop","Exchange","Finder","Rows2000","HeaderMove","Multiple","OverflowPanel","RowSelection","Sort","SortRange","GridOnDialog","SelectMapping"];export{o as APIDemo,l as Basic,d as BulkData,c as CellDrag,n as CellRenderer,a as ColumnFill,u as ContextMenu,m as CustomRenderer,x as DragDrop,h as Exchange,b as Finder,g as GridConfig,v as GridOnDialog,w as HeaderMove,_ as Multiple,s as NoHeader,C as OverflowPanel,R as RowSelection,p as Rows2000,G as SelectMapping,f as Sort,j as SortRange,S as __namedExportsOrder,I as default};
