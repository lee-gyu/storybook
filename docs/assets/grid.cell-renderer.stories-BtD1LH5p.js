import{j as e}from"./jsx-runtime-QvZ8i92b.js";import{D as d,a as o,L as i}from"./doc-content-DCRebTQc.js";import"./index-uubelm5h.js";import"./index-vAxXS4R5.js";const g={title:"JS Components/Grid"},r=()=>e.jsxs(d,{children:[e.jsx(o,{children:"IRGrid"}),e.jsxs("p",{children:[e.jsx("code",{children:"cellRenderer"}),"를 재정의하여 여러 타입의 셀을 출력할 수 있습니다."]}),e.jsx(i,{html:e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"mb--lg",children:e.jsx("button",{id:"btn_check_commands",className:"button",children:"Check commands"})}),e.jsx("div",{id:"ir_grid",style:{height:500,width:1300}})]}),code:`
...
`})]});r.__docgenInfo={description:"",methods:[],displayName:"CellRenderer"};var n,t,l;r.parameters={...r.parameters,docs:{...(n=r.parameters)==null?void 0:n.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(l=(t=r.parameters)==null?void 0:t.docs)==null?void 0:l.source}}};const C=["CellRenderer"];export{r as CellRenderer,C as __namedExportsOrder,g as default};
