import{j as e,a as i,F as t}from"./jsx-runtime-KzWSGvcx.js";import{D as l,a as o,L as s}from"./doc-content-Y1bYfLkc.js";import"./index-DogsOklH.js";import"./index-xS4YNjdq.js";const p={title:"HTML Components/Divider"},d=()=>e(l,{children:[i(o,{children:"Divider Sticky"}),e("p",{children:["sticky를 사용하면 ",i("code",{children:"margin"}),"를 음수값으로 지정하여 여백이 존재하는 부모 컨텐츠에 맞게 설정할 수 있습니다."]}),i("p",{children:i("strong",{children:"사이즈"})}),e("ul",{children:[e("li",{children:[i("code",{children:"xxs"}),": -0.4rem"]}),e("li",{children:[i("code",{children:"xs"}),": -0.6rem"]}),e("li",{children:[i("code",{children:"sm"}),": -0.8rem"]}),e("li",{children:[i("code",{children:"md"}),": -1rem"]}),e("li",{children:[i("code",{children:"lg"}),": -1.2rem"]}),e("li",{children:[i("code",{children:"xl"}),": -1.6rem"]}),e("li",{children:[i("code",{children:"xxl"}),": -2rem"]})]}),i(s,{css:`
