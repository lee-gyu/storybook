import{j as o}from"./jsx-runtime-DEdD30eg.js";import{D as l,a as d,L as a}from"./doc-content-TwLFnQmr.js";import"./index-RYns6xqu.js";const s={title:"JS Components/IRFlowchart"},t=()=>o.jsxs(l,{children:[o.jsx(d,{children:"IRFlowchart"}),o.jsx(a,{html:o.jsxs(o.Fragment,{children:[o.jsxs("div",{style:{marginBottom:8},children:[o.jsx("h3",{children:"오브젝트 추가 API"}),o.jsx("button",{className:"button",id:"btn_add_start",children:"start 노드 추가"}),o.jsx("button",{className:"button",id:"btn_add_if",children:"if 노드 추가"}),o.jsx("button",{className:"button",id:"btn_add_db",children:"db 노드 추가"}),o.jsx("button",{className:"button",id:"btn_add_bridge",children:"bridge 노드 추가"}),o.jsx("button",{className:"button",id:"btn_add_comment",children:"comment 노드 추가"}),o.jsx("button",{className:"button",id:"btn_add_return",children:"return 노드 추가"}),o.jsx("button",{className:"button",id:"btn_add_direct",children:"곧은 연결선 추가"}),o.jsx("button",{className:"button",id:"btn_add_elbow",children:"꺾은 연결선 추가"}),o.jsx("h3",{className:"mt--lg",children:"오브젝트 제어 API"}),o.jsx("button",{className:"button",id:"btn_clear",children:"clear"}),o.jsx("button",{className:"button",id:"btn_remove_selected",children:"선택 개체 제거 (Delete 키)"}),o.jsx("button",{className:"button",id:"btn_group",children:"선택된 개체 그룹"}),o.jsx("button",{className:"button",id:"btn_release_group",children:"그룹 해제"}),o.jsx("button",{className:"button",id:"btn_undo",children:"Undo (Ctrl + Z)"}),o.jsx("button",{className:"button",id:"btn_redo",children:"Redo (Ctrl + Y)"}),o.jsx("button",{className:"button",id:"btn_size_to_fit",children:"컨텐츠에 맞게 크기 조정"}),o.jsx("h3",{className:"mt--lg",children:"배치/정렬 API"}),o.jsx("button",{className:"button",id:"btn_align_left",children:"가로 왼쪽 정렬"}),o.jsx("button",{className:"button",id:"btn_align_center",children:"가로 중앙 정렬"}),o.jsx("button",{className:"button",id:"btn_align_right",children:"가로 오른쪽 정렬"}),o.jsx("button",{className:"button",id:"btn_align_top",children:"세로 위쪽 정렬"}),o.jsx("button",{className:"button",id:"btn_align_middle",children:"세로 중앙 정렬"}),o.jsx("button",{className:"button",id:"btn_align_bottom",children:"세로 아래쪽 정렬"}),o.jsx("button",{className:"button",id:"btn_distribute_horizontal",children:"가로 균등 분배"}),o.jsx("button",{className:"button",id:"btn_distribute_vertical",children:"세로 균등 분배"}),o.jsx("button",{className:"button",id:"btn_bring_to_front",children:"맨 앞으로"}),o.jsx("button",{className:"button",id:"btn_bring_to_back",children:"맨 뒤로"}),o.jsx("h3",{className:"mt--lg",children:"Mode Toggle (on/off)"}),o.jsxs("div",{className:"flex gap-x--lg py--sm",children:[o.jsxs("label",{children:[o.jsx("input",{type:"checkbox",id:"chk_toggle_grid"}),"눈금선"]}),o.jsxs("label",{children:[o.jsx("input",{type:"checkbox",id:"chk_toggle_readonly"}),"읽기 전용"]}),o.jsxs("label",{children:[o.jsx("input",{type:"checkbox",id:"chk_toggle_edit_mode"}),"마우스 상호작용 비활성화"]}),o.jsxs("label",{children:[o.jsx("input",{type:"checkbox",id:"chk_toggle_trace"}),"디버그 모드"]}),o.jsxs("label",{children:[o.jsx("input",{type:"checkbox",id:"chk_toggle_tooltip"}),"툴팁 숨김"]}),o.jsxs("label",{children:[o.jsx("input",{type:"checkbox",id:"chk_toggle_move_screen_on_select"}),"노드 선택 시 스크롤 중앙 이동"]}),o.jsxs("label",{children:[o.jsx("input",{type:"checkbox",id:"chk_toggle_select_node_on_hover"}),"hover 시 노드 선택"]}),o.jsxs("label",{children:[o.jsx("input",{type:"checkbox",id:"chk_toggle_simple_connecting_mode"}),"연결선 최단 거리 자동 설정"]}),o.jsxs("label",{children:[o.jsx("input",{type:"checkbox",id:"chk_toggle_wheel_zoom"}),"Ctrl + Wheel 줌"]}),o.jsxs("label",{children:[o.jsx("input",{type:"checkbox",id:"chk_single_selection"}),"단일 선택 모드"]}),o.jsxs("label",{children:[o.jsx("input",{type:"checkbox",id:"chk_canvas_move"}),"캔버스 이동 모드"]})]})]}),o.jsx("div",{id:"flowchart_div",className:"border",style:{height:550}})]}),code:`
...
`})]});t.__docgenInfo={description:"",methods:[],displayName:"Basic"};var e,n,c;t.parameters={...t.parameters,docs:{...(e=t.parameters)==null?void 0:e.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(c=(n=t.parameters)==null?void 0:n.docs)==null?void 0:c.source}}};const b=["Basic"];export{t as Basic,b as __namedExportsOrder,s as default};
