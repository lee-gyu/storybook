import{j as e}from"./jsx-runtime-CZmXTeUy.js";import{D as t,a as s,V as o,L as n}from"./version-tag-DohCfExP.js";import"./index-eCxJ45ll.js";const r=Array.from({length:20}).map((l,i)=>e.jsxs("p",{children:["Panel ",i]},i)),d=e.jsx(e.Fragment,{children:Array.from({length:100}).map((l,i)=>e.jsxs("span",{children:["Panel ",i]},i))}),c=()=>e.jsxs(t,{children:[e.jsx(s,{children:"IRSplitContainer"}),e.jsx(o,{children:"ir-style@^2.16.0"}),e.jsxs("p",{children:[e.jsx("code",{children:"IRSplitContainer"}),"을 활용하여 구역 경계를 나누고, 사이즈를 변경할 수 있게 합니다."]}),e.jsxs("p",{children:["※ 구버전은 ",e.jsx("code",{children:"createSplitContainer"})," 함수 사용"]}),e.jsx(n,{css:`
#live_editor_wrapper {
    padding: 0
}
