...
`})]});l.__docgenInfo={description:"",methods:[],displayName:"APIDemo"};const n=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsxs("p",{children:[e.jsx("code",{children:"Grid"}),"형태로 사용자 상호작용을 처리하는 UI 컴포넌트입니다.",e.jsx("br",{}),e.jsx("code",{children:"cellRenderer"}),"를 이용하여 셀 출력 내용을 지정합니다."]}),e.jsx(i,{html:e.jsx("div",{id:"ir_grid",style:{height:500,width:800}}),code:`
import * as libGrid from "./dist/grid.js";
...
`})]});d.__docgenInfo={description:"",methods:[],displayName:"CellRenderer"};const s=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsx(i,{html:e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"mb--sm",children:[e.jsx("button",{id:"btn_bulk",className:"button",children:"Append Bulk Data (Slow)"}),e.jsx("button",{id:"btn_bulk2",className:"button",children:"Append Bulk Data (Improved)"}),e.jsx("button",{id:"btn_clear",className:"button",children:"Clear"}),e.jsx("button",{id:"btn_hide",className:"button",children:"all hide"}),e.jsx("button",{id:"btn_visible",className:"button",children:"all visible"})]}),e.jsx("div",{id:"ir_grid",style:{height:500,width:"100%"}})]}),code:`
import * as libGrid from "./dist/grid.js";
...
`})]});s.__docgenInfo={description:"",methods:[],displayName:"BulkData"};const c=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsx("p",{children:"헤더 없는 버전 테스트"}),e.jsx(i,{html:e.jsx("div",{id:"ir_grid",style:{height:500,width:800}}),code:`
import * as libGrid from "./dist/grid.js";
...
`})]});a.__docgenInfo={description:"",methods:[],displayName:"CellDrag"};const g=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid ColumnFill"}),e.jsx("p",{children:"ColumnFill 플러그인을 등록하여 현재 Context 크기에 맞게 모든 열 크기를 균등 분배합니다. (추후 설정된 너비는 각 너비에 맞게 고루 분배됨)"}),e.jsxs("p",{children:["colHeader의 ",e.jsx("code",{children:"maxSize"}),"를 9999로 설정해야 열 크기 제한 문제가 없습니다."]}),e.jsx(i,{fixedHeight:600,html:e.jsxs(e.Fragment,{children:[e.jsx("button",{id:"btn1",className:"button",children:"visible on/off"}),e.jsxs("div",{className:"flex background--light",children:[e.jsx("div",{id:"split1",children:e.jsx("div",{id:"ir_grid",className:"",style:{height:500,width:"100%",display:"none"}})}),e.jsx("div",{id:"split2"})]})]}),code:`
...
`})]});g.__docgenInfo={description:"",methods:[],displayName:"ColumnFill"};const u=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid Configuration"}),e.jsx("p",{children:"Grid 내부 패딩을 조절할 수 있습니다."}),e.jsx(i,{fixedHeight:600,html:e.jsx(e.Fragment,{children:e.jsx("div",{id:"ir_grid",className:"",style:{height:500}})}),code:`
import * as libGrid from "./dist/grid.js";
...
`})]});u.__docgenInfo={description:"",methods:[],displayName:"GridConfig"};const m=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsx(i,{html:e.jsx(e.Fragment,{children:e.jsx("div",{id:"ir_grid",style:{height:500,width:800}})}),code:`
...
`})]});m.__docgenInfo={description:"",methods:[],displayName:"ContextMenu"};const x=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsxs("p",{children:[e.jsx("code",{children:"cellRenderer"}),"인터페이스를 임의로 작성하여 다양한 셀 형태를 출력할 수 있습니다."]}),e.jsx(i,{html:e.jsx("div",{id:"ir_grid",style:{height:500,width:1300}}),code:`
import * as libGrid from "./dist/grid.js";
...
`})]});x.__docgenInfo={description:"",methods:[],displayName:"CustomRenderer"};const h=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsx("p",{children:"좌측 Tree 노드를 드래그하여 Grid Cell에 드롭할 수 있습니다."}),e.jsx(i,{html:e.jsxs("div",{style:{display:"flex",height:500,columnGap:8},children:[e.jsx("div",{id:"tree",style:{width:300}}),e.jsx("div",{id:"ir_grid",style:{height:"100%",width:"100%"}})]}),code:`
...
`})]});h.__docgenInfo={description:"",methods:[],displayName:"DragDrop"};const b=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsx("p",{children:"헤더를 드래그하여 셀 내용 교체"}),e.jsx(i,{html:e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex mb--lg",style:{alignItems:"center",columnGap:"4px"},children:["source: ",e.jsx("div",{className:"input",style:{display:"inline-block",width:100},children:e.jsx("input",{id:"input_source",className:"input__native"})}),"target: ",e.jsx("div",{className:"input",style:{display:"inline-block",width:100},children:e.jsx("input",{id:"input_target",className:"input__native"})}),e.jsx("button",{type:"button",id:"btn_exchange_row",className:"button",children:"행 교체"}),e.jsx("button",{type:"button",id:"btn_exchange_col",className:"button",children:"열 교체"}),e.jsx("button",{type:"button",id:"btn_on",className:"button ml--xl",children:"Drag On"}),e.jsx("button",{type:"button",id:"btn_off",className:"button",children:"Drag Off"}),e.jsx("button",{type:"button",id:"btn_merge",className:"button ml--xl",children:"셀 병합"}),e.jsx("button",{type:"button",id:"btn_freeze",className:"button",children:"행 고정"}),e.jsx("button",{type:"button",id:"btn_freeze_col",className:"button",children:"열 고정"})]}),e.jsx("div",{id:"ir_grid",style:{height:500,width:800}})]}),code:`
import * as libGrid from "./dist/grid.js";
...
`})]});p.__docgenInfo={description:"",methods:[],displayName:"Finder"};const w=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsx(i,{html:e.jsx("div",{id:"ir_grid",style:{height:500,width:1300}}),code:`
import * as libGrid from "./dist/grid.js";
...
`})]});w.__docgenInfo={description:"",methods:[],displayName:"Rows2000"};const C=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsx("p",{children:"헤더를 드래그하여 행/열 이동"}),e.jsx(i,{html:e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex mb--lg",style:{alignItems:"center",columnGap:"4px"},children:["source: ",e.jsx("div",{className:"input",style:{display:"inline-block",width:100},children:e.jsx("input",{id:"input_source",className:"input__native"})}),"target: ",e.jsx("div",{className:"input",style:{display:"inline-block",width:100},children:e.jsx("input",{id:"input_target",className:"input__native"})}),e.jsx("button",{type:"button",id:"btn_move_row",className:"button",children:"행 이동"}),e.jsx("button",{type:"button",id:"btn_move_col",className:"button",children:"열 이동"}),e.jsx("button",{type:"button",id:"btn_on",className:"button ml--xl",children:"Row Drag On"}),e.jsx("button",{type:"button",id:"btn_off",className:"button",children:"Row Drag Off"}),e.jsx("button",{type:"button",id:"btn_merge",className:"button ml--xl",children:"셀 병합"}),e.jsx("button",{type:"button",id:"btn_freeze",className:"button",children:"행 고정"}),e.jsx("button",{type:"button",id:"btn_freeze_col",className:"button",children:"열 고정"})]}),e.jsx("div",{id:"ir_grid",style:{height:500,width:800}})]}),code:`
import * as libGrid from "./dist/grid.js";
...
`})]});C.__docgenInfo={description:"",methods:[],displayName:"HeaderMove"};const _=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsx(i,{html:e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
                    .grid-wrapper {
                        height: 600px;
                        display: grid;
                        gap: 8px;
...
`})]});R.__docgenInfo={description:"",methods:[],displayName:"OverflowPanel"};const f=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsx("p",{}),e.jsx(i,{html:e.jsx("div",{id:"ir_grid",style:{height:500,width:1300}}),code:`
import * as libGrid from "./dist/grid.js";
...
`})]});f.__docgenInfo={description:"",methods:[],displayName:"RowSelection"};const j=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsx("p",{children:"열을 클릭하여 정렬 실행"}),e.jsx(i,{html:e.jsxs(e.Fragment,{children:[e.jsx("button",{type:"button",id:"btn_reset_sort",className:"button mb--sm",children:"정렬 초기화"}),e.jsxs("label",{children:[e.jsx("input",{type:"checkbox",id:"chk_toggle_column_click",defaultChecked:!0}),"열 클릭 활성화"]}),e.jsx("br",{}),e.jsx("div",{id:"ir_grid",style:{height:500,width:800}})]}),code:`
import * as libGrid from "./dist/grid.js";
...
`})]});j.__docgenInfo={description:"",methods:[],displayName:"Sort"};const v=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsx("p",{children:"열을 클릭하여 정렬 실행"}),e.jsx(i,{html:e.jsxs(e.Fragment,{children:[e.jsxs("div",{children:[e.jsx("button",{type:"button",id:"btn_sort",className:"button mb--sm",children:"정렬"}),e.jsx("span",{children:"정렬 Column"}),e.jsx("div",{className:"input",style:{display:"inline-block",width:200},children:e.jsx("input",{type:"text",className:"input__native",id:"input_column",defaultValue:"2"})}),e.jsx("span",{children:"시작 Row"}),e.jsx("div",{className:"input",style:{display:"inline-block",width:200},children:e.jsx("input",{type:"number",className:"input__native",id:"input_start_row",defaultValue:"5"})}),e.jsx("span",{children:"종료 Row"}),e.jsx("div",{className:"input",style:{display:"inline-block",width:200},children:e.jsx("input",{type:"number",className:"input__native",id:"input_end_row",defaultValue:"12"})})]}),e.jsx("br",{}),e.jsx("div",{id:"ir_grid",style:{height:500,width:800}})]}),code:`
import * as libGrid from "./dist/grid.js";
...
`})]});G.__docgenInfo={description:"",methods:[],displayName:"GridOnDialog"};const y=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsx(i,{html:e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"mb--lg",children:e.jsx("button",{id:"btn_check_commands",className:"button",children:"Check commands"})}),e.jsx("div",{id:"ir_grid",style:{height:500,width:1300}})]}),code:`
import * as libGrid from "./dist/grid.js";
...
`})]});y.__docgenInfo={description:"",methods:[],displayName:"SelectMapping"};const N=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGridTablePlugin"}),e.jsx(o,{children:"ir-style@^2.13.0"}),e.jsx("p",{}),e.jsx(i,{html:e.jsxs("div",{children:[e.jsx("button",{id:"remove_btn",className:"button",children:"TablePlugin 제거"}),e.jsxs("div",{className:"flex gap-x--3xl mt--lg",children:[e.jsx("div",{id:"ir_grid",style:{height:500,width:700}}),e.jsx("div",{id:"ir_grid2"})]})]}),code:`
import * as libGrid from "./dist/grid.js";
import { IRContextMenuAdapter } from "./dist/react.js";
...
`})]});N.__docgenInfo={description:"",methods:[],displayName:"GridTable"};const k=()=>e.jsxs(r,{children:[e.jsx(t,{children:"IRGrid"}),e.jsx(i,{html:e.jsxs("div",{style:{display:"flex",flexDirection:"column",height:500,columnGap:8},children:[e.jsx("div",{style:{height:32},children:e.jsxs("select",{id:"cbLocale",children:[e.jsx("option",{children:"ko"}),e.jsx("option",{children:"en"}),e.jsx("option",{children:"ja"})]})}),e.jsx("div",{id:"ir_grid",style:{flex:"1 1 0",width:"100%"}})]}),code:`
...
cbLocale.onchange = () => {
    i18n.setLocale( cbLocale.value );
}

`})]});k.__docgenInfo={description:"",methods:[],displayName:"i18n"};const E={title:"JS Components/IRGrid"},D=["APIDemo","Basic","CellRenderer","BulkData","NoHeader","CellDrag","ColumnFill","GridConfig","ContextMenu","CustomRenderer","DragDrop","Exchange","Finder","Rows2000","HeaderMove","Multiple","OverflowPanel","RowSelection","Sort","SortRange","GridOnDialog","SelectMapping","GridTable","i18n"];export{l as APIDemo,n as Basic,s as BulkData,a as CellDrag,d as CellRenderer,g as ColumnFill,m as ContextMenu,x as CustomRenderer,h as DragDrop,b as Exchange,p as Finder,u as GridConfig,G as GridOnDialog,N as GridTable,C as HeaderMove,_ as Multiple,c as NoHeader,R as OverflowPanel,f as RowSelection,w as Rows2000,y as SelectMapping,j as Sort,v as SortRange,D as __namedExportsOrder,E as default,k as i18n};
