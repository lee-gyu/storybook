import{j as i,a as e,F as D}from"./jsx-runtime-d057ca55.js";import{D as a,a as d,L as c}from"./doc-content-563e1737.js";import"./index-ebeaab24.js";import"./index-631dc947.js";const L={title:"JS Utility/Create Split Container"},p=Array.from({length:20}).map((y,t)=>i("p",{children:["Panel ",t]},t)),o=e(D,{children:Array.from({length:100}).map((y,t)=>i("span",{children:["Panel ",t]},t))}),r=()=>i(a,{children:[e(d,{children:"createSplitContainer"}),i("p",{children:[e("code",{children:"createSplitContainer"}),"을 활용하여 구역 경계를 나누고, 사이즈를 변경할 수 있게 합니다."]}),e(c,{css:`
#live_editor_wrapper {
    padding: 0
}
`,fixedHeight:400,html:i("div",{className:"split-container",style:{display:"flex",height:"100%"},children:[e("div",{id:"split-0",className:"split-panel",children:"panel 1"}),e("div",{id:"split-1",className:"split-panel",children:"panel 2"}),i("div",{id:"split-2",className:"split-panel",children:[e("div",{id:"split-3",className:"split-panel",children:"panel 3"}),i("div",{id:"split-4",className:"split-panel",style:{display:"flex"},children:[e("div",{id:"split-5",className:"split-panel",children:p}),e("div",{id:"split-6",className:"split-panel",children:o})]})]})]}),code:`
...
`,fixedHeight:400,html:i("div",{className:"split-container",style:{display:"flex",height:"100%"},children:[e("div",{id:"split-0",className:"split-panel",children:p}),e("div",{id:"split-1",className:"split-panel",children:o})]}),code:`
import { createSplitContainer } from "./dist/index.js";
...
`,fixedHeight:400,html:i(D,{children:[i("div",{className:"ir-flex ir-gap-x-xxs ir-p-xs",style:{borderBottom:"1px solid var(--border-color)"},children:[e("button",{id:"btn1",className:"button",children:"Get Size"}),e("button",{id:"btn2",className:"button",children:"Collapse"}),e("button",{id:"btn3",className:"button",children:"Destroy"})]}),i("div",{className:"split-container",style:{display:"flex",height:"100%"},children:[e("div",{id:"split-0",className:"split-panel",children:p}),e("div",{id:"split-1",className:"split-panel",children:o})]})]}),code:`
import { createSplitContainer } from "./dist/index.js";
...
split.setSizes([25, 75]);
                `})]});var m,h,v;r.parameters={...r.parameters,docs:{...(m=r.parameters)==null?void 0:m.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(v=(h=r.parameters)==null?void 0:h.docs)==null?void 0:v.source}}};var S,g,x;s.parameters={...s.parameters,docs:{...(S=s.parameters)==null?void 0:S.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(x=(g=s.parameters)==null?void 0:g.docs)==null?void 0:x.source}}};var N,z,b;n.parameters={...n.parameters,docs:{...(N=n.parameters)==null?void 0:N.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(b=(z=n.parameters)==null?void 0:z.docs)==null?void 0:b.source}}};var f,u,E;l.parameters={...l.parameters,docs:{...(f=l.parameters)==null?void 0:f.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(E=(u=l.parameters)==null?void 0:u.docs)==null?void 0:E.source}}};const j=["createSplitContainer","Size","Event","API"];export{l as API,n as Event,s as Size,j as __namedExportsOrder,r as createSplitContainer,L as default};
//# sourceMappingURL=split.basic.stories-75d9a3da.js.map
