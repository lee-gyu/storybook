import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{D as e,a as t,L as r,V as o}from"./version-tag-D7uYrt-q.js";import"./iframe-BlmI-0N5.js";import"./index-CxOA-kXO.js";const l=`import {
    IRGrid,
...
} );`,g='<div id="ir_grid" style="height: 500; width: 800"></div>';function m(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid 5,000개 컬럼"}),n.jsx(r,{htmlRaw:g,code:u})]})}m.__docgenInfo={description:"",methods:[],displayName:"BulkColumns"};const R=`import {
    IRGrid,
...
} );`,b='<div id="ir_grid" style="height: 500; width: 1300"></div>';function w(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid"}),n.jsx(r,{htmlRaw:b,code:R})]})}w.__docgenInfo={description:"",methods:[],displayName:"BulkRows"};const C=`import { IRGrid } from "@innorules/ir-style/lib/esm/grid.js";
...
`,I='<div id="ir_grid" style="height: 500; width: 1300"></div>';function y(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid"}),n.jsx(r,{htmlRaw:I,code:v})]})}y.__docgenInfo={description:"",methods:[],displayName:"CellFormatter"};const k=`import {
    IRGrid,
...
grid.setCell( 2, 6, { label: "달디다고 달디달고 달디단 밤양갱" } );`,G=`<div class="mb--lg">
    <button id="btn_check_commands" class="button">Check commands</button>
</div>
<div id="ir_grid" style="height: 500; width: 1300"></div>`;function T(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid"}),n.jsxs("p",{children:[n.jsx("code",{children:"cellRenderer"}),"를 재정의하여 여러 타입의 셀을 출력할 수 있습니다."]}),n.jsx(r,{htmlRaw:G,code:k})]})}T.__docgenInfo={description:"",methods:[],displayName:"CellRenderer"};const S=`import {
    IRGrid,
    IRGridRowNoHeaderCellRenderer,
} from "@innorules/ir-style/lib/esm/grid.js";
...
};`,j='<div id="ir_grid" style="height: 500; width: 800"></div>';function D(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid"}),n.jsx(r,{htmlRaw:j,code:S})]})}D.__docgenInfo={description:"",methods:[],displayName:"ClipboardEvents"};const P=`import { IRSplitContainer } from "@innorules/ir-style";
import {
    IRGrid,
...
} );`,A=`<button id="btn1" class='button'>visible on/off</button>
<div class="flex background--light">
    <div id="split1">
        <div id="ir_grid" style="height: 500; width: 100%; display: none"></div>
    </div>
    <div id="split2"></div>
</div>`;function E(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid ColumnFill"}),n.jsx("p",{children:"ColumnFill 플러그인을 등록하여 현재 Context 크기에 맞게 모든 열 크기를 균등 분배합니다. (추후 설정된 너비는 각 너비에 맞게 고루 분배됨)"}),n.jsxs("p",{children:["colHeader의 ",n.jsx("code",{children:"maxSize"}),"를 9999로 설정해야 열 크기 제한 문제가 없습니다."]}),n.jsx(r,{fixedHeight:600,htmlRaw:A,code:P})]})}E.__docgenInfo={description:"",methods:[],displayName:"ColumnFill"};const M=`import { IRContextMenu } from "@innorules/ir-style";
...
grid.mergeCells( 2, 1, 3, 3 );`,H='<div id="ir_grid" style="height: 500; width: 800"></div>';function B(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid"}),n.jsx(r,{htmlRaw:H,code:M})]})}B.__docgenInfo={description:"",methods:[],displayName:"ContextMenu"};const N=`import {
    IRGrid,
    IRGridDefaultCellRenderer,
} from "@innorules/ir-style/lib/esm/grid.js";
...
} );`,z='<div id="ir_grid" style="height: 500; width: 1300"></div>';function F(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid"}),n.jsxs("p",{children:[n.jsx("code",{children:"cellRenderer"}),"인터페이스를 임의로 작성하여 다양한 셀 형태를 출력할 수 있습니다."]}),n.jsx(r,{htmlRaw:z,code:N})]})}F.__docgenInfo={description:"",methods:[],displayName:"CustomRenderer"};const $=`import { IRTree } from "@innorules/ir-style";
import {
    IRGrid,
    IRGridDefaultCellRenderer,
    IRGridRowNoHeaderCellRenderer,
...
tree.expandAll();`,O=`<div style="display: flex; height: 500; column-gap: 8">
    <div id="tree" style="width: 300"></div>
    <div id="ir_grid" style="height: '100%'; width: '100%'"></div>
</div>`;function V(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid"}),n.jsx("p",{children:"좌측 Tree 노드를 드래그하여 Grid Cell에 드롭할 수 있습니다."}),n.jsx(r,{htmlRaw:O,code:$})]})}V.__docgenInfo={description:"",methods:[],displayName:"DragDrop"};const L=`import {
    IRGrid,
    IRGridCheckboxRenderer,
    IRGridDefaultCellRenderer,
...
};`,W=`<div class="flex mb--lg" style=" align-items:center; column-gap: 4px">
    source:
...
<div id="ir_grid" style=" height: 500; width: 800 "></div>`;function K(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid"}),n.jsx("p",{children:"헤더를 드래그하여 셀 내용 교체"}),n.jsx(r,{htmlRaw:W,code:L})]})}K.__docgenInfo={description:"",methods:[],displayName:"Exchange"};const U=`import {
    IRGrid,
    IRGridRowNoHeaderCellRenderer,
    IRGridDefaultCellRenderer,
    IRGridCheckboxRenderer,
...
<div id="ir_grid" style="height: 500; width: '100%'"></div>`;function X(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid Finder"}),n.jsx("p",{children:"Finder를 이용하여 셀 찾기 기능을 수행할 수 있습니다."}),n.jsx(r,{htmlRaw:q,code:U})]})}X.__docgenInfo={description:"",methods:[],displayName:"Finder"};const J=`import { IRGrid } from "@innorules/ir-style/lib/esm/grid.js";
...
grid.setText( 1, 1, "ABC" );
grid.setText( 2, 1, "한글" );
grid.setText( 3, 1, "はい" );`,Y=`<div style="display:flex; flex-direction:column; height: 500; column-gap: 8">
    <div id="ir_grid" style="flex: 1 1 0; width: '100%'"></div>
</div>`;function Z(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid"}),n.jsx(r,{localeSelectVisible:!0,htmlRaw:Y,code:J})]})}Z.__docgenInfo={description:"",methods:[],displayName:"i18n"};const Q=`import {
    IRGrid,
    IRGridCheckboxRenderer,
    IRGridDefaultCellRenderer,
...
btn_freeze_col.onclick = () =>
{
    ...
    grid.freezeColumns( selection.left );
};`,nn=`<div class="flex mb--lg" style="align-items: center; column-gap: 4px">
...
<div id="ir_grid" style="height: 500; width: 800"></div>`;function en(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid"}),n.jsx("p",{children:"헤더를 드래그하여 행/열 이동"}),n.jsx(r,{htmlRaw:nn,code:Q})]})}en.__docgenInfo={description:"",methods:[],displayName:"MoveAPI"};const tn=`import { IRGrid } from "@innorules/ir-style/lib/esm/grid.js";
...
window.__GRID_LIST = gridList;`,rn=`<style>
    .grid-wrapper {
        height: 600px;
        display: grid;
        gap: 8px;
...
<div class="grid-wrapper">
    ...
    <div id="ir_grid3"></div>
    <div id="ir_grid4"></div>
</div>`;function on(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid"}),n.jsx(r,{htmlRaw:rn,code:tn})]})}on.__docgenInfo={description:"",methods:[],displayName:"MultiInstance"};const ln=`import { createPopover } from "@innorules/ir-style";
...
</div>`;function cn(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid"}),n.jsx("p",{children:"API 사용 샘플"}),n.jsx(r,{fixedHeight:500,htmlRaw:dn,code:ln})]})}cn.__docgenInfo={description:"",methods:[],displayName:"GridOnDialog"};const sn=`import {
    IRGrid,
    IRGridDefaultCellRenderer,
...
} ) );`,an=`<button type='button' id="btn_freeze_rows" class='button mb--sm'>행 고정</button>
...
<div style="height: 400; display: grid">
    <div id="ir_grid"></div>
</div>`;function un(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid Overflow Panel"}),n.jsx("p",{children:"IRGrid가 overflow될 경우 Grid의 스크롤 제어를 간편하게 할 수 있는 편의 기능을 제공한다."}),n.jsx(r,{localeSelectVisible:!0,fixedHeight:550,htmlRaw:an,code:sn})]})}un.__docgenInfo={description:"",methods:[],displayName:"OverflowPanelPlugin"};const gn=`import { IRSelect, i18n } from "@innorules/ir-style";
import {
    IRGrid,
    IRGridCheckboxRenderer,
    IRGridDatePickerRenderer,
...
} );`,mn=`<div class="flex mb--lg gap-x--lg gap-y--lg align-items--center">
...
<div id="ir_grid" style="height: 500; width: 800"></div>`;function Rn(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid Row Filter"}),n.jsx(o,{children:"ir-style@^2.17.0"}),n.jsx("p",{}),n.jsx(r,{htmlRaw:mn,code:gn})]})}Rn.__docgenInfo={description:"",methods:[],displayName:"GridFilter"};const bn=`import {
    IRGrid,
    IRGridCheckboxRenderer,
    IRGridDatePickerRenderer,
    IRGridDefaultCellRenderer,
...
grid.onSelectCell = ( cell ) => console.log( cell.row );`,wn='<div id="ir_grid" style="height: 500; width: 1300"></div>';function Cn(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid"}),n.jsx("p",{}),n.jsx(r,{htmlRaw:wn,code:bn})]})}Cn.__docgenInfo={description:"",methods:[],displayName:"RowSelection"};const hn=`import {
    IRGrid,
    IRGridDefaultCellRenderer,
    IRGridSelectCellRenderer,
...
grid.autoSizeColumns( 0, 10 );`,pn=`<div class="mb--lg">
    <button id="btn_check_commands" class="button">Check commands</button>
</div>
<div id="ir_grid" style="height: 500; width: 1300"></div>`;function xn(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid"}),n.jsx(r,{htmlRaw:pn,code:hn})]})}xn.__docgenInfo={description:"",methods:[],displayName:"SelectMapping"};const fn=`import {
    IRGrid,
    IRGridDefaultCellRenderer,
    IRGridSelectCellRenderer,
} from "@innorules/ir-style/lib/esm/grid.js";
...
<div id="ir_grid" style="height: 500; width: 1300"></div>`;function vn(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid"}),n.jsx(o,{children:"ir-style@^2.17.0"}),n.jsx(r,{htmlRaw:_n,code:fn})]})}vn.__docgenInfo={description:"",methods:[],displayName:"SelectLazyItems"};const In=`import {
...
Array.from( { length: 250 } )
    .forEach( ( _, id ) =>
    {
        ...
        grid.setText( id + 1, 2, \`\${rand[1][Math.floor( Math.random() * rand[1].length )]}\` );
        grid.setText( id + 1, 3, \`\${rand[2][Math.floor( Math.random() * rand[2].length )]}\` );
        grid.setText( id + 1, 4, \`\${rand[3][Math.floor( Math.random() * rand[3].length )]}\` );
...
for( let i = 1; i < rowCnt; i++ )
    grid.setText( i, 0, i.toString() );`,yn=`<button type='button' id="btn_reset_sort" class='button mb--sm'>정렬 초기화</button>
...
<br />
<div id="ir_grid" style="height: 500px; width: 800px"></div>`;function kn(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid"}),n.jsx("p",{children:"열을 클릭하여 정렬 실행"}),n.jsx(r,{htmlRaw:yn,code:In})]})}kn.__docgenInfo={description:"",methods:[],displayName:"Sort"};const Gn=`import {
...
<br />
<div id="ir_grid" style="height: 500; width: 800"></div>`;function Sn(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid"}),n.jsx("p",{children:"열을 클릭하여 정렬 실행"}),n.jsx(r,{htmlRaw:Tn,code:Gn})]})}Sn.__docgenInfo={description:"",methods:[],displayName:"SortRange"};const jn=`
import {
    IRGrid,
    IRGridCheckboxRenderer,
    IRGridDefaultCellIconButtonRenderer,
...
</div>`;function Pn(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGridTablePlugin And Filter"}),n.jsx(o,{children:"ir-style@^2.17.0"}),n.jsx("p",{}),n.jsx(r,{htmlRaw:Dn,code:jn})]})}Pn.__docgenInfo={description:"",methods:[],displayName:"TableAndRowFilterPlugin"};const An=`import { IRContextMenu } from "@innorules/ir-style";
import {
    IRGrid,
    IRGridCheckboxRenderer,
    IRGridDefaultCellIconButtonRenderer,
...
</div>`;function Mn(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGridTablePlugin"}),n.jsx("div",{className:"ir-mb-md",children:n.jsx(o,{children:"ir-style@^2.13.0"})}),n.jsxs("div",{children:[n.jsx(o,{children:"ir-style@^2.18.0"})," - multipleSelect"]}),n.jsx(r,{defaultCodeFold:[55],htmlRaw:En,code:An})]})}Mn.__docgenInfo={description:"",methods:[],displayName:"TablePlugin"};const Hn=`import { getThemeStore } from "@innorules/ir-style";
import {
    IRGrid,
    IRGridRowNoHeaderCellRenderer,
    IRGridCheckboxRenderer,
...
grid.setColumnWidth( 2, 120 );
grid.setColumnWidth( 3, 120 );
grid.setColumnWidth( 4, 160 );`,Bn='<div id="ir_grid" style="height: 500"></div>';function Nn(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid Configuration"}),n.jsx("p",{children:"Grid 기본 내부 패딩을 조절할 수 있습니다."}),n.jsx(r,{fixedHeight:600,htmlRaw:Bn,code:Hn})]})}Nn.__docgenInfo={description:"",methods:[],displayName:"ThemeConfig"};const Vn={title:"JS Components/IRGrid"},Ln=["APIDemo","Basic","BulkColumns","BulkRows","BulkData","CellDrag","CellFormatter","CellRenderer","ClipboardEvents","ColumnFill","ContextMenu","CustomRenderer","DragDrop","ExchangeAPI","Finder","i18n","MoveAPI","MultiInstance","OnDialog","OverflowPanelPlugin","RowFilterPlugin","RowSelectionPlugin","SelectValueMap","SelectLazyItems","Sort","SortRange","TableAndRowFilterPlugin","TablePlugin","ThemeConfig"];export{d as APIDemo,a as Basic,m as BulkColumns,p as BulkData,w as BulkRows,_ as CellDrag,y as CellFormatter,T as CellRenderer,D as ClipboardEvents,E as ColumnFill,B as ContextMenu,F as CustomRenderer,V as DragDrop,K as ExchangeAPI,X as Finder,en as MoveAPI,on as MultiInstance,cn as OnDialog,un as OverflowPanelPlugin,Rn as RowFilterPlugin,Cn as RowSelectionPlugin,vn as SelectLazyItems,xn as SelectValueMap,kn as Sort,Sn as SortRange,Pn as TableAndRowFilterPlugin,Mn as TablePlugin,Nn as ThemeConfig,Ln as __namedExportsOrder,Vn as default,Z as i18n};
