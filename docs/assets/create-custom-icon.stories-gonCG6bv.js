import{j as o,a as n}from"./jsx-runtime-KzWSGvcx.js";import{D as s,a as c,L as l}from"./doc-content-Y1bYfLkc.js";import"./index-DogsOklH.js";import"./index-xS4YNjdq.js";const d={title:"JS Utility/CreateCustomIcon"},t=()=>o(s,{children:[n(c,{children:"createCustomIcon"}),o("p",{children:[n("code",{children:"createCustomIcon"}),"를 이용하여 특정 svg 아이콘 스타일을 추가합니다."]}),n(l,{html:o("div",{children:[n("i",{className:"ir-icon ir-icon--custom-icon-string"}),n("i",{className:"ir-icon ir-icon--custom-icon-number"})]}),code:`
