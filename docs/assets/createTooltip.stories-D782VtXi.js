...
`})]}),r=()=>t.jsxs(a,{children:[t.jsx(l,{children:"createTooltipContainer"}),t.jsx("p",{children:"ContainerElement 내부의 data-ir-tooltip 속성이 있는 요소에 tooltip을 생성한다."}),t.jsx(s,{css:c,html:t.jsxs(t.Fragment,{children:[t.jsx("style",{children:`
                                #container2 {
                                    height: 100px;
                                    width: 100px;
...
`})]});i.__docgenInfo={description:"",methods:[],displayName:"CreateTooltip"};n.__docgenInfo={description:"",methods:[],displayName:"CreateTooltipBySelector"};r.__docgenInfo={description:"",methods:[],displayName:"createTooltipContainer"};var p,u,m;i.parameters={...i.parameters,docs:{...(p=i.parameters)==null?void 0:p.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(m=(u=i.parameters)==null?void 0:u.docs)==null?void 0:m.source}}};var b,h,_;n.parameters={...n.parameters,docs:{...(b=n.parameters)==null?void 0:b.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(_=(h=n.parameters)==null?void 0:h.docs)==null?void 0:_.source}}};var C,x,N;r.parameters={...r.parameters,docs:{...(C=r.parameters)==null?void 0:C.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(N=(x=r.parameters)==null?void 0:x.docs)==null?void 0:N.source}}};const D=["CreateTooltip","CreateTooltipBySelector","createTooltipContainer"];export{i as CreateTooltip,n as CreateTooltipBySelector,D as __namedExportsOrder,r as createTooltipContainer,v as default};
