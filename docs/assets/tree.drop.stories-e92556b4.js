import{j as n,a as e}from"./jsx-runtime-d057ca55.js";import{D as a,a as i,L as s}from"./doc-content-563e1737.js";import"./index-ebeaab24.js";import"./index-631dc947.js";const h={title:"JS Components/Tree"},o=()=>n(a,{children:[e(i,{children:"Tree drop on node"}),e("p",{children:"다른 개체에서 전달한 Drag 데이터를 노드에서 Drop으로 받아서 처리할 수 있습니다. IRTree의 아래 이벤트를 구성하여야 합니다."}),n("ul",{children:[n("li",{children:[e("code",{children:"onDragOverOnNode(node, event)"})," DragOver 시 호출될 이 이벤트이며, true를 리턴해야 drag 동작을 허용합니다."]}),n("li",{children:[e("code",{children:"onDropOnNode(node, event)"})," 데이터가 drop되었을 시 호출될 이벤트입니다."]})]}),e("p",{children:"아래는 각 트리 노드 데이터를 drag-drop하면 하위 노드로 추가되도록 구현한 예제입니다."}),e(s,{fixedHeight:300,css:`
#drop_zone > * {
    pointer-events: none;
}
...
//# sourceMappingURL=tree.drop.stories-e92556b4.js.map
