import{j as i}from"./jsx-runtime-QvZ8i92b.js";import{D as a,a as p,L as d}from"./doc-content-DCRebTQc.js";import"./index-uubelm5h.js";import"./index-vAxXS4R5.js";const v={title:"JS Utility/Create Split Container"},c=Array.from({length:20}).map((r,e)=>i.jsxs("p",{children:["Panel ",e]},e)),o=i.jsx(i.Fragment,{children:Array.from({length:100}).map((r,e)=>i.jsxs("span",{children:["Panel ",e]},e))}),t=()=>i.jsxs(a,{children:[i.jsx(p,{children:"createSplitContainer"}),i.jsxs("p",{children:[i.jsx("code",{children:"createSplitContainer"}),"을 활용하여 구역 경계를 나누고, 사이즈를 변경할 수 있게 합니다."]}),i.jsx(d,{css:`
#live_editor_wrapper {
    padding: 0
}
...
createSplitContainer(['#split-5', '#split-6'], { gutterCls: "thin" })
                `})]});t.__docgenInfo={description:"",methods:[],displayName:"thinStyle"};var l,s,n;t.parameters={...t.parameters,docs:{...(l=t.parameters)==null?void 0:l.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(n=(s=t.parameters)==null?void 0:s.docs)==null?void 0:n.source}}};const x=["thinStyle"];export{x as __namedExportsOrder,v as default,t as thinStyle};
