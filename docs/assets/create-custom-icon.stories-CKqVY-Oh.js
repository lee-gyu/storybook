import{j as o,a as n}from"./jsx-runtime-CjohWU4o.js";import{D as s,a as c,L as l}from"./doc-content-CB4FAwiC.js";import"./index-CBqU2yxZ.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-Bl6ORisp.js";const u={title:"JS Utility/CreateCustomIcon"},t=()=>o(s,{children:[n(c,{children:"createCustomIcon"}),o("p",{children:[n("code",{children:"createCustomIcon"}),"를 이용하여 특정 svg 아이콘 스타일을 추가합니다."]}),n(l,{html:o("div",{children:[n("i",{className:"ir-icon ir-icon--custom-icon-string"}),n("i",{className:"ir-icon ir-icon--custom-icon-number"})]}),code:`
...
}`,...(e=(r=t.parameters)==null?void 0:r.docs)==null?void 0:e.source}}};const C=["CreateCustomIcon"];export{t as CreateCustomIcon,C as __namedExportsOrder,u as default};
