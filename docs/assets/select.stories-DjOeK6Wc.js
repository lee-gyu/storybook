import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{D as n,a as t,L as o}from"./version-tag-9vMQgyJG.js";import"./iframe-CKHoihc2.js";import"./index-Dprm-oae.js";const r=`import { IRSelect } from "@innorules/ir-style";\r
\r
new IRSelect( {\r
...
</div>`;function x(){return e.jsxs(n,{children:[e.jsx(t,{children:"Transparent"}),e.jsxs("p",{children:[e.jsx("code",{children:"select--transparent"})," class를 추가하여 배경을 투명하게 조정할 수 있습니다."]}),e.jsx(o,{fixedHeight:400,htmlRaw:u,code:m})]})}x.__docgenInfo={description:"",methods:[],displayName:"Transparent"};const R={title:"JS Components/IRSelect"},S=["Basic","Disabled","Event","Transparent"];export{i as Basic,d as Disabled,h as Event,x as Transparent,S as __namedExportsOrder,R as default};
