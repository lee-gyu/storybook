import{j as e,a as i,F as t}from"./jsx-runtime-CjohWU4o.js";import{D as o,a as l,L as s}from"./doc-content-BYQUkk8D.js";import"./index-CBqU2yxZ.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-Bl6ORisp.js";const u={title:"HTML Components/Divider"},d=()=>e(o,{children:[i(l,{children:"Divider Sticky"}),e("p",{children:["sticky를 사용하면 ",i("code",{children:"margin"}),"를 음수값으로 지정하여 여백이 존재하는 부모 컨텐츠에 맞게 설정할 수 있습니다."]}),i("p",{children:i("strong",{children:"사이즈"})}),e("ul",{children:[e("li",{children:[i("code",{children:"xxs"}),": -0.4rem"]}),e("li",{children:[i("code",{children:"xs"}),": -0.6rem"]}),e("li",{children:[i("code",{children:"sm"}),": -0.8rem"]}),e("li",{children:[i("code",{children:"md"}),": -1rem"]}),e("li",{children:[i("code",{children:"lg"}),": -1.2rem"]}),e("li",{children:[i("code",{children:"xl"}),": -1.6rem"]}),e("li",{children:[i("code",{children:"xxl"}),": -2rem"]})]}),i(s,{css:`
