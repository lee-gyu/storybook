import{j as t}from"./jsx-runtime-QvZ8i92b.js";import{l as r}from"./index-B1ZoEFxZ.js";import{D as u,a as i,L as c}from"./doc-content-DCRebTQc.js";import"./index-uubelm5h.js";import"./index-vAxXS4R5.js";const D={title:"JS Components/Editor"},d=`
#ir_editor {
    height: 200px;
}
`,e=()=>t.jsxs(u,{children:[t.jsx(i,{children:"IREditor Cursor API"}),t.jsx("p",{children:"제공되는 API를 이용하여 Cursor 위치 및 상태를 제어합니다."}),t.jsx(c,{css:d,html:t.jsxs(t.Fragment,{children:[t.jsx("div",{id:"ir_editor"}),t.jsx("br",{}),t.jsxs("div",{className:"button-group",children:[t.jsx("button",{id:"btn",className:r,children:"현재 라인 텍스트"}),t.jsx("button",{id:"btn2",className:r,children:"현재 선택된 텍스트"}),t.jsx("button",{id:"btn3",className:r,children:"현재 커서 정보"}),t.jsx("button",{id:"btn4",className:r,children:"1번째 라인 텍스트"}),t.jsx("button",{id:"btn5",className:r,children:"현재 커서 텍스트"}),t.jsx("button",{id:"btn6",className:r,children:"특정 위치 선택"})]})]}),code:`
...
}`,...(s=(n=e.parameters)==null?void 0:n.docs)==null?void 0:s.source}}};const E=["HandlingCursor"];export{e as HandlingCursor,E as __namedExportsOrder,D as default};
