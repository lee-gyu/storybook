import{j as n}from"./jsx-runtime-u17CrQMm.js";import{D as r,a as e,V as l,c as t,L as i}from"./version-tag-Buic5uEj.js";import"./iframe-BmvT9HBJ.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Dx57Rlms.js";const d=`\r
...
</div>`,a=[["/classes/_innorules_grid.IRGridTablePlugin.html","IRGridTablePlugin"],["/classes/_innorules_grid.IRGridTablePluginAPI.html","IRGridTablePluginAPI"]];function c(){return n.jsxs(r,{children:[n.jsx(e,{children:"IRGridTablePlugin"}),n.jsx(l,{children:"ir-style@^2.13.0"}),n.jsxs("p",{children:["IRGridTablePlugin은 IRGrid에 다양한 테이블 관련 기능을 추가하는 플러그인입니다.",n.jsx("br",{}),"이 플러그인을 사용하면 다중 행 선택, 마지막 열 고정, 드래그 앤 드롭 등 다양한 테이블 조작 기능을 구현할 수 있습니다."]}),n.jsx(t,{docList:a}),n.jsx(i,{defaultCodeFold:[55],htmlRaw:s,code:d,exampleCode:o})]})}c.__docgenInfo={description:"",methods:[],displayName:"TablePlugin"};const u=`import {\r
    IRGrid,\r
...
</div>`,R=[["/classes/_innorules_grid.IRGridTablePlugin.html","IRGridTablePlugin"],["/classes/_innorules_grid.IRGridTablePluginAPI.html","IRGridTablePluginAPI"]];function m(){return n.jsxs(r,{children:[n.jsx(e,{children:"IRGridTablePlugin RowDraggable"}),n.jsx(l,{children:"ir-style@^2.22.0"}),n.jsxs("p",{children:["IRGridTablePlugin에서 ",n.jsx("code",{children:"rowDraggable"})," 속성을 사용하면 테이블 행 전체를 드래그 할 수 있다.",n.jsx("br",{}),"선택한 행은 드래그할 수 있으며, `Ctrl + Click`으로 선택을 해제할 수 있다. ",n.jsx("br",{}),n.jsx("code",{children:"multipleSelect"})," 속성과 같이 사용할 경우 다중 행 드래그가 가능하다.",n.jsx("br",{}),n.jsxs("b",{children:["※ 기본적으로 행을 드래그하려면, 선택된 행의 0번째 컬럼 중 최소 하나 이상 ",n.jsx("code",{children:"draggable: true"}),"와, cell의 object가 정의되어 있어야 한다."]})]}),n.jsx(t,{docList:R}),n.jsx(i,{htmlRaw:b,code:u,exampleCode:g})]})}m.__docgenInfo={description:"",methods:[],displayName:"TablePluginRowDraggable"};const C=`import {\r
    IRGrid,\r
    IRGridDefaultCellIconButtonRenderer,\r
    IRGridDefaultCellRenderer,\r
    IRGridPopoverPlugin,\r
...
\r
globalThis.createGrid = ( id ) =>\r
{\r
    const grid = new IRGrid( {\r
        contextElement: document.getElementById( id ),\r
        body: {\r
            rowCount: 10000,\r
            cellRenderer: defaultCellRenderer,\r
        },\r
...
\r
    return grid;\r
};`,h=`import { IRGridTablePlugin } from "@innorules/ir-style/lib/esm/grid.js";\r
\r
const tableGrid = createGrid( "ir_grid" );\r
\r
const tableListViewPlugin = new IRGridTablePlugin( {\r
    style: "list-view",\r
    multipleSelect: true,\r
} );\r
\r
tableGrid.addPlugin( tableListViewPlugin );`,w='<div id="ir_grid" style="height: 500px; width: 700px"></div>',I=[["/classes/_innorules_grid.IRGridTablePlugin.html","IRGridTablePlugin"],["/types/_innorules_grid.IRGridTablePluginArgs.html#style","IRGridTablePluginArgs style"]];function p(){return n.jsxs(r,{children:[n.jsx(e,{children:"IRGridTablePlugin ListViewStyle"}),n.jsx(l,{children:"ir-style@^2.23.0"}),n.jsxs("p",{children:["IRGridTablePlugin에서 ",n.jsx("code",{children:"style"})," 속성을 ",n.jsx("code",{children:"list-view"}),"로 설정하면 PF ListView 스타일이 적용된다."]}),n.jsx(t,{docList:I}),n.jsx(i,{htmlRaw:w,code:C,exampleCode:h})]})}p.__docgenInfo={description:"",methods:[],displayName:"ListViewStyle"};const G={title:"JS Components/IRGrid/TablePlugin"},v=["Basic","RowDraggable","ListViewStyle"];export{c as Basic,p as ListViewStyle,m as RowDraggable,v as __namedExportsOrder,G as default};
