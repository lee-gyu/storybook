import{j as n}from"./jsx-runtime-QvZ8i92b.js";import{D as l,a as u,L as d}from"./doc-content-DCRebTQc.js";import"./index-uubelm5h.js";import"./index-vAxXS4R5.js";const C={title:"JS Components/Flowchart"},o=()=>n.jsxs(l,{children:[n.jsx(u,{children:"IRFlowchart"}),n.jsx(d,{html:n.jsxs(n.Fragment,{children:[n.jsxs("div",{style:{marginBottom:8},children:[n.jsx("h3",{children:"오브젝트 추가 API"}),n.jsx("button",{className:"button",id:"btn_add_start",children:"start 노드 추가"}),n.jsx("button",{className:"button",id:"btn_add_if",children:"if 노드 추가"}),n.jsx("button",{className:"button",id:"btn_add_db",children:"db 노드 추가"}),n.jsx("button",{className:"button",id:"btn_add_bridge",children:"bridge 노드 추가"}),n.jsx("button",{className:"button",id:"btn_add_comment",children:"comment 노드 추가"}),n.jsx("button",{className:"button",id:"btn_add_return",children:"return 노드 추가"}),n.jsx("button",{className:"button",id:"btn_add_direct",children:"곧은 연결선 추가"}),n.jsx("button",{className:"button",id:"btn_add_elbow",children:"꺾은 연결선 추가"}),n.jsx("h3",{className:"mt--lg",children:"오브젝트 제어 API"}),n.jsx("button",{className:"button",id:"btn_clear",children:"clear"}),n.jsx("button",{className:"button",id:"btn_remove_selected",children:"선택 개체 제거 (Delete 키)"}),n.jsx("button",{className:"button",id:"btn_group",children:"선택된 개체 그룹"}),n.jsx("button",{className:"button",id:"btn_release_group",children:"그룹 해제"}),n.jsx("button",{className:"button",id:"btn_undo",children:"Undo (Ctrl + Z)"}),n.jsx("button",{className:"button",id:"btn_redo",children:"Redo (Ctrl + Y)"}),n.jsx("button",{className:"button",id:"btn_size_to_fit",children:"컨텐츠에 맞게 크기 조정"}),n.jsx("h3",{className:"mt--lg",children:"배치/정렬 API"}),n.jsx("button",{className:"button",id:"btn_align_left",children:"가로 왼쪽 정렬"}),n.jsx("button",{className:"button",id:"btn_align_center",children:"가로 중앙 정렬"}),n.jsx("button",{className:"button",id:"btn_align_right",children:"가로 오른쪽 정렬"}),n.jsx("button",{className:"button",id:"btn_align_top",children:"세로 위쪽 정렬"}),n.jsx("button",{className:"button",id:"btn_align_middle",children:"세로 중앙 정렬"}),n.jsx("button",{className:"button",id:"btn_align_bottom",children:"세로 아래쪽 정렬"}),n.jsx("button",{className:"button",id:"btn_distribute_horizontal",children:"가로 균등 분배"}),n.jsx("button",{className:"button",id:"btn_distribute_vertical",children:"세로 균등 분배"}),n.jsx("button",{className:"button",id:"btn_bring_to_front",children:"맨 앞으로"}),n.jsx("button",{className:"button",id:"btn_bring_to_back",children:"맨 뒤로"}),n.jsx("h3",{className:"mt--lg",children:"Mode Toggle (on/off)"}),n.jsxs("div",{className:"flex gap-x--lg py--sm",children:[n.jsxs("label",{children:[n.jsx("input",{type:"checkbox",id:"chk_toggle_grid"}),"눈금선"]}),n.jsxs("label",{children:[n.jsx("input",{type:"checkbox",id:"chk_toggle_readonly"}),"읽기 전용"]}),n.jsxs("label",{children:[n.jsx("input",{type:"checkbox",id:"chk_toggle_edit_mode"}),"마우스 상호작용 비활성화"]}),n.jsxs("label",{children:[n.jsx("input",{type:"checkbox",id:"chk_toggle_trace"}),"디버그 모드"]}),n.jsxs("label",{children:[n.jsx("input",{type:"checkbox",id:"chk_toggle_tooltip"}),"툴팁 숨김"]}),n.jsxs("label",{children:[n.jsx("input",{type:"checkbox",id:"chk_toggle_move_screen_on_select"}),"노드 선택 시 스크롤 중앙 이동"]}),n.jsxs("label",{children:[n.jsx("input",{type:"checkbox",id:"chk_toggle_select_node_on_hover"}),"hover 시 노드 선택"]}),n.jsxs("label",{children:[n.jsx("input",{type:"checkbox",id:"chk_toggle_simple_connecting_mode"}),"연결선 최단 거리 자동 설정"]}),n.jsxs("label",{children:[n.jsx("input",{type:"checkbox",id:"chk_toggle_wheel_zoom"}),"Ctrl + Wheel 줌"]}),n.jsxs("label",{children:[n.jsx("input",{type:"checkbox",id:"chk_single_selection"}),"단일 선택 모드"]}),n.jsxs("label",{children:[n.jsx("input",{type:"checkbox",id:"chk_canvas_move"}),"캔버스 이동 모드"]})]})]}),n.jsx("div",{id:"flowchart_div",className:"border",style:{height:550}})]}),code:`
...
`})]});o.__docgenInfo={description:"",methods:[],displayName:"Basic"};var t,e,c;o.parameters={...o.parameters,docs:{...(t=o.parameters)==null?void 0:t.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(c=(e=o.parameters)==null?void 0:e.docs)==null?void 0:c.source}}};const s=["Basic"];export{o as Basic,s as __namedExportsOrder,C as default};
