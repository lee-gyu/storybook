import{j as e}from"./jsx-runtime-CkxqCPlQ.js";import{D as i,a as t,L as d}from"./version-tag-BPwPDPyQ.js";import"./index-DJO9vBfz.js";const n=()=>e.jsxs(i,{children:[e.jsx(t,{children:"DatePicker"}),e.jsxs("p",{children:[e.jsx("code",{children:"IRDatePicker"})," 컴포넌트를 활용하여 날짜를 선택하는 입력 컨트롤을 표현할 수 있으며 ",e.jsx("code",{children:"format"})," 속성으로 날짜 서식을 지정할 수 있습니다. (기본 값 : YYYY-MM-DD)"]}),e.jsx(d,{fixedHeight:400,html:e.jsxs(e.Fragment,{children:[e.jsx("div",{id:"date_picker",style:{width:300}}),e.jsx("br",{}),e.jsx("div",{id:"date_picker2",style:{width:200}})]}),code:`
