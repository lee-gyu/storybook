import{j as n}from"./jsx-runtime-u17CrQMm.js";import{D as e,a as t,V as o,c as r,L as l}from"./version-tag-B2yXrdOr.js";import"./iframe-BRPaCIBY.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DL7yNlIg.js";const i=`
import {
...
`,s=`<div class="flex mb--lg gap-x--lg gap-y--lg align-items--center">
...
<div id="ir_grid" style="height: 500px; width: 800px"></div>`,c=[["/classes/_innorules_grid.IRGridRowFilterCellRenderer.html","IRGridRowFilterCellRenderer"],["/classes/_innorules_grid.IRGridRowFilterPlugin.html","IRGridRowFilterPlugin"]];function a(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid Row Filter"}),n.jsx(o,{children:"ir-style@^2.17.0"}),n.jsxs("p",{children:["IRGrid Row Filter Plugin은 IRGrid의 행 필터링을 위한 플러그인입니다.",n.jsx("br",{}),"이 플러그인을 사용하면 정렬 기능, 특정 조건에 따른 행을 필터링 기능을 구현할 수 있습니다."]}),n.jsx(r,{docList:c}),n.jsx(l,{htmlRaw:s,exampleCode:d,code:i})]})}a.__docgenInfo={description:"",methods:[],displayName:"RowFilterPlugin"};const g=`
import {
    IRGrid,
    IRGridCheckboxRenderer,
    IRGridDatePickerRenderer,
...
`,u=`import { cellCompare, IRGridRowFilterPlugin } from "@innorules/ir-style/lib/esm/grid.js";
...
};`,R=`<div class="flex mb--lg gap-x--lg gap-y--lg align-items--center">
    <button class='button' id='btn_merge'>Merge Cells</button>
    <button class='button' id='btn_split'>Split Cells</button>
</div>
<div id="ir_grid" style="height: 400px; width: 800px"></div>`,m=[["/classes/_innorules_grid.IRGridRowFilterCellRenderer.html","IRGridRowFilterCellRenderer"],["/classes/_innorules_grid.IRGridRowFilterPlugin.html","IRGridRowFilterPlugin"]];function w(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRGrid Custom Merge Cell Sorting"}),n.jsxs("p",{children:[n.jsx("code",{children:"IRGridRowFilterPlugin"}),"의 ",n.jsx("code",{children:"columnSortManager.compareTo"}),"를 재정의하여 사용자 정의 정렬 로직을 구현할 수 있습니다.",n.jsx("br",{}),"※ 참고: ",n.jsx("code",{children:"columnSortManager.compareTo"}),"의 ",n.jsx("code",{children:"order"})," 옵션은 v2.22.2 버전 이상부터 지원"]}),n.jsx(r,{docList:m}),n.jsx(l,{htmlRaw:R,exampleCode:u,code:g})]})}w.__docgenInfo={description:"",methods:[],displayName:"RowFilterPlugin"};const _={title:"JS Components/IRGrid/RowFilterPlugin"},p=["Basic","CustomMergeCellSorting"];export{a as Basic,w as CustomMergeCellSorting,p as __namedExportsOrder,_ as default};
