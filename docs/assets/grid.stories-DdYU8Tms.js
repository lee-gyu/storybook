import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{D as n,a as e,L as t,V as o}from"./version-tag-CkTpihZX.js";import"./iframe-jo4tttFm.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BDcoFm-e.js";const l=`import {\r
    IRGrid,\r
...
<div id="ir_grid" style="height: 500; width: '100%'"></div>`;function p(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsx(t,{htmlRaw:h,code:C})]})}p.__docgenInfo={description:"",methods:[],displayName:"BulkData"};const x=`import {\r
    IRGrid,\r
    IRGridRowNoHeaderCellRenderer,\r
    IRGridDefaultCellRenderer,\r
...
};`,j='<div id="ir_grid" style="height: 500; width: 800"></div>';function P(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsx(t,{htmlRaw:j,code:T})]})}P.__docgenInfo={description:"",methods:[],displayName:"ClipboardEvents"};const D=`import { IRSplitContainer } from "@innorules/ir-style";\r
import {\r
    IRGrid,\r
...
<div class="flex background--light">\r
    ...
    <div id="split2"></div>\r
</div>`;function E(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid ColumnFill"}),r.jsx("p",{children:"ColumnFill 플러그인을 등록하여 현재 Context 크기에 맞게 모든 열 크기를 균등 분배합니다. (추후 설정된 너비는 각 너비에 맞게 고루 분배됨)"}),r.jsxs("p",{children:["colHeader의 ",r.jsx("code",{children:"maxSize"}),"를 9999로 설정해야 열 크기 제한 문제가 없습니다."]}),r.jsx(t,{fixedHeight:600,htmlRaw:A,code:D})]})}E.__docgenInfo={description:"",methods:[],displayName:"ColumnFill"};const M=`import { IRContextMenu } from "@innorules/ir-style";\r
...
\r
grid.mergeCells( 2, 1, 3, 3 );`,H='<div id="ir_grid" style="height: 500; width: 800"></div>';function z(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsx(t,{htmlRaw:H,code:M})]})}z.__docgenInfo={description:"",methods:[],displayName:"ContextMenu"};const B=`import {\r
    IRGrid,\r
    IRGridDefaultCellRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
\r
...
} );`,N='<div id="ir_grid" style="height: 500; width: 1300"></div>';function F(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsxs("p",{children:[r.jsx("code",{children:"cellRenderer"}),"인터페이스를 임의로 작성하여 다양한 셀 형태를 출력할 수 있습니다."]}),r.jsx(t,{htmlRaw:N,code:B})]})}F.__docgenInfo={description:"",methods:[],displayName:"CustomRenderer"};const $=`import { IRTree } from "@innorules/ir-style";\r
import {\r
    IRGrid,\r
    IRGridDefaultCellRenderer,\r
    IRGridRowNoHeaderCellRenderer,\r
...
<div id="ir_grid" style="height: 500; width: 1300"></div>`;function pr(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsx(t,{htmlRaw:hr,code:Cr})]})}pr.__docgenInfo={description:"",methods:[],displayName:"SelectMapping"};const xr=`import {\r
    IRGrid,\r
    IRGridDefaultCellRenderer,\r
    IRGridSelectCellRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
...
<div id="ir_grid" style="height: 500; width: 1300"></div>`;function _r(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsx(o,{children:"ir-style@^2.17.0"}),r.jsx(t,{htmlRaw:fr,code:xr})]})}_r.__docgenInfo={description:"",methods:[],displayName:"SelectLazyItems"};const vr=`import {\r
...
<br />\r
<div id="ir_grid" style="height: 500; width: 800"></div>`;function Sr(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsx("p",{children:"열을 클릭하여 정렬 실행"}),r.jsx(t,{htmlRaw:Gr,code:kr})]})}Sr.__docgenInfo={description:"",methods:[],displayName:"SortRange"};const Tr=`import { IRContextMenu } from "@innorules/ir-style";\r
import {\r
    IRGrid,\r
    IRGridCheckboxRenderer,\r
    IRGridDefaultCellIconButtonRenderer,\r
...
</div>`;function Pr(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGridTablePlugin"}),r.jsx("div",{className:"ir-mb-md",children:r.jsx(o,{children:"ir-style@^2.13.0"})}),r.jsxs("div",{children:[r.jsx(o,{children:"ir-style@^2.18.0"})," - multipleSelect"]}),r.jsx(t,{defaultCodeFold:[55],htmlRaw:jr,code:Tr})]})}Pr.__docgenInfo={description:"",methods:[],displayName:"TablePlugin"};const Dr=`\r
import {\r
    IRGrid,\r
    IRGridCheckboxRenderer,\r
    IRGridDefaultCellIconButtonRenderer,\r
...
</div>`;function Er(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGridTablePlugin And Filter"}),r.jsx(o,{children:"ir-style@^2.17.0"}),r.jsx("p",{}),r.jsx(t,{htmlRaw:Ar,code:Dr})]})}Er.__docgenInfo={description:"",methods:[],displayName:"TableAndRowFilterPlugin"};const Mr=`import {\r
    IRGrid,\r
    IRGridDefaultCellIconButtonRenderer,\r
    IRGridDefaultCellRenderer,\r
    IRGridPopoverPlugin,\r
...
</div>`;function zr(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGridTablePlugin RowDraggable"}),r.jsx(o,{children:"ir-style@^2.22.0"}),r.jsxs("p",{children:["IRGridTablePlugin에서 ",r.jsx("code",{children:"rowDraggable"})," 속성을 사용하면 테이블 행 전체를 드래그 할 수 있다.",r.jsx("br",{}),"선택한 행은 드래그할 수 있으며, `Ctrl + Click`으로 선택을 해제할 수 있다. ",r.jsx("br",{}),r.jsx("code",{children:"multipleSelect"})," 속성과 같이 사용할 경우 다중 행 드래그가 가능하다.",r.jsx("br",{}),r.jsxs("b",{children:["※ 기본적으로 행을 드래그하려면, 선택된 행의 0번째 컬럼 중 최소 하나 이상 ",r.jsx("code",{children:"draggable: true"}),"와, cell의 object가 정의되어 있어야 한다."]})]}),r.jsx(t,{htmlRaw:Hr,code:Mr})]})}zr.__docgenInfo={description:"",methods:[],displayName:"TablePluginRowDraggable"};const Br=`import { getThemeStore } from "@innorules/ir-style";\r
import {\r
    IRGrid,\r
    IRGridRowNoHeaderCellRenderer,\r
    IRGridCheckboxRenderer,\r
...
grid.setColumnWidth( 2, 120 );\r
grid.setColumnWidth( 3, 120 );\r
grid.setColumnWidth( 4, 160 );`,Nr='<div id="ir_grid" style="height: 500"></div>';function Fr(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid Configuration"}),r.jsx("p",{children:"Grid 기본 내부 패딩을 조절할 수 있습니다."}),r.jsx(t,{fixedHeight:600,htmlRaw:Nr,code:Br})]})}Fr.__docgenInfo={description:"",methods:[],displayName:"ThemeConfig"};const $r=`import {\r
    IRGrid,\r
    IRGridCheckboxRenderer,\r
    IRGridDatePickerRenderer,\r
    IRGridDefaultCellRenderer,\r
...
</div>`;function Vr(){return r.jsxs(n,{children:[r.jsx(e,{children:"MultiSelectCellPlugin"}),r.jsx(o,{children:"ir-style@^2.21.0"}),r.jsxs("p",{children:["IRGrid에 다중 셀 선택 기능을 제공한다.",r.jsx("br",{}),r.jsx("b",{children:"※ 단독 사용은 불가능하며 반드시 IRGridMouseCellSelectorPlugin과 함께 사용"})]}),r.jsxs("p",{children:[r.jsx("b",{children:"복사/붙여넣기 참고 사항"}),r.jsx("br",{}),"- 복사와 붙여넣기는 선택한 셀들이 행과 열 모두에서 동일한 개수일 때만 동작한다. (잘못된 영역인 경우 경고 메시지 출력)",r.jsx("br",{}),"- 붙여넣기 시 선택한 셀들은 빈칸 없이 연속된 형태로 붙어서 표시된다.",r.jsx("br",{}),"※ 엑셀의 다중 셀 선택 복사/붙여넣기 동작 참고",r.jsx("br",{})]}),r.jsx(t,{htmlRaw:Or,code:$r})]})}Vr.__docgenInfo={description:"",methods:[],displayName:"MultiSelectCellPlugin"};const Xr={title:"JS Components/IRGrid"},Jr=["APIDemo","Basic","BulkColumns","BulkRows","BulkData","CellDrag","CellFormatter","CellRenderer","ClipboardEvents","ColumnFill","ContextMenu","CustomRenderer","DragDrop","ExchangeAPI","Finder","i18n","MoveAPI","MultiInstance","OnDialog","OverflowPanelPlugin","RowFilterPlugin","RowSelectionPlugin","SelectValueMap","SelectLazyItems","Sort","SortRange","TablePlugin","TableAndRowFilterPlugin","TablePluginRowDraggable","ThemeConfig","MultiSelectCellPlugin"];export{d as APIDemo,a as Basic,m as BulkColumns,p as BulkData,w as BulkRows,_ as CellDrag,y as CellFormatter,S as CellRenderer,P as ClipboardEvents,E as ColumnFill,z as ContextMenu,F as CustomRenderer,V as DragDrop,K as ExchangeAPI,X as Finder,nr as MoveAPI,or as MultiInstance,Vr as MultiSelectCellPlugin,dr as OnDialog,ar as OverflowPanelPlugin,mr as RowFilterPlugin,wr as RowSelectionPlugin,_r as SelectLazyItems,pr as SelectValueMap,yr as Sort,Sr as SortRange,Er as TableAndRowFilterPlugin,Pr as TablePlugin,zr as TablePluginRowDraggable,Fr as ThemeConfig,Jr as __namedExportsOrder,Xr as default,Z as i18n};
