import{j as e}from"./jsx-runtime-u17CrQMm.js";import{D as n,a as t,L as i}from"./version-tag-C5kiIE4p.js";import"./iframe-Dxn4oHhn.js";import"./preload-helper-PPVm8Dsz.js";import"./index-D7URE3Da.js";const r=`import { IRDatePicker } from "@innorules/ir-style";\r
\r
new IRDatePicker( {\r
...
new IRDatePicker( {\r
    ...
    format: "MM/DD/YYYY",\r
} );`,d=`<div id="date_picker" style="width: 300px"></div>\r
<br />\r
<div id="date_picker2" style="width: 200px"></div>`;function c(){return e.jsxs(n,{children:[e.jsx(t,{children:"DatePicker"}),e.jsxs("p",{children:[e.jsx("code",{children:"IRDatePicker"})," 컴포넌트를 활용하여 날짜를 선택하는 입력 컨트롤을 표현할 수 있으며 ",e.jsx("code",{children:"format"})," 속성으로 날짜 서식을 지정할 수 있습니다. (기본 값 : YYYY-MM-DD)"]}),e.jsx(i,{fixedHeight:400,htmlRaw:d,code:r})]})}c.__docgenInfo={description:"",methods:[],displayName:"Basic"};const s=`import { IRDatePicker } from "@innorules/ir-style";\r
\r
new IRDatePicker( {\r
...
</div>`;function R(){return e.jsxs(n,{children:[e.jsx(t,{children:"Date Input Range"}),e.jsxs("p",{children:[e.jsx("code",{children:"input-date-range"}),"와 함께 시작~종료일을 나타낼 수 있습니다."]}),e.jsx(i,{fixedHeight:400,htmlRaw:k,code:v})]})}R.__docgenInfo={description:"",methods:[],displayName:"Range"};const M={title:"JS Components/IRDatePicker"},P=["Basic","Disabled","Event","i18n","MinMax","Range"];export{c as Basic,a as Disabled,m as Event,f as MinMax,R as Range,P as __namedExportsOrder,M as default,u as i18n};
