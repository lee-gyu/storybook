import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{D as n,a as e,V as o,c as t,L as l}from"./version-tag-D_C1jUBh.js";import"./iframe-BvK5mbBg.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BIfM9e56.js";const i=`\r
import {\r
...
<div id="ir_grid" style="height: 400px; width: 800px"></div>`,m=[["/classes/_innorules_ir-style.grid.IRGridRowFilterCellRenderer.html","IRGridRowFilterCellRenderer"],["/classes/_innorules_ir-style.grid.IRGridRowFilterPlugin.html","IRGridRowFilterPlugin"]];function w(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid Custom Merge Cell Sorting"}),r.jsxs("p",{children:[r.jsx("code",{children:"IRGridRowFilterPlugin"}),"의 ",r.jsx("code",{children:"columnSortManager.compareTo"}),"를 재정의하여 사용자 정의 정렬 로직을 구현할 수 있습니다.",r.jsx("br",{}),"※ 참고: ",r.jsx("code",{children:"columnSortManager.compareTo"}),"의 ",r.jsx("code",{children:"order"})," 옵션은 v2.22.2 버전 이상부터 지원"]}),r.jsx(t,{docList:m}),r.jsx(l,{htmlRaw:R,exampleCode:u,code:g})]})}w.__docgenInfo={description:"",methods:[],displayName:"RowFilterPlugin"};const _={title:"JS Components/IRGrid/RowFilterPlugin"},p=["Basic","CustomMergeCellSorting"];export{a as Basic,w as CustomMergeCellSorting,p as __namedExportsOrder,_ as default};
