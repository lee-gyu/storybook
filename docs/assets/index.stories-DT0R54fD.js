import{j as o}from"./jsx-runtime-u17CrQMm.js";import{D as n,a as r,c as i,L as e,V as t}from"./version-tag-DqccibA3.js";import"./iframe-D3tc5L3-.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DQMUxHhF.js";const l=`import { createPopover } from "@innorules/ir-style";\r
\r
...
</div>`,d=[["/classes/_innorules_ir-style.index.IRPopover.html","IRPopover"]];function c(){return o.jsxs(n,{children:[o.jsx(r,{children:"bringToTop"}),o.jsx("p",{children:"createPopover 핸들러의 bringToTop API를 이용해서 zIndex 순서를 제어할 수 있습니다."}),o.jsx(i,{docList:d}),o.jsx(e,{fixedHeight:500,htmlRaw:s,code:l,exampleCode:a})]})}c.__docgenInfo={description:"",methods:[],displayName:"BringToTop"};const g=`import { createPopover } from "@innorules/ir-style";\r
\r
const dialog1Popover = createPopover( {\r
    element: dialog1,\r
    type: "dialog",\r
...
</div>`,p=[["/classes/_innorules_ir-style.index.IRPopover.html","IRPopover"],["/variables/_innorules_ir-style.index.createPopover.html","createPopover"]];function _(){return o.jsxs(n,{children:[o.jsx(r,{children:"createPopover"}),o.jsx("p",{children:"내부 z-index 표준 시스템을 적용하여 Dialog를 화면에 표시합니다. (ESC를 누르면 가장 최상위 다이얼로그가 종료됩니다.)"}),o.jsx(i,{docList:p}),o.jsx(e,{fixedHeight:500,htmlRaw:v,exampleCode:g})]})}_.__docgenInfo={description:"",methods:[],displayName:"CreatePopover"};const b=`import { createPopover } from "@innorules/ir-style";\r
\r
...
</div>`,m=[["/variables/_innorules_ir-style.index.createPopover.html","createPopover"],["/types/_innorules_ir-style.index.PopoverArgs.html","PopoverArgs"]];function h(){return o.jsxs(n,{children:[o.jsx(r,{children:"parentElement"}),o.jsx("p",{children:"부모 요소를 지정하여 DOM 마운트를 제어 합니다."}),o.jsx(i,{docList:m}),o.jsx(e,{fixedHeight:500,htmlRaw:u,exampleCode:b})]})}h.__docgenInfo={description:"",methods:[],displayName:"ParentElement"};const P=`import { createPopover } from "@innorules/ir-style";\r
\r
const dialog1Popover = createPopover( {\r
    element: dialog1,\r
    type: "dialog",\r
...
globalThis.dialog3Popover = dialog3Popover;`,x=`import { IRDialogManager } from "@innorules/ir-style/lib/esm/solid.js";\r
\r
/**\r
 * DialogManager 생성\r
...
minimize3.onclick = () => dialog3Popover.minimize( manager, "새 다이얼로그", "ir-icon--add" );`,y=`<div>\r
    <button id="btn1" class="button">다이얼로그 출력</button>\r
...
</div>`,f=[["/classes/_innorules_ir-style.index.IRPopover.html","IRPopover"]];function j(){return o.jsxs(n,{children:[o.jsx(r,{children:"IRDialogManager"}),o.jsx(t,{children:"ir-style@^2.20.0"}),o.jsxs("p",{children:["다이얼로그를 최소화하고 하단에 버튼으로 관리할 수 있는 매니저입니다.",o.jsx("br",{}),"createPopover 핸들러의 minimize API를 이용해서 최소화할 수 있으며, 버튼을 누르면 다시 열 수 있습니다."]}),o.jsx(i,{docList:f}),o.jsx(e,{fixedHeight:500,htmlRaw:y,code:P,exampleCode:x})]})}j.__docgenInfo={description:"",methods:[],displayName:"DialogManager"};const I={title:"JS Utility/Popover"},D=["BringToTop","CreatePopover","ParentElement","DialogManager"];export{c as BringToTop,_ as CreatePopover,j as DialogManager,h as ParentElement,D as __namedExportsOrder,I as default};
