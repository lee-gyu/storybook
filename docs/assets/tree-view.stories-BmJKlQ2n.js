import{j as n}from"./jsx-runtime-Y5Ju2SGo.js";import{D as e,a as t,L as o,V as i}from"./version-tag-DunVkkeT.js";import"./index-eCxJ45ll.js";const r=`import { IRTreeView, uuid, IRSplitContainer, IRContextMenu, i18n } from "@innorules/ir-style";
...
</div>`;function h(){return n.jsx("input",{type:"checkbox",className:"checkbox__input","data-state":"sub-checked",style:{pointerEvents:"none"}})}function g(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRTreeView"}),n.jsx(i,{children:"ir-style@^2.14.0"}),n.jsxs("p",{children:[n.jsx("code",{children:"IRTreeViewCascadeCheckingPlugin"}),"을 이용하여 부모/자식 간의 체크 상태 전파 기능을 추가할 수 있습니다."]}),n.jsxs("ul",{children:[n.jsxs("li",{children:[n.jsx("code",{children:"disabled"})," 상태의 자식 노드로 체크됩니다."]}),n.jsxs("li",{children:[n.jsx(h,{})," ",n.jsx("code",{children:"subChecked"}),": 모두 체크되어 있지 않고, 1개 이상 체크된 경우 true"]})]}),n.jsx(o,{htmlRaw:u,code:p})]})}g.__docgenInfo={description:"",methods:[],displayName:"CascadeChecking"};const m=`import { IRTreeView } from "@innorules/ir-style";
...
</div>`;function y(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRTreeView"}),n.jsx("p",{children:"Checkbox 사용 케이스 (inner, column 레이아웃 2가지 모드 제공, ui는 checkbox, favorite 2가지 스타일 제공)"}),n.jsx(o,{htmlRaw:b,code:m})]})}y.__docgenInfo={description:"",methods:[],displayName:"Checkbox"};const x=`import { IRTreeView } from "@innorules/ir-style";
...
<div>
    ...
    <div id="temp"></div>
</div>`;function S(){return n.jsxs(e,{children:[n.jsx(t,{children:"IRTreeView"}),n.jsx(i,{children:"ir-style@^2.17.0"}),n.jsxs("p",{children:[n.jsx("code",{children:"IRTreeViewTooltipPlugin"}),"을 이용하여 tooltip 기능을 사용하실 수 있습니다.",n.jsx("br",{}),"※ 비활성화 노드와 빈 값은 툴팁이 적용되지 않습니다."]}),n.jsx(o,{htmlRaw:R,code:N})]})}S.__docgenInfo={description:"",methods:[],displayName:"Tooltip"};const V={title:"JS Components/IRTreeView"},P=["Basic","BulkData","CascadeChecking","Checkbox","DragDrop","DragDropMove","StickyColumn","Tooltip"];export{l as Basic,s as BulkData,g as CascadeChecking,y as Checkbox,v as DragDrop,f as DragDropMove,I as StickyColumn,S as Tooltip,P as __namedExportsOrder,V as default};
