import{j as o}from"./jsx-runtime-DEdD30eg.js";import{D as l,A as d}from"./index-DRMmGMIW.js";import{D as t,a as c,L as g,c as e}from"./doc-content-TwLFnQmr.js";import"./index-RYns6xqu.js";const s="dialog",a={dialog:{"&":s,transparent:`${s}--transparent`,"is-visible":"is-visible"},dialogWrapper:{"&":`${s}__wrapper`},dialogHeader:{"&":`${s}__header`},dialogHeaderTitle:{"&":`${s}__header-title`},dialogHeaderActions:{"&":`${s}__header-actions`},dialogContent:{"&":`${s}__content`},dialogFooter:{"&":`${s}__footer`},dialogFooterLeft:{"&":`${s}__footer-left`},dialogFooterRight:{"&":`${s}__footer-right`},dialogButtonClose:{"&":`${s}__button-close`}},C={title:"JS Utility/Create Popover"},m=`
body > div {
    height: 500px;
