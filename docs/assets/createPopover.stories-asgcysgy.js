import{j as o}from"./jsx-runtime-CkxqCPlQ.js";import{b as l,a as d}from"./index-B7QSYDRL.js";import{D as t,a as c,L as g,c as e}from"./version-tag-BPwPDPyQ.js";import"./index-DJO9vBfz.js";const s="dialog",a={dialog:{"&":s,transparent:`${s}--transparent`,"is-visible":"is-visible"},dialogWrapper:{"&":`${s}__wrapper`},dialogHeader:{"&":`${s}__header`},dialogHeaderTitle:{"&":`${s}__header-title`},dialogHeaderActions:{"&":`${s}__header-actions`},dialogContent:{"&":`${s}__content`},dialogFooter:{"&":`${s}__footer`},dialogFooterLeft:{"&":`${s}__footer-left`},dialogFooterRight:{"&":`${s}__footer-right`},dialogButtonClose:{"&":`${s}__button-close`}},C={title:"JS Utility/Create Popover"},m=`
body > div {
    height: 500px;
