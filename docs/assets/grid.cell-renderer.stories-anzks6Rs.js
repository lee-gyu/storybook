import{j as n,a as e,F as d}from"./jsx-runtime-KzWSGvcx.js";import{D as i,a as s,L as u}from"./doc-content-Y1bYfLkc.js";import"./index-DogsOklH.js";import"./index-xS4YNjdq.js";const x={title:"JS Components/Grid"},r=()=>n(i,{children:[e(s,{children:"IRGrid"}),n("p",{children:[e("code",{children:"cellRenderer"}),"를 재정의하여 여러 타입의 셀을 출력할 수 있습니다."]}),e(u,{html:n(d,{children:[e("div",{className:"mb--lg",children:e("button",{id:"btn_check_commands",className:"button",children:"Check commands"})}),e("div",{id:"ir_grid",style:{height:500,width:1300}})]}),code:`
...
const outlineButtonRenderer = libGrid.renderGridButton({
    onClick: (ev, row, col) => {
        console.log(col);
...
grid.setCell(2, 10, { text: "", icon: "save", horizontalAlign: "center" })
...
`})]});var t,l,o;r.parameters={...r.parameters,docs:{...(t=r.parameters)==null?void 0:t.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(o=(l=r.parameters)==null?void 0:l.docs)==null?void 0:o.source}}};const m=["CellRenderer"];export{r as CellRenderer,m as __namedExportsOrder,x as default};
