import{j as o,c as e}from"./index-BVpe1bT6.js";import{E as l,Z as d}from"./index-rXZW3N37.js";import{D as t,a as c,L as g}from"./doc-content-BzTGzIX_.js";import"./index-RYns6xqu.js";const s="dialog",a={dialog:{"&":s,transparent:`${s}--transparent`,"is-visible":"is-visible"},dialogWrapper:{"&":`${s}__wrapper`},dialogHeader:{"&":`${s}__header`},dialogHeaderTitle:{"&":`${s}__header-title`},dialogHeaderActions:{"&":`${s}__header-actions`},dialogContent:{"&":`${s}__content`},dialogFooter:{"&":`${s}__footer`},dialogFooterLeft:{"&":`${s}__footer-left`},dialogFooterRight:{"&":`${s}__footer-right`},dialogButtonClose:{"&":`${s}__button-close`}},C={title:"JS Utility/Create Popover"},m=`
body > div {
    height: 500px;
