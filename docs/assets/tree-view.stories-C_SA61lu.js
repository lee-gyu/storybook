import{j as n}from"./jsx-runtime-u17CrQMm.js";import{D as e,a as r,L as t,V as o}from"./version-tag-DqccibA3.js";import"./iframe-D3tc5L3-.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DQMUxHhF.js";const i=`import { IRTreeView, uuid, IRSplitContainer, IRContextMenu, i18n } from "@innorules/ir-style";\r
\r
...
<div id="container" style="display: grid; width: 320px; height: 300px; border: 1px solid var(--border-color)"></div>`;function s(){return n.jsxs(e,{children:[n.jsx(r,{children:"IRTreeView"}),n.jsx("p",{children:"50,000 Row 처리 케이스"}),n.jsx(t,{htmlRaw:c,code:a})]})}s.__docgenInfo={description:"",methods:[],displayName:"BulkData"};const p=`import { IRTreeView } from "@innorules/ir-style";\r
\r
const tree = new IRTreeView( {\r
    showCheckbox: true,\r
    showIcon: true,\r
...
\r
globalThis.tree = tree;`,u=`import { IRTreeViewCascadeCheckingPlugin } from "@innorules/ir-style";\r
\r
globalThis.tree.addPlugin( new IRTreeViewCascadeCheckingPlugin( {\r
...
`,g='<div id="treeContainer" class="border"></div>';function m(){return n.jsx("input",{type:"checkbox",className:"checkbox__input","data-state":"sub-checked",style:{pointerEvents:"none"}})}function y(){return n.jsxs(e,{children:[n.jsx(r,{children:"IRTreeView"}),n.jsx(o,{children:"ir-style@^2.14.0"}),n.jsxs("p",{children:[n.jsx("code",{children:"IRTreeViewCascadeCheckingPlugin"}),"을 이용하여 부모/자식 간의 체크 상태 전파 기능을 추가할 수 있습니다."]}),n.jsxs("ul",{children:[n.jsxs("li",{children:[n.jsx("code",{children:"disabled"})," 상태의 자식 노드로 체크됩니다."]}),n.jsxs("li",{children:[n.jsx(m,{})," ",n.jsx("code",{children:"subChecked"}),": 모두 체크되어 있지 않고, 1개 이상 체크된 경우 true"]})]}),n.jsx(t,{css:h,htmlRaw:g,code:p,exampleCode:u})]})}y.__docgenInfo={description:"",methods:[],displayName:"CascadeChecking"};const b=`import { IRTreeView } from "@innorules/ir-style";\r
\r
const args = {\r
    showIcon: true,\r
    showCheckbox: true,\r
...
} );`,x=`<div style="display: grid; gap: 8px; grid-auto-flow: column; grid-auto-columns: 300px; height: 300px">\r
    <div id="tc1" class="border" style="display: grid"></div>\r
    <div id="tc2" class="border" style="display: grid"></div>\r
    <div id="tc3" class="border" style="display: grid"></div>\r
</div>`;function k(){return n.jsxs(e,{children:[n.jsx(r,{children:"IRTreeView"}),n.jsx("p",{children:"Checkbox 사용 케이스 (inner, column 레이아웃 2가지 모드 제공, ui는 checkbox, favorite 2가지 스타일 제공)"}),n.jsx(t,{htmlRaw:x,code:b})]})}k.__docgenInfo={description:"",methods:[],displayName:"Checkbox"};const v=`import { IRTreeView } from "@innorules/ir-style";\r
...
\r
    ...
    <div id="treeContainer" class="border" style="display: grid"></div>\r
    <div id="gridContainer" style="display: grid"></div>\r
</div>`;function w(){return n.jsxs(e,{children:[n.jsx(r,{children:"IRTreeView"}),n.jsx("p",{children:"DragDrop 처리 케이스 (현재 예제에서는 rootNode는 dragging 처리 불가)"}),n.jsx(t,{htmlRaw:C,code:v})]})}w.__docgenInfo={description:"",methods:[],displayName:"DragDrop"};const f=`import {\r
    IRTreeView,\r
...
\r
    ...
    <div id="treeContainer1" class="border" style="display: grid"></div>\r
    <div id="treeContainer2" class="border" style="display: grid"></div>\r
</div>`;function D(){return n.jsxs(e,{children:[n.jsx(r,{children:"IRTreeViewDragDropMovePlugin"}),n.jsxs("ol",{className:"ir-list-disc ir-pl-[20px] ir-mb-[8px]",children:[n.jsx("li",{children:"canNodeMoveStart dragStart 시작 검사"}),n.jsx("li",{children:"canNodeMoveDragOver dragOver 처리 검사"}),n.jsx("li",{children:"canNodeMoveDrop drop 처리 여부 검사"})]}),n.jsx(t,{htmlRaw:_,code:f})]})}D.__docgenInfo={description:"",methods:[],displayName:"DragDropMove"};const I=`import {\r
    IRTreeView,\r
...
};`,N=`<button id="change_btn" class="button mb--lg">룰(메인) 너비 변경</button>\r
...
<div class="split-container">\r
    ...
    <div id="temp"></div>\r
</div>`;function R(){return n.jsxs(e,{children:[n.jsx(r,{children:"IRTreeView"}),n.jsx(o,{children:"ir-style@^2.14.1"}),n.jsxs("p",{children:[n.jsx("code",{children:"IRTreeViewColStickyPlugin"}),"을 이용하여 Content 컬럼을 제외한 우측 컬럼을 고정할 수 있습니다.",n.jsx("br",{}),"※ 최대 5개만 고정이 가능합니다."]}),n.jsx(t,{htmlRaw:N,code:I})]})}R.__docgenInfo={description:"",methods:[],displayName:"StickyColumn"};const S=`import {\r
    IRTreeView,\r
...
\r
// remove_btn.onclick = () => tree.removePlugin(tooltipPlugin);`,j=`<button id="remove_btn" class="button mb--lg">Remove Plugin</button>\r
<div>\r
    <div id="treeview" style="display: grid; height: 300px; border: 1px solid var(--border-color)"></div>\r
    <div id="temp"></div>\r
</div>`;function T(){return n.jsxs(e,{children:[n.jsx(r,{children:"IRTreeView"}),n.jsx(o,{children:"ir-style@^2.17.0"}),n.jsxs("p",{children:[n.jsx("code",{children:"IRTreeViewTooltipPlugin"}),"을 이용하여 tooltip 기능을 사용하실 수 있습니다.",n.jsx("br",{}),"※ 비활성화 노드와 빈 값은 툴팁이 적용되지 않습니다."]}),n.jsx(t,{htmlRaw:j,code:S})]})}T.__docgenInfo={description:"",methods:[],displayName:"Tooltip"};const H={title:"JS Components/IRTreeView"},M=["Basic","BulkData","CascadeChecking","Checkbox","DragDrop","DragDropMove","StickyColumn","Tooltip"];export{l as Basic,s as BulkData,y as CascadeChecking,k as Checkbox,w as DragDrop,D as DragDropMove,R as StickyColumn,T as Tooltip,M as __namedExportsOrder,H as default};
