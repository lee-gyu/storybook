import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{D as t,a as e,L as r}from"./version-tag-CkTpihZX.js";import"./iframe-jo4tttFm.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BDcoFm-e.js";const o=`import { IRConfirm, createTooltipContainer } from "@innorules/ir-style";\r
\r
...
<button id="btn_no" class="button">아니오</button>`;function b(){return n.jsxs(t,{children:[n.jsx(e,{children:"KeyBinding"}),n.jsxs("p",{children:[n.jsx("code",{children:"enterButton"})," 값을 지정하여 엔터 키에 대한 기본 클릭 버튼을 지정합니다."]}),n.jsx(r,{fixedHeight:300,htmlRaw:y,code:u})]})}b.__docgenInfo={description:"",methods:[],displayName:"KeyBinding"};const _={title:"JS Components/IRConfirm"},C=["Basic","CustomButtonText","i18n","KeyBinding"];export{s as Basic,d as CustomButtonText,b as KeyBinding,C as __namedExportsOrder,_ as default,a as i18n};
