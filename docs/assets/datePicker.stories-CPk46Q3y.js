import{j as e}from"./jsx-runtime-Y5Ju2SGo.js";import{D as n,a as t,L as i}from"./version-tag-DunVkkeT.js";import"./index-eCxJ45ll.js";const d=`import { IRDatePicker } from "@innorules/ir-style";
...
</div>`;function R(){return e.jsxs(n,{children:[e.jsx(t,{children:"Date Input Range"}),e.jsxs("p",{children:[e.jsx("code",{children:"input-date-range"}),"와 함께 시작~종료일을 나타낼 수 있습니다."]}),e.jsx(i,{fixedHeight:400,htmlRaw:k,code:v})]})}R.__docgenInfo={description:"",methods:[],displayName:"Range"};const w={title:"JS Components/IRDatePicker"},y=["Basic","Disabled","Event","i18n","MinMax","Range"];export{s as Basic,a as Disabled,m as Event,f as MinMax,R as Range,y as __namedExportsOrder,w as default,u as i18n};
