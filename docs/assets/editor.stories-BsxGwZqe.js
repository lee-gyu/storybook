import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{D as n,a as t,L as e}from"./version-tag-BrgfOmML.js";import"./iframe-CPzXEQh7.js";import"./preload-helper-PPVm8Dsz.js";import"./index-kA2kW7wp.js";const o=`import { IREditor } from "@innorules/ir-style/lib/esm/editor.js";\r
\r
...
\r
editor.addLineClass( 5, "wrap", "ir-highlight" );`,i=`#ir_editor {\r
    height: 200px;\r
}\r
\r
.ir-highlight {\r
...
<button id="btn3" class="button">replace 출력</button>`;function s(){return r.jsxs(n,{children:[r.jsx(t,{children:"IREditor"}),r.jsxs("p",{children:[r.jsx("code",{children:"IREditor"}),"를 이용하여 에디터 스타일을 표현합니다."]}),r.jsx(e,{css:i,htmlRaw:c,exampleCode:o})]})}s.__docgenInfo={description:"",methods:[],displayName:"Basic"};const l=`import { IREditor } from "@innorules/ir-style/lib/esm/editor.js";\r
\r
new IREditor( {\r
    contextElement: document.getElementById( "ir_editor" ),\r
    mode: "ir-db-rule",\r
...
\r
editor.addLineGutter( 0, "ir-breakpoint", createBreakPointGutter() );`,L='<div id="ir_editor"></div>',S=`
#ir_editor {
    height: 200px;
}
`;function C(){return r.jsxs(n,{children:[r.jsx(t,{children:"IREditor"}),r.jsx(e,{css:S,htmlRaw:L,code:k})]})}C.__docgenInfo={description:"",methods:[],displayName:"LineGutter"};const y=`import { IREditor } from "@innorules/ir-style/lib/esm/editor.js";\r
\r
new IREditor( {\r
    contextElement: ir_editor,\r
    mode: "ir-rule-exp",\r
    code: \`  123.123 + "Asdzxc" + {rule} + [항목] + "ㅇㅇㅁㄴㅇㅁㄴ\\\\\\\\"ㅇㅇㅇㅇ"\`,\r
} );`,_='<div id="ir_editor"></div>',f=`#ir_editor {\r
    height: 200px;\r
}\r
\r
.cm-ir-input {\r
...
`;function j(){return r.jsxs(n,{children:[r.jsx(t,{children:"IREditor"}),r.jsx("p",{children:"룰 표현식 문법을 이용하여 에디터 스타일을 표현합니다."}),r.jsx(e,{css:f,htmlRaw:_,code:y})]})}j.__docgenInfo={description:"",methods:[],displayName:"RuleSyntax"};const T=`import { IREditor } from "@innorules/ir-style/lib/esm/editor.js";\r
\r
const editor = new IREditor( {\r
    contextElement: document.getElementById( "ir_editor" ),\r
    mode: "sql-oracle",\r
...
`;function O(){return r.jsxs(n,{children:[r.jsx(t,{children:"IREditor"}),r.jsxs("p",{children:[r.jsx("code",{children:"getSearchCursor"}),"를 검색 기능을 이용합니다."]}),r.jsx(e,{css:w,htmlRaw:I,code:T})]})}O.__docgenInfo={description:"",methods:[],displayName:"Search"};const N={title:"JS Components/IREditor"},G=["Basic","DBRule","HandlingCursor","KeyEvents","LineGutter","RuleSyntax","Search"];export{s as Basic,u as DBRule,h as HandlingCursor,g as KeyEvents,C as LineGutter,j as RuleSyntax,O as Search,G as __namedExportsOrder,N as default};
