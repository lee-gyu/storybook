import{j as u,a as e}from"./jsx-runtime-KzWSGvcx.js";import{D as d,a as i,L as C}from"./doc-content-Y1bYfLkc.js";import"./index-DogsOklH.js";import"./index-xS4YNjdq.js";const B={title:"JS Components/DatePicker"},t=()=>u(d,{children:[e(i,{children:"Event"}),u("p",{children:[e("code",{children:"onSelect"})," 이벤트를 이용하여 선택한 날짜를 제어할 수 있습니다."]}),u("p",{children:[e("code",{children:"onChange"})," 이벤트를 이용하여 값이 변경될 때 이벤트를 호출 받을 수 있습니다."]}),e(C,{fixedHeight:400,html:e("div",{id:"date_picker",style:{width:200}}),code:`
...
}`,...(r=(o=t.parameters)==null?void 0:o.docs)==null?void 0:r.source}}};const D=["Event"];export{t as Event,D as __namedExportsOrder,B as default};
