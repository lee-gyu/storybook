import{j as r,a as e}from"./jsx-runtime-KzWSGvcx.js";import{D as n,a as s,L as l}from"./doc-content-Y1bYfLkc.js";import"./index-DogsOklH.js";import"./index-xS4YNjdq.js";const b={title:"HTML Components/Breadcrumb"},i=()=>r(n,{children:[e(s,{children:"Breadcrumb"}),e(l,{fixedHeight:200,html:e("div",{className:"breadcrumb",children:r("ul",{className:"breadcrumb__list",children:[e("li",{className:"breadcrumb__item",children:"개발"}),e("li",{className:"breadcrumb__item",children:"PoC"}),e("li",{className:"breadcrumb__item",children:r("div",{className:"rule-name",children:[e("i",{className:"ir-icon ir-icon--rule-type-table"}),e("span",{className:"rule-name__text",children:"사이트 목록"})]})}),e("li",{className:"breadcrumb__item",children:e("select",{className:"width--md",children:e("option",{children:"2021-10-15"})})}),e("li",{className:"breadcrumb__item",children:r("button",{type:"button",className:"button button--outline",children:[e("i",{className:"button__icon-prefix ir-icon ir-icon--version-history"})," 버전 관리"]})})]})}),code:`
