import{j as n}from"./jsx-runtime-u17CrQMm.js";import{D as o,a as i,b as e,L as t,V as l}from"./version-tag-BQbZ1r9I.js";import"./iframe-CcqNoikh.js";import"./preload-helper-PPVm8Dsz.js";import"./index-a64PSLyw.js";const a=`import { createPopover } from "@innorules/ir-style";
...
</div>`,p=[["/classes/_innorules_inno-front-core.IRPopover.html","IRPopover"],["/variables/_innorules_inno-front-core.createPopover.html","createPopover"]];function _(){return n.jsxs(o,{children:[n.jsx(i,{children:"createPopover"}),n.jsx("p",{children:"내부 z-index 표준 시스템을 적용하여 Dialog를 화면에 표시합니다. (ESC를 누르면 가장 최상위 다이얼로그가 종료됩니다.)"}),n.jsx(e,{docList:p}),n.jsx(t,{fixedHeight:500,htmlRaw:v,exampleCode:g})]})}_.__docgenInfo={description:"",methods:[],displayName:"CreatePopover"};const b=`import { createPopover } from "@innorules/ir-style";
...
</div>`,u=[["/variables/_innorules_inno-front-core.createPopover.html","createPopover"],["/types/_innorules_inno-front-core.PopoverArgs.html","PopoverArgs"]];function h(){return n.jsxs(o,{children:[n.jsx(i,{children:"parentElement"}),n.jsx("p",{children:"부모 요소를 지정하여 DOM 마운트를 제어 합니다."}),n.jsx(e,{docList:u}),n.jsx(t,{fixedHeight:500,htmlRaw:m,exampleCode:b})]})}h.__docgenInfo={description:"",methods:[],displayName:"ParentElement"};const P=`import { createPopover } from "@innorules/ir-style";
