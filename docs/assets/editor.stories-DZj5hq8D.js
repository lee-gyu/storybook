import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{D as n,a as t,L as e}from"./version-tag-CkTpihZX.js";import"./iframe-jo4tttFm.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BDcoFm-e.js";const o=`import { IREditor } from "@innorules/ir-style/lib/esm/editor.js";\r
\r
...
`;function O(){return r.jsxs(n,{children:[r.jsx(t,{children:"IREditor"}),r.jsxs("p",{children:[r.jsx("code",{children:"getSearchCursor"}),"를 검색 기능을 이용합니다."]}),r.jsx(e,{css:w,htmlRaw:I,code:T})]})}O.__docgenInfo={description:"",methods:[],displayName:"Search"};const N={title:"JS Components/IREditor"},G=["Basic","DBRule","HandlingCursor","KeyEvents","LineGutter","RuleSyntax","Search"];export{c as Basic,u as DBRule,h as HandlingCursor,g as KeyEvents,S as LineGutter,j as RuleSyntax,O as Search,G as __namedExportsOrder,N as default};
