import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{D as e,a as r,L as t,V as o}from"./version-tag-BrgfOmML.js";import"./iframe-CPzXEQh7.js";import"./preload-helper-PPVm8Dsz.js";import"./index-kA2kW7wp.js";const i=`import { IRTreeView, uuid, IRSplitContainer, IRContextMenu, i18n } from "@innorules/ir-style";\r
\r
...
<div id="container" style="display: grid; width: 320px; height: 300px; border: 1px solid var(--border-color)"></div>`;function s(){return n.jsxs(e,{children:[n.jsx(r,{children:"IRTreeView"}),n.jsx("p",{children:"50,000 Row 처리 케이스"}),n.jsx(t,{htmlRaw:c,code:a})]})}s.__docgenInfo={description:"",methods:[],displayName:"BulkData"};const p=`import { IRTreeView } from "@innorules/ir-style";
...
globalThis.tree = tree;`,u=`import { IRTreeViewCascadeCheckingPlugin } from "@innorules/ir-style";

globalThis.tree.addPlugin( new IRTreeViewCascadeCheckingPlugin( {
...
} );`,x=`<div style="display: grid; gap: 8px; grid-auto-flow: column; grid-auto-columns: 300px; height: 300px">
    <div id="tc1" class="border" style="display: grid"></div>
    <div id="tc2" class="border" style="display: grid"></div>
    <div id="tc3" class="border" style="display: grid"></div>
...
\r
    ...
    <div id="treeContainer" class="border" style="display: grid"></div>
...
\r
    ...
    <div id="treeContainer1" class="border" style="display: grid"></div>
    <div id="treeContainer2" class="border" style="display: grid"></div>
