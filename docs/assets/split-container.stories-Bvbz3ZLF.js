import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{D as a,a as p,L as s,V as r}from"./version-tag-CkTpihZX.js";import"./iframe-jo4tttFm.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BDcoFm-e.js";const e=`import { IRSplitContainer } from "@innorules/ir-style";\r
\r
...
\r
split.setSizes( [25, 75] );`,l=`<div class="ir-flex ir-gap-x-xxs ir-p-xs" style="border-bottom: 1px solid var(--border-color);">\r
...
} );`,c=`<div class="border-b--px height--block">\r
...
<div id="container" class="border-t--px border-b--px" style="height: 400px;">\r
    <div id="split-0">\r
        <div id="split-01"></div>\r
        <div id="split-02"></div>\r
    </div>\r
    <div id="split-1">\r
        <div id="tree-view"></div>\r
    </div>\r
...
</div>`;function w(){return n.jsxs(a,{children:[n.jsx(p,{children:"Size 설정"}),n.jsxs("p",{children:[n.jsx("code",{children:"sizes"}),"를 이용하여 해당 패널의 백분율 배열로 지정할 수 있고,",n.jsx("br",{}),n.jsx("code",{children:"minSize(default: 100px), maxSize"}),"의 px를 지정하여 resize 가능한 크기 범위를 지정합니다.",n.jsx("br",{}),n.jsx("code",{children:"Infinity"}),"는 ",n.jsx("code",{children:"minSize"}),"에서 사용 시 설정된 패널 초기 크기로 지정되고, ",n.jsx("code",{children:"maxSize"}),"에서 사용 시 무한으로 늘어날 수 있습니다."]}),n.jsx(s,{css:"#live_editor_wrapper { padding: 0 }",fixedHeight:400,htmlRaw:S,code:C})]})}w.__docgenInfo={description:"",methods:[],displayName:"Size"};const I=`import { IRSplitContainer } from "@innorules/ir-style";\r
\r
new IRSplitContainer( {\r
    elements: ["#split-0", "#split-1", "#split-2"],\r
...
</div>`;function j(){return n.jsxs(a,{children:[n.jsx(p,{children:"IRSplitContainer"}),n.jsx("p",{children:"thin 스타일을 적용하여 얇은 영역 나누기가 가능합니다."}),n.jsx(s,{css:"#live_editor_wrapper { padding: 0 }",fixedHeight:400,htmlRaw:b,code:I})]})}j.__docgenInfo={description:"",methods:[],displayName:"ThinStyle"};const A={title:"JS Components/IRSplitContainer"},D=["API","Basic","DeepNestedCase","Event","GutterClickAction","Size","ThinStyle"];export{P as API,d as Basic,v as DeepNestedCase,x as Event,R as GutterClickAction,w as Size,j as ThinStyle,D as __namedExportsOrder,A as default};
