import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{D as r,a as e,L as o}from"./version-tag-9vMQgyJG.js";import"./iframe-CKHoihc2.js";import"./index-Dprm-oae.js";const t=`\r
...
\r
points[1].x += 35;\r
con3.data["connection.points"] = points;`,b='<div id="flowchart_div" class="border" style="height: 800px"></div>';function h(){return n.jsxs(r,{children:[n.jsx(e,{children:"IRFlowchart"}),n.jsx(o,{htmlRaw:b,code:p})]})}h.__docgenInfo={description:"",methods:[],displayName:"RuleArchitecture"};const w={title:"JS Components/IRFlowchart"},y=["Basic","Export","Multiple","RuleArchitecture"];export{d as Basic,a as Export,u as Multiple,h as RuleArchitecture,y as __namedExportsOrder,w as default};
