import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{D as e,a as r,L as t,V as o}from"./version-tag-9vMQgyJG.js";import"./iframe-CKHoihc2.js";import"./index-Dprm-oae.js";const i=`import { IRTreeView, uuid, IRSplitContainer, IRContextMenu, i18n } from "@innorules/ir-style";\r
\r
...
</div>`;function y(){return n.jsxs(e,{children:[n.jsx(r,{children:"IRTreeView"}),n.jsx("p",{children:"Checkbox 사용 케이스 (inner, column 레이아웃 2가지 모드 제공, ui는 checkbox, favorite 2가지 스타일 제공)"}),n.jsx(t,{htmlRaw:b,code:g})]})}y.__docgenInfo={description:"",methods:[],displayName:"Checkbox"};const x=`import { IRTreeView } from "@innorules/ir-style";\r
...
</div>`;function v(){return n.jsxs(e,{children:[n.jsx(r,{children:"IRTreeView"}),n.jsx("p",{children:"DragDrop 처리 케이스 (현재 예제에서는 rootNode는 dragging 처리 불가)"}),n.jsx(t,{htmlRaw:k,code:x})]})}v.__docgenInfo={description:"",methods:[],displayName:"DragDrop"};const w=`import {\r
    IRTreeView,\r
...
<div>\r
    ...
    <div id="temp"></div>\r
</div>`;function S(){return n.jsxs(e,{children:[n.jsx(r,{children:"IRTreeView"}),n.jsx(o,{children:"ir-style@^2.17.0"}),n.jsxs("p",{children:[n.jsx("code",{children:"IRTreeViewTooltipPlugin"}),"을 이용하여 tooltip 기능을 사용하실 수 있습니다.",n.jsx("br",{}),"※ 비활성화 노드와 빈 값은 툴팁이 적용되지 않습니다."]}),n.jsx(t,{htmlRaw:R,code:N})]})}S.__docgenInfo={description:"",methods:[],displayName:"Tooltip"};const P={title:"JS Components/IRTreeView"},L=["Basic","BulkData","CascadeChecking","Checkbox","DragDrop","DragDropMove","StickyColumn","Tooltip"];export{l as Basic,s as BulkData,m as CascadeChecking,y as Checkbox,v as DragDrop,f as DragDropMove,I as StickyColumn,S as Tooltip,L as __namedExportsOrder,P as default};
