import{j as o,a as t}from"./jsx-runtime-e43ccb36.js";import{D as s,a as l,L as i}from"./doc-content-486f07cf.js";import"./index-1b03fe98.js";import"./index-91038615.js";const _={title:"HTML Components/Side Toolbar"},e=()=>o(s,{children:[t(l,{children:"Side Toolbar"}),t(i,{fixedHeight:400,html:o("div",{className:"side-toolbar",children:[t("button",{type:"button",className:"side-toolbar__button",children:t("i",{className:"side-toolbar__icon ir-icon ir-icon--check-all-rectangle"})}),t("button",{type:"button",className:"side-toolbar__button",children:t("i",{className:"side-toolbar__icon ir-icon ir-icon--uncheck-all-rectangle"})}),t("button",{type:"button",className:"side-toolbar__button",children:t("i",{className:"side-toolbar__icon ir-icon ir-icon--row-del2"})}),t("button",{type:"button",className:"side-toolbar__button",children:t("i",{className:"side-toolbar__icon ir-icon ir-icon--copy"})}),t("button",{type:"button",className:"side-toolbar__button",children:t("i",{className:"side-toolbar__icon ir-icon ir-icon--paste"})}),o("div",{className:"menu-container",children:[t("button",{type:"button",className:"side-toolbar__button",children:t("i",{className:"side-toolbar__icon ir-icon ir-icon--add-return"})}),t("div",{className:"menu menu--top-right",children:o("ul",{className:"menu__list",children:[t("li",{className:"menu__item",children:t("button",{type:"button",className:"menu__button",children:"조건 추가"})}),t("li",{className:"menu__item",children:t("button",{type:"button",className:"menu__button",children:"조건 변경"})}),t("li",{className:"menu__item",children:t("button",{type:"button",className:"menu__button",children:"조건 삽입"})}),t("li",{className:"menu__item",children:t("button",{type:"button",className:"menu__button",children:"조건 삭제"})})]})})]})]}),code:`
...
//# sourceMappingURL=side-toolbar.stories-faef67da.js.map
