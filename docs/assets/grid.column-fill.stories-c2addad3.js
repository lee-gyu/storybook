import{j as n,a as i,F as d}from"./jsx-runtime-e43ccb36.js";import{D as o,a as s,L as a}from"./doc-content-486f07cf.js";import"./index-1b03fe98.js";import"./index-91038615.js";const g={title:"JS Components/Grid"},e=()=>n(o,{children:[i(s,{children:"IRGrid ColumnFill"}),i("p",{children:"ColumnFill 플러그인을 등록하여 현재 Context 크기에 맞게 모든 열 크기를 균등 분배합니다. (추후 설정된 너비는 각 너비에 맞게 고루 분배됨)"}),n("p",{children:["colHeader의 ",i("code",{children:"maxSize"}),"를 9999로 설정해야 열 크기 제한 문제가 없습니다."]}),i(a,{fixedHeight:600,html:n(d,{children:[i("button",{id:"btn1",className:"button",children:"visible on/off"}),n("div",{className:"split-container flex background--light",children:[i("div",{id:"split1",children:i("div",{id:"ir_grid",className:"",style:{height:500,width:"100%",display:"none"}})}),i("div",{id:"split2"})]})]}),code:`
...
\`} />\r
    </Doc>`,...(t=(l=e.parameters)==null?void 0:l.docs)==null?void 0:t.source}}};const C=["ColumnFill"];export{e as ColumnFill,C as __namedExportsOrder,g as default};
//# sourceMappingURL=grid.column-fill.stories-c2addad3.js.map
