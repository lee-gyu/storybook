...
window.addEventListener('click', (e) => {
    ...
    if (target.classList.contains('collapse__button')) {
        ...
        if (target.classList.contains('is-active') === false) {
            ...
            `})]});n.__docgenInfo={description:"",methods:[],displayName:"Collapse"};var t,s,a;n.parameters={...n.parameters,docs:{...(t=n.parameters)==null?void 0:t.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(a=(s=n.parameters)==null?void 0:s.docs)==null?void 0:a.source}}};const _=["Collapse"];export{n as Collapse,_ as __namedExportsOrder,m as default};
