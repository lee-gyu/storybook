import{n as e}from"./chunk-BneVvdWh.js";import{a as t,o as n,s as r,t as i}from"./context-C6uFeUW4.js";import{t as a}from"./jsx-runtime-6sF1Ejqi.js";var o,s=e((()=>{o=`mockEntryParam( {
...
}`})),c,l=e((()=>{c=`import { InnoAppStatusBar } from "@innorules/ir-style/lib/esm/solid.js";
...
InnoAppStatusBar.initText( {
    ...
    // copyright: "Copyright 2007. INNOAX Corporation. All rights reserved.",
    // vendor: "InnoAX Co.,LTD.",
...
btn_destroy.onclick = () => innoAppStatusBar.destroy();`})),u,d=e((()=>{u=`<div class="flex flex--column" style="height: 400px; border: 1px solid lightgray">
...
</div>`}));function f(){return(0,p.jsxs)(n,{children:[(0,p.jsx)(t,{children:`InnoAppStatusBar`}),(0,p.jsx)(`p`,{children:`현재 서비스의 제품 정보, 라이선스, 서비스 전환 등을 표시하는 상태바 컴포넌트입니다.`}),(0,p.jsx)(r,{htmlRaw:u,code:o,exampleCode:c})]})}var p,m,h;e((()=>{s(),l(),d(),i(),p=a(),m={title:`SolidJS Components/InnoAppStatusBar`},f.__docgenInfo={description:``,methods:[],displayName:`InnoAppStatusBar`},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`function InnoAppStatusBar() {
  return <Doc>
...
}`,...f.parameters?.docs?.source}}},h=[`InnoAppStatusBar`]}))();export{f as InnoAppStatusBar,h as __namedExportsOrder,m as default};