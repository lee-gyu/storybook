import{j as e}from"./jsx-runtime-u17CrQMm.js";import{D as r,a as n,c as t,L as l}from"./version-tag-B2V-8a8w.js";import"./iframe-72AAcSIy.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CfaMo4xr.js";const d=`globalThis.setupGrid = ( grid ) =>\r
{\r
    // column 1: 기본값\r
...
<div id="ir_grid" style="height: 500px; width: 1300px"></div>`,g=[["/classes/_innorules_grid.IRGridCellRenderer.html","IRGridCellRenderer"],["/classes/_innorules_grid.IRGridCheckboxRenderer.html","IRGridCheckboxRenderer"],["/types/_innorules_grid.RenderGridCheckboxArgs.html","Type Alias RenderGridCheckboxArgs"]];function m(){return e.jsxs(r,{children:[e.jsx(n,{children:"IRGridCheckboxRenderer"}),e.jsx(t,{docList:g}),e.jsx(l,{htmlRaw:R,code:c,exampleCode:u})]})}m.__docgenInfo={description:"",methods:[],displayName:"CellRenderer"};const C=`import { IRGridDefaultCellRenderer } from "@innorules/ir-style/lib/esm/grid.js";\r
\r
globalThis.setupGrid = ( grid ) =>\r
{\r
    // 헤더 설정\r
...
\r
setupGrid( grid );`,p='<div id="ir_grid" style="height: 500px; width: 1300px"></div>',h=[["/classes/_innorules_grid.IRGridCellRenderer.html","IRGridCellRenderer"],["/classes/_innorules_grid.IRGridRadioCellRenderer.html","IRGridRadioCellRenderer"],["/types/_innorules_grid.RenderGridRadioArgs.html","Type Alias RenderGridRadioArgs"]];function f(){return e.jsxs(r,{children:[e.jsx(n,{children:"IRGridRadioCellRenderer"}),e.jsx(t,{docList:h}),e.jsx(l,{htmlRaw:p,code:C,exampleCode:x})]})}f.__docgenInfo={description:"",methods:[],displayName:"CellRenderer"};const w=`const items = [\r
    { value: "ko", text: "한국어" },\r
    { value: "en", text: "영어" },\r
...
\r
setupGrid( grid );`,D='<div id="ir_grid" style="height: 500px; width: 1300px"></div>',k=[["/classes/_innorules_grid.IRGridCellRenderer.html","IRGridCellRenderer"],["/classes/_innorules_grid.IRGridDatePickerRenderer.html","IRGridDatePickerRenderer"],["/types/_innorules_grid.RenderDatePickerArgs.html","Type Alias RenderDatePickerArgs"]];function S(){return e.jsxs(r,{children:[e.jsx(n,{children:"IRGridDatePickerRenderer"}),e.jsx(t,{docList:k}),e.jsx(l,{htmlRaw:D,code:_,exampleCode:y})]})}S.__docgenInfo={description:"",methods:[],displayName:"CellRenderer"};const v=`import { IRGridDefaultCellRenderer } from "@innorules/ir-style/lib/esm/grid.js";\r
\r
globalThis.setupGrid = ( grid ) =>\r
{\r
    // 헤더 설정\r
...
\r
globalThis.defaultRenderer = new IRGridDefaultCellRenderer();`,E=`import {\r
    IRGrid,\r
...
\r
// 클래스형 렌더러\r
class IRGridCustomCellRenderer extends IRGridDefaultCellRenderer\r
{\r
    render( row, col, data )\r
    {\r
        const element = document.createElement( "div" );\r
\r
        // IRGrid 기본 셀 패딩 적용을 위해 속성 설정\r
        ...
        element.setAttribute( "data-has-py", "" );\r
        element.className = "ir_grid_cell_content";\r
        element.innerHTML = "class = <span style='color: blue;'>[abc]</span>";\r
\r
        return element;\r
    }\r
\r
    getCellTextOptions( cell )\r
    {\r
        return {\r
            ...super.getCellTextOptions( cell ),\r
            text: "class = [abc]",\r
        };\r
    }\r
}\r
...
new IRGrid( {\r
    ...
    body: {\r
        ...
        {\r
            switch ( col )\r
            {\r
                case 2: return customRenderer( row, col, data );\r
                case 3: return new IRGridCustomCellRenderer( row, col, data );\r
                default: return defaultRenderer;\r
            }\r
        },\r
    },\r
