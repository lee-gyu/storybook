import{j as e}from"./jsx-runtime-CkxqCPlQ.js";import{D as o,a as i,L as r}from"./version-tag-BPwPDPyQ.js";import"./index-DJO9vBfz.js";const a={title:"JS Components/IRSelect"},n=()=>e.jsxs(o,{children:[e.jsx(i,{children:"Disabled"}),e.jsxs("p",{children:[e.jsx("code",{children:"disabled"})," 속성을 이용하여 비활성화 합니다."]}),e.jsx(r,{fixedHeight:400,html:e.jsxs(e.Fragment,{children:[e.jsxs("label",{children:[e.jsx("input",{type:"checkbox"})," 비활성화"]}),e.jsxs("select",{style:{display:"none"},children:[e.jsx("option",{children:"한국어"}),e.jsx("option",{children:"English"})]})]}),code:`
