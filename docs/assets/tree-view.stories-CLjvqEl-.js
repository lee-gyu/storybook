import{j as e}from"./jsx-runtime-u17CrQMm.js";import{D as n,a as t,b as o,L as i,V as r}from"./version-tag-BQbZ1r9I.js";import"./iframe-CcqNoikh.js";import"./preload-helper-PPVm8Dsz.js";import"./index-a64PSLyw.js";const d=`import { IRSplitContainer, IRContextMenu } from "@innorules/ir-style";
...
`,c=[["/classes/_innorules_tree-view.IRTreeView.html","IRTreeView"],["/types/_innorules_tree-view.IRTreeViewArgs.html","IRTreeViewArgs"]];function u(){return e.jsxs(n,{children:[e.jsx(t,{children:"IRTreeView"}),e.jsx("p",{children:"기존 IRTree의 구조적인 문제를 개선하여 고성능의 확장성 높고, 다양한 기능을 제공하는 확장 버전의 Tree UI 컴포넌트 입니다."}),e.jsx(o,{docList:c}),e.jsx(i,{htmlRaw:a,css:s,code:d,exampleCode:l})]})}u.__docgenInfo={description:"",methods:[],displayName:"Basic"};const p=`import { IRTreeView } from "@innorules/ir-style";
