import{j as n}from"./jsx-runtime-Y5Ju2SGo.js";import{D as t,a as e,L as o}from"./version-tag-D9L4qBs8.js";import"./index-eCxJ45ll.js";const i=`import { IRConfirm, createTooltipContainer } from "@innorules/ir-style";
...
<button id="btn_no" class="button">아니오</button>`;function b(){return n.jsxs(t,{children:[n.jsx(e,{children:"KeyBinding"}),n.jsxs("p",{children:[n.jsx("code",{children:"enterButton"})," 값을 지정하여 엔터 키에 대한 기본 클릭 버튼을 지정합니다."]}),n.jsx(o,{fixedHeight:300,htmlRaw:y,code:u})]})}b.__docgenInfo={description:"",methods:[],displayName:"KeyBinding"};const w={title:"JS Components/IRConfirm"},g=["Basic","CustomButtonText","i18n","KeyBinding"];export{r as Basic,d as CustomButtonText,b as KeyBinding,g as __namedExportsOrder,w as default,a as i18n};
