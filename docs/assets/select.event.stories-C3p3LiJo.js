import{j as e}from"./jsx-runtime-DEdD30eg.js";import{D as r,a as i,L as c}from"./doc-content-TwLFnQmr.js";import"./index-RYns6xqu.js";const p={title:"JS Components/IRSelect"},t=()=>e.jsxs(r,{children:[e.jsx(i,{children:"Event"}),e.jsxs("p",{children:[e.jsx("code",{children:"onChange"})," 이벤트를 이용하여 값 변경 시 이벤트를 받을 수 있습니다."]}),e.jsx(c,{fixedHeight:400,html:e.jsxs("select",{style:{display:"none"},children:[e.jsx("option",{"data-key":"A",children:"한국어"}),e.jsx("option",{children:"English"})]}),code:`
...
}`,...(s=(o=t.parameters)==null?void 0:o.docs)==null?void 0:s.source}}};const m=["Event"];export{t as Event,m as __namedExportsOrder,p as default};
