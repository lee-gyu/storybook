import{j as r}from"./jsx-runtime-u17CrQMm.js";import{D as n,a as e,L as t,c as o,V as i}from"./version-tag-DqccibA3.js";import"./iframe-D3tc5L3-.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DQMUxHhF.js";const l=`import {\r
    IRGrid,\r
...
<div id="ir_grid" style="height: 500px; width: 1300px"></div>`;function s(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsx("p",{children:"API 사용 샘플"}),r.jsx(t,{fixedHeight:700,htmlRaw:d,code:l})]})}s.__docgenInfo={description:"",methods:[],displayName:"APIDemo"};const c=`// TEST\r
globalThis.createGrid( "#ir_grid", 5000, 100 );\r
globalThis.createGrid( "#ir_grid2", 100, 5000 );`,a=`import { IRGrid, IRGridDefaultCellRenderer } from "@innorules/ir-style/lib/esm/grid.js";\r
\r
globalThis.createGrid = ( elementId, colCount, rowCount ) =>\r
{\r
    const defaultRenderer = new IRGridDefaultCellRenderer();\r
\r
    return new IRGrid( {\r
        contextElement: document.querySelector( elementId ),\r
        colHeader: {\r
            rowCount: 1,\r
            colCount: colCount,\r
            cellRenderer: ( row, col, data ) =>\r
        ...
        body: {\r
            ...
            cellRenderer: ( row, col, data ) =>\r
            {\r
                if( !data.text ) data.text = \`\${row},\${col}\`;\r
\r
                return defaultRenderer;\r
            },\r
        },\r
        rowHeader: {\r
            ...
            cellRenderer: ( row, col, data ) =>\r
            {\r
                if( !data.text ) data.text = row.toString();\r
                return defaultRenderer;\r
            },\r
        },\r
    } );\r
...
`,g=`<div class="grid-container">\r
    <div class="grid-item">\r
        <h4>Column 5,000개</h4>\r
        <div id="ir_grid" style="height: 500px; width: 100%"></div>\r
    </div>\r
    <div class="grid-item">\r
        <h4>Row 5,000개</h4>\r
        <div id="ir_grid2" style="height: 500px; width: 100%"></div>\r
    </div>\r
...
\r
`,p='<div id="ir_grid" style="height: 500px; width: 1300px"></div>';function h(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsx(t,{htmlRaw:p,code:b})]})}h.__docgenInfo={description:"",methods:[],displayName:"CellFormatter"};const _=`import { IRSplitContainer } from "@innorules/ir-style";\r
import {\r
    IRGrid,\r
    IRGridRowNoHeaderCellRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
...
<div class="flex background--light" style="height: 520px;">\r
    ...
    <div id="split2"></div>\r
</div>`,w=[["/classes/_innorules_ir-style.grid.IRGridColumnFillPlugin.html","IRGridColumnFillPlugin"]];function C(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid ColumnFill"}),r.jsxs("p",{children:["ColumnFill 플러그인을 등록하여 현재 Context 크기에 맞게 모든 열 크기를 균등 분배합니다. (추후 설정된 너비는 각 너비에 맞게 고루 분배됨)",r.jsx("br",{}),"colHeader의 ",r.jsx("code",{children:"maxSize"}),"를 9999로 설정해야 열 크기 제한 문제가 없습니다."]}),r.jsx(o,{docList:w}),r.jsx(t,{fixedHeight:600,htmlRaw:R,code:_,exampleCode:x})]})}C.__docgenInfo={description:"",methods:[],displayName:"ColumnFill"};const f=`import {\r
    IRGrid,\r
    IRGridRowNoHeaderCellRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
\r
...
\r
globalThis.grid = grid;`,v=`import { IRContextMenu } from "@innorules/ir-style";\r
\r
...
`,y='<div id="ir_grid" style="height: 500px; width: 800px"></div>',I=[["/classes/_innorules_ir-style.index.IRContextMenu.html","IRContextMenu"],["/classes/_innorules_ir-style.grid.IRGrid.html#oncontextmenu","IRGrid.onContextMenu"]];function k(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid ContextMenu"}),r.jsx(o,{docList:I}),r.jsx(t,{htmlRaw:y,code:f,exampleCode:v})]})}k.__docgenInfo={description:"",methods:[],displayName:"ContextMenu"};const S=`import {\r
    IRGrid,\r
    IRGridDefaultCellRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
\r
...
} );`,G='<div id="ir_grid" style="height: 500px; width: 1300px"></div>',M=[["/classes/_innorules_ir-style.grid.CustomCellRenderer.html","CustomCellRenderer"]];function j(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsxs("p",{children:[r.jsx("code",{children:"cellRenderer"}),"인터페이스를 임의로 작성하여 다양한 셀 형태를 출력할 수 있습니다."]}),r.jsx(o,{docList:M}),r.jsx(t,{htmlRaw:G,exampleCode:S})]})}j.__docgenInfo={description:"",methods:[],displayName:"CustomRenderer"};const T=`import {\r
    IRGrid,\r
...
\r
globalThis.grid = grid;`,P=`import { IRGridExchangeByHeaderCellPlugin } from "@innorules/ir-style/lib/esm/grid.js";\r
\r
const grid = globalThis.grid;\r
\r
...
<div id="ir_grid" style=" height: 500px; width: 800px"></div>`,H=[["/classes/_innorules_ir-style.grid.IRGridExchangeByHeaderCellPlugin.html","IRGridExchangeByHeaderCellPlugin"]];function D(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsx("p",{children:"헤더를 드래그하여 셀 내용 교체할 수 있습니다."}),r.jsx(o,{docList:H}),r.jsx(t,{htmlRaw:z,code:T,exampleCode:P})]})}D.__docgenInfo={description:"",methods:[],displayName:"Exchange"};const A=`import {\r
    IRGrid,\r
    IRGridRowNoHeaderCellRenderer,\r
    IRGridDefaultCellRenderer,\r
    IRGridCheckboxRenderer,\r
...
\r
globalThis.grid = grid;`,E=`const grid = globalThis.grid;\r
\r
...
\r
<div id="ir_grid" style="height: 500px; width: 100%"></div>`,$=[["/classes/_innorules_ir-style.grid.IRGrid.html#createfinder","IRGrid.createFinder"]];function F(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid Finder"}),r.jsx("p",{children:"Finder를 이용하여 셀 찾기 기능을 수행할 수 있습니다."}),r.jsx(o,{docList:$}),r.jsx(t,{htmlRaw:N,code:A,exampleCode:E})]})}F.__docgenInfo={description:"",methods:[],displayName:"Finder"};const B=`import {\r
    IRGrid,\r
    IRGridCheckboxRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
\r
...
\r
globalThis.grid = grid;`,O=`import {\r
...
\r
grid.addPlugin( moveRowPlugin );\r
grid.addPlugin( moveColPlugin );`,L=`<div class="flex mb--lg" style="align-items: center; column-gap: 4px">\r
...
<div id="ir_grid" style="height: 500px; width: 800px"></div>`,V=[["/classes/_innorules_ir-style.grid.IRGridMoveRowsPlugin.html","IRGridMoveRowsPlugin"],["/classes/_innorules_ir-style.grid.IRGridMoveColumnsPlugin.html","IRGridMoveColumnsPlugin"]];function W(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsx("p",{children:"헤더를 드래그하여 행/열을 이동할 수 있습니다."}),r.jsx(o,{docList:V}),r.jsx(t,{htmlRaw:L,code:B,exampleCode:O})]})}W.__docgenInfo={description:"",methods:[],displayName:"MoveAPI"};const U=`import {\r
    IRGrid,\r
    IRGridDefaultCellRenderer,\r
    IRGridRowNoHeaderCellRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
...
\r
globalThis.grid = grid;`,X=`import { IRGridOverflowPanelPlugin } from "@innorules/ir-style/lib/esm/grid.js";\r
\r
const grid = globalThis.grid;\r
\r
...
} ) );`,q=`<button type='button' id="btn_freeze_rows" class='button mb--sm'>행 고정</button>\r
...
</div>`,Y=[["/classes/_innorules_ir-style.grid.IRGridOverflowPanelPlugin.html","IRGridOverflowPanelPlugin"]];function J(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid Overflow Panel"}),r.jsx("p",{children:"IRGrid가 overflow될 경우 Grid의 스크롤 제어를 간편하게 할 수 있는 편의 기능을 제공한다."}),r.jsx(o,{docList:Y}),r.jsx(t,{fixedHeight:550,htmlRaw:q,code:U,exampleCode:X})]})}J.__docgenInfo={description:"",methods:[],displayName:"OverflowPanelPlugin"};const Z=`import {\r
    IRGrid,\r
    IRGridCheckboxRenderer,\r
    IRGridDefaultCellRenderer,\r
...
\r
globalThis.grid = grid;`,K=`import {\r
...
};`,Q=`<button type="button" id="btn_sort" class="button mb--sm">정렬</button>\r
...
\r
<br />\r
<div id="ir_grid" style="height: 500px; width: 800px"></div>`,rr=[["/variables/_innorules_ir-style.grid.createIRGridColumnSortManager.html","createIRGridColumnSortManager"],["/variables/_innorules_ir-style.grid.createInferenceSortHandler.html","createInferenceSortHandler"]];function nr(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsx("p",{children:"열을 클릭하여 정렬 실행"}),r.jsx(o,{docList:rr}),r.jsx(t,{htmlRaw:Q,exampleCode:K,code:Z})]})}nr.__docgenInfo={description:"",methods:[],displayName:"Sort"};const er=`import { getThemeStore } from "@innorules/ir-style";\r
import {\r
    IRGrid,\r
    IRGridRowNoHeaderCellRenderer,\r
    IRGridCheckboxRenderer,\r
...
grid.setColumnWidth( 2, 120 );\r
grid.setColumnWidth( 3, 120 );\r
grid.setColumnWidth( 4, 160 );`,tr='<div id="ir_grid" style="height: 500px"></div>';function or(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid Configuration"}),r.jsx("p",{children:"Grid 기본 내부 패딩을 조절할 수 있습니다."}),r.jsx(t,{fixedHeight:600,htmlRaw:tr,code:er})]})}or.__docgenInfo={description:"",methods:[],displayName:"ThemeConfig"};const ir=`import {\r
    IRGrid,\r
    IRGridCheckboxRenderer,\r
    IRGridDatePickerRenderer,\r
    IRGridDefaultCellRenderer,\r
...
</div>`,sr=[["/classes/_innorules_ir-style.grid.IRGridMultiSelectCellPlugin.html","IRGridMultiSelectCellPlugin"]];function cr(){return r.jsxs(n,{children:[r.jsx(e,{children:"MultiSelectCellPlugin"}),r.jsx(i,{children:"ir-style@^2.21.0"}),r.jsxs("p",{children:["IRGrid에 다중 셀 선택 기능을 제공한다.",r.jsx("br",{}),r.jsx("b",{children:"※ 단독 사용은 불가능하며 반드시 IRGridMouseCellSelectorPlugin과 함께 사용"})]}),r.jsxs("p",{children:[r.jsx("b",{children:"복사/붙여넣기 참고 사항"}),r.jsx("br",{}),"- 복사와 붙여넣기는 선택한 셀들이 행과 열 모두에서 동일한 개수일 때만 동작한다. (잘못된 영역인 경우 경고 메시지 출력)",r.jsx("br",{}),"- 붙여넣기 시 선택한 셀들은 빈칸 없이 연속된 형태로 붙어서 표시된다.",r.jsx("br",{}),"※ 엑셀의 다중 셀 선택 복사/붙여넣기 동작 참고",r.jsx("br",{})]}),r.jsx(o,{docList:sr}),r.jsx(t,{htmlRaw:dr,exampleCode:lr,code:ir})]})}cr.__docgenInfo={description:"",methods:[],displayName:"MultiSelectCellPlugin"};const ar=`import {\r
    IRGrid,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
\r
const grid = new IRGrid( {\r
...
\r
globalThis.grid = grid;`,ur=`const grid = globalThis.grid;\r
\r
