import{j as t,c as o}from"./index-BVpe1bT6.js";import{E as e,Z as d}from"./index-rXZW3N37.js";import{D as r,a as l,L as s}from"./doc-content-BzTGzIX_.js";import"./index-RYns6xqu.js";const v={title:"JS Utility/Create Tooltip"},c=`
body > div {
    height: 400px;
}`,n=()=>t.jsxs(r,{children:[t.jsx(l,{children:"createTooltip"}),t.jsx("p",{children:"툴팁 출력을 위해 사용합니다."}),t.jsx(s,{css:c,html:t.jsxs(t.Fragment,{children:[t.jsx("button",{id:"btn_destroy",className:o(e),children:"Tooltip Destroy"}),t.jsx("button",{id:"btn_resize",className:o(e),children:"Resize"}),t.jsxs("div",{className:"border height--lg mt--sm min-height--none overflow--auto",children:[t.jsx("div",{className:"height--sm"}),t.jsx("button",{id:"btn1",className:o(e,d),children:"Tooltip"}),t.jsx("button",{id:"btn2",className:o(e,d),children:"Tooltip2"}),t.jsx("div",{className:"height--sm"})]}),t.jsx("div",{id:"div_parent",style:{backgroundColor:"lightgray",width:100,height:100},children:t.jsx("button",{id:"div_child",className:"button ml--xl mt--xl",children:"Child"})})]}),code:`
...
`})]});n.__docgenInfo={description:"",methods:[],displayName:"CreateTooltip"};i.__docgenInfo={description:"",methods:[],displayName:"CreateTooltipBySelector"};a.__docgenInfo={description:"",methods:[],displayName:"createTooltipContainer"};var p,m,b;n.parameters={...n.parameters,docs:{...(p=n.parameters)==null?void 0:p.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(b=(m=n.parameters)==null?void 0:m.docs)==null?void 0:b.source}}};var u,h,_;i.parameters={...i.parameters,docs:{...(u=i.parameters)==null?void 0:u.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(_=(h=i.parameters)==null?void 0:h.docs)==null?void 0:_.source}}};var x,N,y;a.parameters={...a.parameters,docs:{...(x=a.parameters)==null?void 0:x.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(y=(N=a.parameters)==null?void 0:N.docs)==null?void 0:y.source}}};const E=["CreateTooltip","CreateTooltipBySelector","createTooltipContainer"];export{n as CreateTooltip,i as CreateTooltipBySelector,E as __namedExportsOrder,a as createTooltipContainer,v as default};
