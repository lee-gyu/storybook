import{j as r}from"./jsx-runtime-u17CrQMm.js";import{D as n,a as t,c as e,L as o}from"./version-tag-DqccibA3.js";import"./iframe-D3tc5L3-.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DQMUxHhF.js";const i=`import { IREditor } from "@innorules/ir-style/lib/esm/editor.js";\r
\r
...
<button id="btn3" class="button">replace 출력</button>`,c=[["/classes/_innorules_ir-style.editor.IREditor.html","IREditor"]];function d(){return r.jsxs(n,{children:[r.jsx(t,{children:"IREditor"}),r.jsxs("p",{children:[r.jsx("code",{children:"IREditor"}),"를 이용하여 에디터 스타일을 표현합니다."]}),r.jsx(e,{docList:c}),r.jsx(o,{css:s,htmlRaw:l,exampleCode:i})]})}d.__docgenInfo={description:"",methods:[],displayName:"Basic"};const a=`import { IREditor } from "@innorules/ir-style/lib/esm/editor.js";\r
\r
new IREditor( {\r
    contextElement: document.getElementById( "ir_editor" ),\r
    mode: "ir-db-rule",\r
...
<div id="ir_editor"></div>`,m=[["/classes/_innorules_ir-style.editor.IREditor.html","IREditor"]],b=`
#ir_editor {
    height: 200px;
}
`;function E(){return r.jsxs(n,{children:[r.jsx(t,{children:"IREditor"}),r.jsx("p",{children:"룰 표현식 문법 + SQL 문법을 믹싱한 에디터 스타일을 표현입니다."}),r.jsx(e,{docList:m}),r.jsx(o,{css:b,htmlRaw:u,exampleCode:a})]})}E.__docgenInfo={description:"",methods:[],displayName:"DBRule"};const h=`import { IREditor } from "@innorules/ir-style/lib/esm/editor.js";\r
\r
const editor = new IREditor( {\r
    contextElement: document.getElementById( "ir_editor" ),\r
    mode: "sql-oracle",\r
...
</div>`,x=[["/classes/_innorules_ir-style.editor.IREditor.html","IREditor"]],g=`
#ir_editor {
    height: 200px;
}
`;function L(){return r.jsxs(n,{children:[r.jsx(t,{children:"IREditor Cursor API"}),r.jsx("p",{children:"제공되는 API를 이용하여 Cursor 위치 및 상태를 제어합니다."}),r.jsx(e,{docList:x}),r.jsx(o,{css:g,htmlRaw:R,code:h,exampleCode:p})]})}L.__docgenInfo={description:"",methods:[],displayName:"HandlingCursor"};const C=`import { IREditor } from "@innorules/ir-style/lib/esm/editor.js";\r
\r
const editor = new IREditor( {\r
    contextElement: document.getElementById( "ir_editor" ),\r
    mode: "sql-oracle",\r
...
} );`,_='<div id="ir_editor"></div>',y=[["/classes/_innorules_ir-style.editor.IREditor.html","IREditor"]],k=`
#ir_editor {
    height: 200px;
}
`;function I(){return r.jsxs(n,{children:[r.jsx(t,{children:"IREditor KeyEvents"}),r.jsxs("p",{children:[r.jsx("code",{children:"keyEvents"})," 속성으로 특정 키의 이벤트를 처리합니다."]}),r.jsx(e,{docList:y}),r.jsx(o,{css:k,htmlRaw:_,exampleCode:C})]})}I.__docgenInfo={description:"",methods:[],displayName:"KeyEvents"};const S=`import { IREditor } from "@innorules/ir-style/lib/esm/editor.js";\r
\r
const gutterList = [];\r
\r
const editor = new IREditor( {\r
...
`,j='<div id="ir_editor"></div>',f=[["/classes/_innorules_ir-style.editor.IREditor.html","IREditor"]],T=`
#ir_editor {
    height: 200px;
}
`;function w(){return r.jsxs(n,{children:[r.jsx(t,{children:"IREditor"}),r.jsxs("p",{children:[r.jsx("code",{children:"lineGutter"})," 속성으로 줄 번호 외에 추가적인 거터를 표시할 수 있습니다."]}),r.jsx(e,{docList:f}),r.jsx(o,{css:T,htmlRaw:j,exampleCode:S})]})}w.__docgenInfo={description:"",methods:[],displayName:"LineGutter"};const O=`import { IREditor } from "@innorules/ir-style/lib/esm/editor.js";\r
\r
new IREditor( {\r
...
`,$=[["/classes/_innorules_ir-style.editor.IREditor.html","IREditor"]];function v(){return r.jsxs(n,{children:[r.jsx(t,{children:"IREditor"}),r.jsx("p",{children:"룰 표현식 문법을 이용하여 에디터 스타일을 표현합니다."}),r.jsx(e,{docList:$}),r.jsx(o,{css:F,htmlRaw:M,exampleCode:O})]})}v.__docgenInfo={description:"",methods:[],displayName:"RuleSyntax"};const B=`import { IREditor } from "@innorules/ir-style/lib/esm/editor.js";\r
\r
const editor = new IREditor( {\r
    contextElement: document.getElementById( "ir_editor" ),\r
    mode: "sql-oracle",\r
...
<button id="btn3" class="button">내용 바꾸기</button>`,D=[["/classes/_innorules_ir-style.editor.IREditor.html","IREditor"]],P=`
#ir_editor {
    height: 200px;
}
`;function U(){return r.jsxs(n,{children:[r.jsx(t,{children:"IREditor"}),r.jsxs("p",{children:[r.jsx("code",{children:"getSearchCursor"}),"를 검색 기능을 이용합니다."]}),r.jsx(e,{docList:D}),r.jsx(o,{css:P,htmlRaw:G,code:B,exampleCode:N})]})}U.__docgenInfo={description:"",methods:[],displayName:"Search"};const z={title:"JS Components/IREditor"},H=["Basic","DBRule","HandlingCursor","KeyEvents","LineGutter","RuleSyntax","Search"];export{d as Basic,E as DBRule,L as HandlingCursor,I as KeyEvents,w as LineGutter,v as RuleSyntax,U as Search,H as __namedExportsOrder,z as default};
