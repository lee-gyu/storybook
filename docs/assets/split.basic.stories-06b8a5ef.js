import{j as i,a as e,F as m}from"./jsx-runtime-e43ccb36.js";import{D as a,a as d,L as c}from"./doc-content-486f07cf.js";import"./index-1b03fe98.js";import"./index-91038615.js";const L={title:"JS Utility/Create Split Container"},o=Array.from({length:20}).map((y,t)=>i("p",{children:["Panel ",t]},t)),p=e(m,{children:Array.from({length:100}).map((y,t)=>i("span",{children:["Panel ",t]},t))}),r=()=>i(a,{children:[e(d,{children:"createSplitContainer"}),i("p",{children:[e("code",{children:"createSplitContainer"}),"을 활용하여 구역 경계를 나누고, 사이즈를 변경할 수 있게 합니다."]}),e(c,{css:`
#live_editor_wrapper {
    padding: 0
}
...
//# sourceMappingURL=split.basic.stories-06b8a5ef.js.map
