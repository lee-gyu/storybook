import{j as e,a as t,F as s}from"./jsx-runtime-CjohWU4o.js";import{o as r}from"./index-jvX_Qewy.js";import{D as c,a as d,L as a}from"./doc-content-BYQUkk8D.js";import"./index-CBqU2yxZ.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-Bl6ORisp.js";const T={title:"JS Components/Editor"},l=`
#ir_editor {
    height: 200px;
}
`,o=()=>e(c,{children:[t(d,{children:"IREditor Cursor API"}),t("p",{children:"제공되는 API를 이용하여 Cursor 위치 및 상태를 제어합니다."}),t(a,{css:l,html:e(s,{children:[t("div",{id:"ir_editor"}),t("br",{}),e("div",{className:"button-group",children:[t("button",{id:"btn",className:r,children:"현재 라인 텍스트"}),t("button",{id:"btn2",className:r,children:"현재 선택된 텍스트"}),t("button",{id:"btn3",className:r,children:"현재 커서 정보"}),t("button",{id:"btn4",className:r,children:"1번째 라인 텍스트"}),t("button",{id:"btn5",className:r,children:"현재 커서 텍스트"}),t("button",{id:"btn6",className:r,children:"특정 위치 선택"})]})]}),code:`
...
`})]});var n,u,i;o.parameters={...o.parameters,docs:{...(n=o.parameters)==null?void 0:n.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(i=(u=o.parameters)==null?void 0:u.docs)==null?void 0:i.source}}};const B=["HandlingCursor"];export{o as HandlingCursor,B as __namedExportsOrder,T as default};
