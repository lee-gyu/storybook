import{j as o}from"./jsx-runtime-u17CrQMm.js";import{D as n,a as i,c as e,L as t,V as l}from"./version-tag-u3GxDBUd.js";import"./iframe-9F64GLpK.js";import"./preload-helper-PPVm8Dsz.js";import"./index-F4J0AwFl.js";const a=`import { createPopover } from "@innorules/ir-style";
...
</div>`,r=[["/classes/_innorules_inno-front-core.IRPopover.html","IRPopover"]];function c(){return o.jsxs(n,{children:[o.jsx(i,{children:"bringToTop"}),o.jsx("p",{children:"createPopover 핸들러의 bringToTop API를 이용해서 zIndex 순서를 제어할 수 있습니다."}),o.jsx(e,{docList:r}),o.jsx(t,{fixedHeight:500,htmlRaw:d,code:a,exampleCode:s})]})}c.__docgenInfo={description:"",methods:[],displayName:"BringToTop"};const g=`import { createPopover } from "@innorules/ir-style";
...
</div>`,p=[["/classes/_innorules_inno-front-core.IRPopover.html","IRPopover"],["/variables/_innorules_inno-front-core.createPopover.html","createPopover"]];function _(){return o.jsxs(n,{children:[o.jsx(i,{children:"createPopover"}),o.jsx("p",{children:"내부 z-index 표준 시스템을 적용하여 Dialog를 화면에 표시합니다. (ESC를 누르면 가장 최상위 다이얼로그가 종료됩니다.)"}),o.jsx(e,{docList:p}),o.jsx(t,{fixedHeight:500,htmlRaw:v,exampleCode:g})]})}_.__docgenInfo={description:"",methods:[],displayName:"CreatePopover"};const b=`import { createPopover } from "@innorules/ir-style";
...
btn_open.onclick = () => dialogPopover.show();`,m=`<div>
...
</div>`,u=[["/variables/_innorules_inno-front-core.createPopover.html","createPopover"],["/types/_innorules_inno-front-core.PopoverArgs.html","PopoverArgs"]];function h(){return o.jsxs(n,{children:[o.jsx(i,{children:"parentElement"}),o.jsx("p",{children:"부모 요소를 지정하여 DOM 마운트를 제어 합니다."}),o.jsx(e,{docList:u}),o.jsx(t,{fixedHeight:500,htmlRaw:m,exampleCode:b})]})}h.__docgenInfo={description:"",methods:[],displayName:"ParentElement"};const P=`import { createPopover } from "@innorules/ir-style";
...
</div>`,y=[["/classes/_innorules_inno-front-core.IRPopover.html","IRPopover"]];function I(){return o.jsxs(n,{children:[o.jsx(i,{children:"IRDialogManager"}),o.jsx(l,{children:"ir-style@^2.20.0"}),o.jsxs("p",{children:["다이얼로그를 최소화하고 하단에 버튼으로 관리할 수 있는 매니저입니다.",o.jsx("br",{}),"IRDialogManager의 minimize API를 이용해서 최소화할 수 있으며, 버튼을 누르면 다시 열 수 있습니다."]}),o.jsx(e,{docList:y}),o.jsx(t,{fixedHeight:500,htmlRaw:x,code:P,exampleCode:f})]})}I.__docgenInfo={description:"",methods:[],displayName:"DialogManager"};const z={title:"JS Utility/Popover"},C=["BringToTop","CreatePopover","ParentElement","DialogManager"];export{c as BringToTop,_ as CreatePopover,I as DialogManager,h as ParentElement,C as __namedExportsOrder,z as default};
