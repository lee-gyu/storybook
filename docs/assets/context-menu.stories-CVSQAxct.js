import{j as n}from"./jsx-runtime-u17CrQMm.js";import{D as r,a as e,c as t,L as i}from"./version-tag-DqccibA3.js";import"./iframe-D3tc5L3-.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DQMUxHhF.js";const o=`export const CONTEXT_ITEMS = {\r
    // blurDisabled: true,\r
    items: [\r
        {\r
            id: "1",\r
...
<div id="test_area2" class="border width--full height--xl"></div>`,a=[["/classes/_innorules_ir-style.index.IRContextMenu.html","IRContextMenu"]];function s(){return n.jsxs(r,{children:[n.jsx(e,{children:"IRContextMenu"}),n.jsxs("p",{children:[n.jsx("code",{children:"IRContextMenu"})," 클래스를 이용하여 메뉴를 출력합니다."]}),n.jsx(t,{docList:a}),n.jsx(i,{fixedHeight:500,htmlRaw:l,code:o,exampleCode:d})]})}s.__docgenInfo={description:"",methods:[],displayName:"Basic"};const y={title:"JS Components/IRContextMenu"},v=["Basic"];export{s as Basic,v as __namedExportsOrder,y as default};
