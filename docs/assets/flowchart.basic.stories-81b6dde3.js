import{j as t,a as o,F as d}from"./jsx-runtime-e43ccb36.js";import{D as a,a as r,L as i}from"./doc-content-c992edf3.js";import"./index-1b03fe98.js";import"./index-91038615.js";const E={title:"JS Components/Flowchart"},e=()=>t(a,{children:[o(r,{children:"IRFlowchart"}),o(i,{html:t(d,{children:[t("div",{style:{marginBottom:8},children:[o("h3",{children:"오브젝트 추가 API"}),o("button",{className:"button",id:"btn_add_start",children:"start 노드 추가"}),o("button",{className:"button",id:"btn_add_if",children:"if 노드 추가"}),o("button",{className:"button",id:"btn_add_db",children:"db 노드 추가"}),o("button",{className:"button",id:"btn_add_bridge",children:"bridge 노드 추가"}),o("button",{className:"button",id:"btn_add_comment",children:"comment 노드 추가"}),o("button",{className:"button",id:"btn_add_return",children:"return 노드 추가"}),o("button",{className:"button",id:"btn_add_direct",children:"곧은 연결선 추가"}),o("button",{className:"button",id:"btn_add_elbow",children:"꺾은 연결선 추가"}),o("h3",{className:"mt--lg",children:"오브젝트 제어 API"}),o("button",{className:"button",id:"btn_clear",children:"clear"}),o("button",{className:"button",id:"btn_remove_selected",children:"선택 개체 제거 (Delete 키)"}),o("button",{className:"button",id:"btn_group",children:"선택된 개체 그룹"}),o("button",{className:"button",id:"btn_release_group",children:"그룹 해제"}),o("button",{className:"button",id:"btn_undo",children:"Undo (Ctrl + Z)"}),o("button",{className:"button",id:"btn_redo",children:"Redo (Ctrl + Y)"}),o("button",{className:"button",id:"btn_size_to_fit",children:"컨텐츠에 맞게 크기 조정"}),o("h3",{className:"mt--lg",children:"배치/정렬 API"}),o("button",{className:"button",id:"btn_align_left",children:"가로 왼쪽 정렬"}),o("button",{className:"button",id:"btn_align_center",children:"가로 중앙 정렬"}),o("button",{className:"button",id:"btn_align_right",children:"가로 오른쪽 정렬"}),o("button",{className:"button",id:"btn_align_top",children:"세로 위쪽 정렬"}),o("button",{className:"button",id:"btn_align_middle",children:"세로 중앙 정렬"}),o("button",{className:"button",id:"btn_align_bottom",children:"세로 아래쪽 정렬"}),o("button",{className:"button",id:"btn_distribute_horizontal",children:"가로 균등 분배"}),o("button",{className:"button",id:"btn_distribute_vertical",children:"세로 균등 분배"}),o("button",{className:"button",id:"btn_bring_to_front",children:"맨 앞으로"}),o("button",{className:"button",id:"btn_bring_to_back",children:"맨 뒤로"}),o("h3",{className:"mt--lg",children:"Mode Toggle (on/off)"}),t("div",{className:"flex gap-x--lg py--sm",children:[t("label",{children:[o("input",{type:"checkbox",id:"chk_toggle_grid"}),"눈금선"]}),t("label",{children:[o("input",{type:"checkbox",id:"chk_toggle_readonly"}),"읽기 전용"]}),t("label",{children:[o("input",{type:"checkbox",id:"chk_toggle_edit_mode"}),"마우스 상호작용 비활성화"]}),t("label",{children:[o("input",{type:"checkbox",id:"chk_toggle_trace"}),"디버그 모드"]}),t("label",{children:[o("input",{type:"checkbox",id:"chk_toggle_tooltip"}),"툴팁 숨김"]}),t("label",{children:[o("input",{type:"checkbox",id:"chk_toggle_move_screen_on_select"}),"노드 선택 시 스크롤 중앙 이동"]}),t("label",{children:[o("input",{type:"checkbox",id:"chk_toggle_select_node_on_hover"}),"hover 시 노드 선택"]}),t("label",{children:[o("input",{type:"checkbox",id:"chk_toggle_simple_connecting_mode"}),"연결선 최단 거리 자동 설정"]}),t("label",{children:[o("input",{type:"checkbox",id:"chk_toggle_wheel_zoom"}),"Ctrl + Wheel 줌"]}),t("label",{children:[o("input",{type:"checkbox",id:"chk_single_selection"}),"단일 선택 모드"]}),t("label",{children:[o("input",{type:"checkbox",id:"chk_canvas_move"}),"캔버스 이동 모드"]})]})]}),o("div",{id:"flowchart_div",className:"border",style:{height:550}})]}),code:`
...
`})]});var n,c,l;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(l=(c=e.parameters)==null?void 0:c.docs)==null?void 0:l.source}}};const u=["Basic"];export{e as Basic,u as __namedExportsOrder,E as default};
//# sourceMappingURL=flowchart.basic.stories-81b6dde3.js.map
