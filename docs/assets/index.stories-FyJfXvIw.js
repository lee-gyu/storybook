import{j as r}from"./jsx-runtime-u17CrQMm.js";import{D as n,a as e,V as l,c as t,L as i}from"./version-tag-B2V-8a8w.js";import"./iframe-72AAcSIy.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CfaMo4xr.js";const d=`\r
...
</div>`,a=[["/classes/_innorules_grid.IRGridTablePlugin.html","IRGridTablePlugin"],["/classes/_innorules_grid.IRGridTablePluginAPI.html","IRGridTablePluginAPI"]];function c(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGridTablePlugin"}),r.jsx(l,{children:"ir-style@^2.13.0"}),r.jsxs("p",{children:["IRGridTablePlugin은 IRGrid에 다양한 테이블 관련 기능을 추가하는 플러그인입니다.",r.jsx("br",{}),"이 플러그인을 사용하면 다중 행 선택, 마지막 열 고정, 드래그 앤 드롭 등 다양한 테이블 조작 기능을 구현할 수 있습니다."]}),r.jsx(t,{docList:a}),r.jsx(i,{defaultCodeFold:[55],htmlRaw:s,code:d,exampleCode:o})]})}c.__docgenInfo={description:"",methods:[],displayName:"TablePlugin"};const u=`import {\r
    IRGrid,\r
...
\r
tableGrid.addPlugin( tableListViewPlugin );`,w='<div id="ir_grid" style="height: 500px; width: 700px"></div>',I=[["/classes/_innorules_grid.IRGridTablePlugin.html","IRGridTablePlugin"],["/types/_innorules_grid.IRGridTablePluginArgs.html#style","IRGridTablePluginArgs style"]];function p(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGridTablePlugin ListViewStyle"}),r.jsx(l,{children:"ir-style@^2.23.0"}),r.jsxs("p",{children:["IRGridTablePlugin에서 ",r.jsx("code",{children:"style"})," 속성을 ",r.jsx("code",{children:"list-view"}),"로 설정하면 PF ListView 스타일이 적용된다."]}),r.jsx(t,{docList:I}),r.jsx(i,{htmlRaw:w,code:C,exampleCode:h})]})}p.__docgenInfo={description:"",methods:[],displayName:"ListViewStyle"};const G={title:"JS Components/IRGrid/TablePlugin"},v=["Basic","RowDraggable","ListViewStyle"];export{c as Basic,p as ListViewStyle,m as RowDraggable,v as __namedExportsOrder,G as default};
