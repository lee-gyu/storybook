import{j as i,a as e,F as C}from"./jsx-runtime-CjohWU4o.js";import{D as u,a,L as d}from"./doc-content-CB4FAwiC.js";import"./index-CBqU2yxZ.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-Bl6ORisp.js";const T={title:"JS Utility/Create Split Container"},o=Array.from({length:20}).map((A,n)=>i("p",{children:["Panel ",n]},n)),c=e(C,{children:Array.from({length:100}).map((A,n)=>i("span",{children:["Panel ",n]},n))}),t=()=>i(u,{children:[e(a,{children:"createSplitContainer"}),i("p",{children:[e("code",{children:"createSplitContainer"}),"을 활용하여 구역 경계를 나누고, 사이즈를 변경할 수 있게 합니다."]}),e(d,{css:`
#live_editor_wrapper {
    padding: 0
}
