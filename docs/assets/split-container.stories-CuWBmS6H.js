import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{D as a,a as p,L as s,V as e}from"./version-tag-DYWb7goF.js";import"./iframe-MfDS26RN.js";import"./index-BoKU7Xug.js";const l=`import { IRSplitContainer } from "@innorules/ir-style";
...
</div>`;function j(){return n.jsxs(a,{children:[n.jsx(p,{children:"IRSplitContainer"}),n.jsx("p",{children:"thin 스타일을 적용하여 얇은 영역 나누기가 가능합니다."}),n.jsx(s,{css:"#live_editor_wrapper { padding: 0 }",fixedHeight:400,htmlRaw:b,code:I})]})}j.__docgenInfo={description:"",methods:[],displayName:"ThinStyle"};const k={title:"JS Components/IRSplitContainer"},A=["API","Basic","DeepNestedCase","Event","GutterClickAction","Size","ThinStyle"];export{i as API,o as Basic,v as DeepNestedCase,x as Event,R as GutterClickAction,w as Size,j as ThinStyle,A as __namedExportsOrder,k as default};
