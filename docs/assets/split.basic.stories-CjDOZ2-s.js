import{j as e}from"./jsx-runtime-QvZ8i92b.js";import{D as l,a,L as u}from"./doc-content-DCRebTQc.js";import"./index-uubelm5h.js";import"./index-vAxXS4R5.js";const z={title:"JS Utility/Create Split Container"},d=Array.from({length:20}).map((j,i)=>e.jsxs("p",{children:["Panel ",i]},i)),o=e.jsx(e.Fragment,{children:Array.from({length:100}).map((j,i)=>e.jsxs("span",{children:["Panel ",i]},i))}),s=()=>e.jsxs(l,{children:[e.jsx(a,{children:"createSplitContainer"}),e.jsxs("p",{children:[e.jsx("code",{children:"createSplitContainer"}),"을 활용하여 구역 경계를 나누고, 사이즈를 변경할 수 있게 합니다."]}),e.jsx(u,{css:`
#live_editor_wrapper {
    padding: 0
}
`,fixedHeight:400,html:e.jsxs(e.Fragment,{children:[e.jsx("style",{children:".gutter{ background-color: var(--background-color) }"}),e.jsxs("div",{className:"split-container",style:{display:"flex",height:"100%"},children:[e.jsx("div",{id:"split-0",className:"split-panel",children:"panel 1"}),e.jsx("div",{id:"split-1",className:"split-panel",children:"panel 2"}),e.jsxs("div",{id:"split-2",className:"split-panel",children:[e.jsx("div",{id:"split-3",className:"split-panel",children:"panel 3"}),e.jsxs("div",{id:"split-4",className:"split-panel",style:{display:"flex"},children:[e.jsx("div",{id:"split-5",className:"split-panel",children:d}),e.jsx("div",{id:"split-6",className:"split-panel",children:o})]})]})]})]}),code:`
...
createSplitContainer(['#split-5', '#split-6'], { borderColor: "border-light" })
                `})]}),n=()=>e.jsxs(l,{children:[e.jsx(a,{children:"Size 설정"}),e.jsxs("p",{children:[e.jsx("code",{children:"sizes"}),"를 이용하여 해당 패널의 백분율 배열로 지정할 수 있고,",e.jsx("br",{}),e.jsx("code",{children:"minSize(default: 100px), maxSize"}),"의 px를 지정하여 resize 가능한 크기 범위를 지정합니다.",e.jsx("br",{}),e.jsx("code",{children:"Infinity"}),"는 ",e.jsx("code",{children:"minSize"}),"에서 사용 시 설정된 패널 초기 크기로 지정되고, ",e.jsx("code",{children:"maxSize"}),"에서 사용 시 무한으로 늘어날 수 있습니다."]}),e.jsx(u,{css:`
#live_editor_wrapper {
    padding: 0
}
`,fixedHeight:400,html:e.jsxs("div",{className:"split-container",style:{display:"flex",height:"100%"},children:[e.jsx("div",{id:"split-0",className:"split-panel",children:d}),e.jsx("div",{id:"split-1",className:"split-panel",children:o})]}),code:`
import { createSplitContainer } from "./dist/index.js";
...
createSplitContainer(['#split-0', '#split-1'], {
    ...
    maxSize: [700, Infinity]
                ...
                `})]}),t=()=>e.jsxs(l,{children:[e.jsx(a,{children:"Event"}),e.jsxs("p",{children:[e.jsx("code",{children:"onDrag"})," 이벤트를 이용하여 드래그 시 이벤트를 받을 수 있습니다.",e.jsx("br",{}),e.jsx("code",{children:"onDragStart"})," 이벤트를 이용하여 드래그 시작 시 이벤트를 받을 수 있습니다.",e.jsx("br",{}),e.jsx("code",{children:"onDragEnd"})," 이벤트를 이용하여 드래그 종료 시 이벤트를 받을 수 있습니다. "]}),e.jsx(u,{css:`
#live_editor_wrapper {
    padding: 0
}
`,fixedHeight:400,html:e.jsxs("div",{className:"split-container",style:{display:"flex",height:"100%"},children:[e.jsx("div",{id:"split-0",className:"split-panel",children:d}),e.jsx("div",{id:"split-1",className:"split-panel",children:o})]}),code:`
...
split.setSizes([25, 75]);
                `})]});s.__docgenInfo={description:"",methods:[],displayName:"createSplitContainer"};n.__docgenInfo={description:"",methods:[],displayName:"Size"};t.__docgenInfo={description:"",methods:[],displayName:"Event"};r.__docgenInfo={description:"",methods:[],displayName:"API"};var c,p,C;s.parameters={...s.parameters,docs:{...(c=s.parameters)==null?void 0:c.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(C=(p=s.parameters)==null?void 0:p.docs)==null?void 0:C.source}}};var m,x,B;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(B=(x=n.parameters)==null?void 0:x.docs)==null?void 0:B.source}}};var D,h,v;t.parameters={...t.parameters,docs:{...(D=t.parameters)==null?void 0:D.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(v=(h=t.parameters)==null?void 0:h.docs)==null?void 0:v.source}}};var S,E,g;r.parameters={...r.parameters,docs:{...(S=r.parameters)==null?void 0:S.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(g=(E=r.parameters)==null?void 0:E.docs)==null?void 0:g.source}}};const y=["createSplitContainer","Size","Event","API"];export{r as API,t as Event,n as Size,y as __namedExportsOrder,s as createSplitContainer,z as default};
