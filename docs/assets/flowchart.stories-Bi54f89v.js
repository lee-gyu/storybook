import{n as e}from"./chunk-BneVvdWh.js";import{a as t,o as n,r,s as i,t as a}from"./context-C6uFeUW4.js";import{t as o}from"./jsx-runtime-6sF1Ejqi.js";var s,ee=e((()=>{s=`import { IRContextMenu } from "@innorules/ir-style";
...
window.__IR_FLOWCHART__ = flowchart;`})),c,te=e((()=>{c=`<div style="margin-bottom: 8px">
    <h3>오브젝트 추가 API</h3>
...
<div id="flowchart_div" class="border" style="height: 550px"></div>`}));function l(){return(0,u.jsxs)(n,{children:[(0,u.jsx)(t,{children:`IRFlowchart`}),(0,u.jsx)(i,{htmlRaw:c,code:s})]})}var u,ne=e((()=>{ee(),te(),a(),u=o(),l.__docgenInfo={description:``,methods:[],displayName:`Basic`}})),d,re=e((()=>{d=`import { IRFlowchart } from "@innorules/ir-style/lib/esm/flowchart.js";
...
globalThis.flowchart = flowchart;`})),ie,ae=e((()=>{ie=`btn_save_png.onclick = async () =>
{
...
};`})),f,oe=e((()=>{f=`<div style="margin-bottom: 8px">
...
<div id="flowchart_div" class="border" style="height: 550px"></div>`}));function p(){return(0,m.jsxs)(n,{children:[(0,m.jsx)(t,{children:`IRFlowchart Exporting`}),(0,m.jsx)(r,{docList:h}),(0,m.jsx)(i,{htmlRaw:f,code:d,exampleCode:ie})]})}var m,h,se=e((()=>{re(),ae(),oe(),a(),m=o(),h=[[`/classes/_innorules_flowchart.IRFlowchart.html`,`IRFlowchart`],[`/classes/_innorules_flowchart.IRFlowchart.html#saveasimagefile`,`IRFlowchart.saveAsImageFile`],[`/classes/_innorules_flowchart.IRFlowchart.html#copytoclipboard`,`IRFlowchart.copyToClipboard`]],p.__docgenInfo={description:``,methods:[],displayName:`Export`}})),g,ce=e((()=>{g=`import { IRFlowchart } from "@innorules/ir-style/lib/esm/flowchart.js";
...
globalThis.flowchartList = flowchartList;`})),_,le=e((()=>{_=`/** 왼쪽 FlowChart */
...
btn2.onclick = () => flowchartList[1].append( "append", { type: "node", render: "db" } );`})),v,ue=e((()=>{v=`<style>
    .fw-container {
        display: grid;
        height: 400px;
...
</div>`}));function y(){return(0,b.jsxs)(n,{children:[(0,b.jsx)(t,{children:`IRFlowchart`}),(0,b.jsx)(r,{docList:x}),(0,b.jsx)(i,{htmlRaw:v,code:g,exampleCode:_})]})}var b,x,de=e((()=>{ce(),le(),ue(),a(),b=o(),x=[[`/classes/_innorules_flowchart.IRFlowchart.html`,`IRFlowchart`]],y.__docgenInfo={description:``,methods:[],displayName:`Multiple`}})),S,fe=e((()=>{S=`import { IRFlowchart } from "@innorules/ir-style/lib/esm/flowchart.js";
...
points[1].x += 35;
con3.data["connection.points"] = points;`})),C,pe=e((()=>{C=`<div id="flowchart_div" class="border" style="height: 800px"></div>`}));function w(){return(0,T.jsxs)(n,{children:[(0,T.jsx)(t,{children:`IRFlowchart`}),(0,T.jsx)(r,{docList:E}),(0,T.jsx)(i,{htmlRaw:C,code:S})]})}var T,E,me=e((()=>{fe(),pe(),a(),T=o(),E=[[`/classes/_innorules_flowchart.IRFlowchart.html`,`IRFlowchart`]],w.__docgenInfo={description:``,methods:[],displayName:`RuleArchitecture`}})),D,he=e((()=>{D=`import { IRFlowchart } from "@innorules/ir-style/lib/esm/flowchart.js";
...
globalThis.flowchart = flowchart;`})),O,ge=e((()=>{O=`// 가로 정렬
btn_align_left.onclick = () => flowchart.align( "left" );
btn_align_center.onclick = () => flowchart.align( "center" );
btn_align_right.onclick = () => flowchart.align( "right" );
...
// 균등 분배
btn_distribute_horizontal.onclick = () => flowchart.distribute( "h" );
btn_distribute_vertical.onclick = () => flowchart.distribute( "v" );`})),k,_e=e((()=>{k=`<div style="margin-bottom: 8px">
    <button class="button" id="btn_align_left">가로 왼쪽 정렬</button>
    <button class="button" id="btn_align_center">가로 중앙 정렬</button>
    <button class="button" id="btn_align_right">가로 오른쪽 정렬</button>
    <button class="button" id="btn_align_top">세로 위쪽 정렬</button>
...
<div id="flowchart_div" class="border" style="height: 550px"></div>`}));function A(){return(0,j.jsxs)(n,{children:[(0,j.jsx)(t,{children:`IRFlowchart`}),(0,j.jsx)(`p`,{children:`오브젝트 배치 및 정렬하는 API`}),(0,j.jsx)(r,{docList:M}),(0,j.jsx)(i,{htmlRaw:k,code:D,exampleCode:O})]})}var j,M,ve=e((()=>{he(),ge(),_e(),a(),j=o(),M=[[`/classes/_innorules_flowchart.IRFlowchart.html`,`IRFlowchart`],[`/classes/_innorules_flowchart.IRFlowchart.html#align`,`IRFlowchart.align`],[`/classes/_innorules_flowchart.IRFlowchart.html#distribute`,`IRFlowchart.distribute`]],A.__docgenInfo={description:``,methods:[],displayName:`Basic`}})),N,ye=e((()=>{N=`import { IRFlowchart } from "@innorules/ir-style/lib/esm/flowchart.js";
...
window.__IR_FLOWCHART__ = flowchart;
globalThis.flowchart = flowchart;`})),be,xe=e((()=>{be=`// 노드 추가
btn_add_start.onclick = () => flowchart.append( "append", { type: "node", render: "start" } );
btn_add_if.onclick = () => flowchart.append( "append", { type: "node", render: "if" } );
btn_add_db.onclick = () => flowchart.append( "append", { type: "node", render: "db" } );
btn_add_bridge.onclick = () => flowchart.append( "append", { type: "node", render: "bridge" } );
...
// 컨텐츠에 맞게 크기 조정
btn_size_to_fit.onclick = () => flowchart.fitSizeOnText();
`})),P,Se=e((()=>{P=`<div class="flex mb--lg gap-x--lg gap-y--lg flex--wrap">
...
<div id="flowchart_div" class="border" style="height: 550px"></div>`}));function F(){return(0,I.jsxs)(n,{children:[(0,I.jsx)(t,{children:`IRFlowchart`}),(0,I.jsx)(r,{docList:L}),(0,I.jsx)(i,{htmlRaw:P,code:N,exampleCode:be})]})}var I,L,Ce=e((()=>{ye(),xe(),Se(),a(),I=o(),L=[[`/classes/_innorules_flowchart.IRFlowchart.html`,`IRFlowchart`]],F.__docgenInfo={description:``,methods:[],displayName:`Basic`}})),R,we=e((()=>{R=`import { IRFlowchart } from "@innorules/ir-style/lib/esm/flowchart.js";
...
window.__IR_FLOWCHART__ = flowchart;
globalThis.flowchart = flowchart;`})),z,Te=e((()=>{z=`// 그룹화
btn_group.onclick = () => flowchart.group();
// 그룹 해제
btn_release_group.onclick = () => flowchart.ungroup();`})),B,Ee=e((()=>{B=`<div style="margin-bottom: 8px">
    <button class="button" id="btn_group">선택된 개체 그룹</button>
    <button class="button" id="btn_release_group">그룹 해제</button>
</div>
<div id="flowchart_div" class="border" style="height: 550px"></div>`}));function V(){return(0,H.jsxs)(n,{children:[(0,H.jsx)(t,{children:`IRFlowchart`}),(0,H.jsx)(r,{docList:U}),(0,H.jsx)(i,{htmlRaw:B,code:R,exampleCode:z})]})}var H,U,De=e((()=>{we(),Te(),Ee(),a(),H=o(),U=[[`/classes/_innorules_flowchart.IRFlowchart.html`,`IRFlowchart`],[`/classes/_innorules_flowchart.IRFlowchart.html#group`,`IRFlowchart.group`],[`/classes/_innorules_flowchart.IRFlowchart.html#ungroup`,`IRFlowchart.ungroup`]],V.__docgenInfo={description:``,methods:[],displayName:`Basic`}})),W,Oe=e((()=>{W=`import { IRFlowchart } from "@innorules/ir-style/lib/esm/flowchart.js";
...
window.__IR_FLOWCHART__ = flowchart;
globalThis.flowchart = flowchart;`})),G,ke=e((()=>{G=`import { IRContextMenu } from "@innorules/ir-style";
...
window.__IR_FLOWCHART__ = flowchart;`})),K,Ae=e((()=>{K=`<div id="flowchart_div" class="border" style="height: 550px"></div>`}));function q(){return(0,J.jsxs)(n,{children:[(0,J.jsx)(t,{children:`IRFlowchart ContextMenu`}),(0,J.jsx)(r,{docList:Y}),(0,J.jsx)(i,{htmlRaw:K,code:W,exampleCode:G})]})}var J,Y,je=e((()=>{Oe(),ke(),Ae(),a(),J=o(),Y=[[`/classes/_innorules_solid-ui.IRContextMenu.html`,`IRContextMenu`],[`/classes/_innorules_flowchart.IRFlowchart.html`,`IRFlowchart`],[`/variables/_innorules_flowchart.EVENT_TYPE.html`,`EVENT_TYPE`]],q.__docgenInfo={description:``,methods:[],displayName:`Basic`}})),X,Me=e((()=>{X=`import { IRFlowchart } from "@innorules/ir-style/lib/esm/flowchart.js";
...
window.__IR_FLOWCHART__ = flowchart;
globalThis.flowchart = flowchart;`})),Z,Ne=e((()=>{Z=`import { EVENT_TYPE } from "@innorules/ir-style/lib/esm/flowchart.js";
...
{
    console.log( EVENT_TYPE.MOUSEUP_SHEET, x, y );
} );`})),Q,Pe=e((()=>{Q=`<div class="mb--md">
    <button class="button" id="btn_add_if">if 노드 추가</button>
    <button class="button" id="btn_remove_selected">선택 개체 제거 (Delete 키)</button>
</div>
<div id="flowchart_div" class="border" style="height: 550px"></div>`}));function Fe(){return(0,$.jsxs)(n,{children:[(0,$.jsx)(t,{children:`Event`}),(0,$.jsx)(`p`,{children:`IRFlowchart의 이벤트 시스템을 사용하여 다양한 사용자 상호작용을 처리할 수 있습니다.`}),(0,$.jsx)(r,{docList:Ie}),(0,$.jsx)(i,{htmlRaw:Q,code:X,exampleCode:Z})]})}var $,Ie,Le=e((()=>{Me(),Ne(),Pe(),a(),$=o(),Ie=[[`/classes/_innorules_flowchart.IRFlowchart.html`,`IRFlowchart`],[`/variables/_innorules_flowchart.EVENT_TYPE.html`,`EVENT_TYPE`]],Fe.__docgenInfo={description:``,methods:[],displayName:`Basic`}})),Re,ze;e((()=>{ne(),se(),de(),me(),ve(),Ce(),De(),je(),Le(),Re={title:`JS Components/IRFlowchart`},ze=[`APIDemo`,`Export`,`Multiple`,`RuleArchitecture`,`ObjectAlign`,`Basic`,`Group`,`ContextMenu`,`Event`]}))();export{l as APIDemo,F as Basic,q as ContextMenu,Fe as Event,p as Export,V as Group,y as Multiple,A as ObjectAlign,w as RuleArchitecture,ze as __namedExportsOrder,Re as default};