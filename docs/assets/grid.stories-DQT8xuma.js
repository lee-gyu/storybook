import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{D as r,a as e,L as t,c as o,V as i}from"./version-tag-D_C1jUBh.js";import"./iframe-BvK5mbBg.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BIfM9e56.js";const l=`import {\r
    IRGrid,\r
...
\r
`,p='<div id="ir_grid" style="height: 500px; width: 1300px"></div>';function h(){return n.jsxs(r,{children:[n.jsx(e,{children:"IRGrid"}),n.jsx(t,{htmlRaw:p,code:b})]})}h.__docgenInfo={description:"",methods:[],displayName:"CellFormatter"};const _=`import { IRSplitContainer } from "@innorules/ir-style";\r
import {\r
    IRGrid,\r
    IRGridRowNoHeaderCellRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
...
<div class="flex background--light" style="height: 520px;">\r
    ...
    <div id="split2"></div>\r
</div>`,w=[["/classes/_innorules_ir-style.grid.IRGridColumnFillPlugin.html","IRGridColumnFillPlugin"]];function C(){return n.jsxs(r,{children:[n.jsx(e,{children:"IRGrid ColumnFill"}),n.jsxs("p",{children:["ColumnFill 플러그인을 등록하여 현재 Context 크기에 맞게 모든 열 크기를 균등 분배합니다. (추후 설정된 너비는 각 너비에 맞게 고루 분배됨)",n.jsx("br",{}),"colHeader의 ",n.jsx("code",{children:"maxSize"}),"를 9999로 설정해야 열 크기 제한 문제가 없습니다."]}),n.jsx(o,{docList:w}),n.jsx(t,{fixedHeight:600,htmlRaw:R,code:_,exampleCode:x})]})}C.__docgenInfo={description:"",methods:[],displayName:"ColumnFill"};const f=`import {\r
    IRGrid,\r
    IRGridRowNoHeaderCellRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
\r
...
} );`,G='<div id="ir_grid" style="height: 500px; width: 1300px"></div>',M=[["/classes/_innorules_ir-style.grid.CustomCellRenderer.html","CustomCellRenderer"]];function j(){return n.jsxs(r,{children:[n.jsx(e,{children:"IRGrid"}),n.jsxs("p",{children:[n.jsx("code",{children:"cellRenderer"}),"인터페이스를 임의로 작성하여 다양한 셀 형태를 출력할 수 있습니다."]}),n.jsx(o,{docList:M}),n.jsx(t,{htmlRaw:G,exampleCode:S})]})}j.__docgenInfo={description:"",methods:[],displayName:"CustomRenderer"};const T=`import {\r
    IRGrid,\r
...
<div id="ir_grid" style=" height: 500px; width: 800px"></div>`,H=[["/classes/_innorules_ir-style.grid.IRGridExchangeByHeaderCellPlugin.html","IRGridExchangeByHeaderCellPlugin"]];function D(){return n.jsxs(r,{children:[n.jsx(e,{children:"IRGrid"}),n.jsx("p",{children:"헤더를 드래그하여 셀 내용 교체할 수 있습니다."}),n.jsx(o,{docList:H}),n.jsx(t,{htmlRaw:z,code:T,exampleCode:P})]})}D.__docgenInfo={description:"",methods:[],displayName:"Exchange"};const A=`import {\r
    IRGrid,\r
    IRGridRowNoHeaderCellRenderer,\r
    IRGridDefaultCellRenderer,\r
    IRGridCheckboxRenderer,\r
...
\r
<div id="ir_grid" style="height: 500px; width: 100%"></div>`,$=[["/classes/_innorules_ir-style.grid.IRGrid.html#createfinder","IRGrid.createFinder"]];function F(){return n.jsxs(r,{children:[n.jsx(e,{children:"IRGrid Finder"}),n.jsx("p",{children:"Finder를 이용하여 셀 찾기 기능을 수행할 수 있습니다."}),n.jsx(o,{docList:$}),n.jsx(t,{htmlRaw:N,code:A,exampleCode:E})]})}F.__docgenInfo={description:"",methods:[],displayName:"Finder"};const B=`import {\r
    IRGrid,\r
    IRGridCheckboxRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
\r
...
<div id="ir_grid" style="height: 500px; width: 800px"></div>`,V=[["/classes/_innorules_ir-style.grid.IRGridMoveRowsPlugin.html","IRGridMoveRowsPlugin"],["/classes/_innorules_ir-style.grid.IRGridMoveColumnsPlugin.html","IRGridMoveColumnsPlugin"]];function W(){return n.jsxs(r,{children:[n.jsx(e,{children:"IRGrid"}),n.jsx("p",{children:"헤더를 드래그하여 행/열을 이동할 수 있습니다."}),n.jsx(o,{docList:V}),n.jsx(t,{htmlRaw:L,code:B,exampleCode:O})]})}W.__docgenInfo={description:"",methods:[],displayName:"MoveAPI"};const U=`import {\r
    IRGrid,\r
    IRGridDefaultCellRenderer,\r
    IRGridRowNoHeaderCellRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
...
</div>`,Y=[["/classes/_innorules_ir-style.grid.IRGridOverflowPanelPlugin.html","IRGridOverflowPanelPlugin"]];function J(){return n.jsxs(r,{children:[n.jsx(e,{children:"IRGrid Overflow Panel"}),n.jsx("p",{children:"IRGrid가 overflow될 경우 Grid의 스크롤 제어를 간편하게 할 수 있는 편의 기능을 제공한다."}),n.jsx(o,{docList:Y}),n.jsx(t,{fixedHeight:550,htmlRaw:q,code:U,exampleCode:X})]})}J.__docgenInfo={description:"",methods:[],displayName:"OverflowPanelPlugin"};const Z=`import {\r
    IRGrid,\r
    IRGridCheckboxRenderer,\r
    IRGridDefaultCellRenderer,\r
...
\r
<br />\r
<div id="ir_grid" style="height: 500px; width: 800px"></div>`,nn=[["/variables/_innorules_ir-style.grid.createIRGridColumnSortManager.html","createIRGridColumnSortManager"],["/variables/_innorules_ir-style.grid.createInferenceSortHandler.html","createInferenceSortHandler"]];function rn(){return n.jsxs(r,{children:[n.jsx(e,{children:"IRGrid"}),n.jsx("p",{children:"열을 클릭하여 정렬 실행"}),n.jsx(o,{docList:nn}),n.jsx(t,{htmlRaw:Q,exampleCode:K,code:Z})]})}rn.__docgenInfo={description:"",methods:[],displayName:"Sort"};const en=`import { getThemeStore } from "@innorules/ir-style";\r
import {\r
    IRGrid,\r
    IRGridRowNoHeaderCellRenderer,\r
    IRGridCheckboxRenderer,\r
...
grid.setColumnWidth( 2, 120 );\r
grid.setColumnWidth( 3, 120 );\r
grid.setColumnWidth( 4, 160 );`,tn='<div id="ir_grid" style="height: 500px"></div>';function on(){return n.jsxs(r,{children:[n.jsx(e,{children:"IRGrid Configuration"}),n.jsx("p",{children:"Grid 기본 내부 패딩을 조절할 수 있습니다."}),n.jsx(t,{fixedHeight:600,htmlRaw:tn,code:en})]})}on.__docgenInfo={description:"",methods:[],displayName:"ThemeConfig"};const ln=`import {\r
    IRGrid,\r
    IRGridCheckboxRenderer,\r
    IRGridDatePickerRenderer,\r
    IRGridDefaultCellRenderer,\r
...
</div>`,cn=[["/classes/_innorules_ir-style.grid.IRGridMultiSelectCellPlugin.html","IRGridMultiSelectCellPlugin"]];function an(){return n.jsxs(r,{children:[n.jsx(e,{children:"MultiSelectCellPlugin"}),n.jsx(i,{children:"ir-style@^2.21.0"}),n.jsxs("p",{children:["IRGrid에 다중 셀 선택 기능을 제공한다.",n.jsx("br",{}),n.jsx("b",{children:"※ 단독 사용은 불가능하며 반드시 IRGridMouseCellSelectorPlugin과 함께 사용"})]}),n.jsxs("p",{children:[n.jsx("b",{children:"복사/붙여넣기 참고 사항"}),n.jsx("br",{}),"- 복사와 붙여넣기는 선택한 셀들이 행과 열 모두에서 동일한 개수일 때만 동작한다. (잘못된 영역인 경우 경고 메시지 출력)",n.jsx("br",{}),"- 붙여넣기 시 선택한 셀들은 빈칸 없이 연속된 형태로 붙어서 표시된다.",n.jsx("br",{}),"※ 엑셀의 다중 셀 선택 복사/붙여넣기 동작 참고",n.jsx("br",{})]}),n.jsx(o,{docList:cn}),n.jsx(t,{htmlRaw:sn,exampleCode:dn,code:ln})]})}an.__docgenInfo={description:"",methods:[],displayName:"MultiSelectCellPlugin"};const un=`import {\r
    IRGrid,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
\r
const grid = new IRGrid( {\r
...
\r
globalThis.grid = grid;`,gn=`const grid = globalThis.grid;\r
\r
...
\r
grid.autoSizeColumns( 0, 2 );`,mn='<div id="ir_grid" style="height: 500px; width: 100%"></div>';function bn(){return n.jsxs(r,{children:[n.jsx(e,{children:"IRGrid 각 행/열 Min/Max Size 조정"}),n.jsx("p",{children:"아래 IRGrid API를 이용하여 각 행/열의 최소/최대 사이즈를 지정할 수 있습니다."}),n.jsxs("ul",{children:[n.jsxs("li",{className:"ir-h-[15px]",children:[n.jsx("a",{className:"text-link",target:"_blank",href:"http://innorules.com:32108/classes/_innorules_ir-style.grid.IRGrid.html#setrowminsize",rel:"noreferrer",children:"setRowMinSize"}),": 특정 행에 최소 높이 지정"]}),n.jsxs("li",{className:"ir-h-[15px]",children:[n.jsx("a",{className:"text-link",target:"_blank",href:"http://innorules.com:32108/classes/_innorules_ir-style.grid.IRGrid.html#setrowmaxsize",rel:"noreferrer",children:"setRowMaxSize"}),": 특정 행에 최대 높이 지정"]}),n.jsxs("li",{className:"ir-h-[15px]",children:[n.jsx("a",{className:"text-link",target:"_blank",href:"http://innorules.com:32108/classes/_innorules_ir-style.grid.IRGrid.html#setcolumnminsize",rel:"noreferrer",children:"setColumnMinSize"}),": 특정 열에 최소 높이 지정"]}),n.jsxs("li",{className:"ir-h-[15px]",children:[n.jsx("a",{className:"text-link",target:"_blank",href:"http://innorules.com:32108/classes/_innorules_ir-style.grid.IRGrid.html#setcolumnminsize",rel:"noreferrer",children:"setColumnMaxSize"}),": 특정 열에 최대 높이 지정"]})]}),n.jsx(t,{htmlRaw:mn,code:un,exampleCode:gn})]})}bn.__docgenInfo={description:"",methods:[],displayName:"MinMax"};const wn={title:"JS Components/IRGrid"},Cn=["APIDemo","BulkData","CellFormatter","ColumnFill","ContextMenu","CustomRenderer","ExchangeAPI","Finder","MoveAPI","OverflowPanelPlugin","Sort","ThemeConfig","MultiSelectCellPlugin","MinMax"];export{s as APIDemo,m as BulkData,h as CellFormatter,C as ColumnFill,k as ContextMenu,j as CustomRenderer,D as ExchangeAPI,F as Finder,bn as MinMax,W as MoveAPI,an as MultiSelectCellPlugin,J as OverflowPanelPlugin,rn as Sort,on as ThemeConfig,Cn as __namedExportsOrder,wn as default};
