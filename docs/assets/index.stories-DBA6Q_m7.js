import{j as t}from"./jsx-runtime-u17CrQMm.js";import{D as e,a as o,L as l}from"./version-tag-u3GxDBUd.js";import"./iframe-9F64GLpK.js";import"./preload-helper-PPVm8Dsz.js";import"./index-F4J0AwFl.js";const i=`import { createFloatingHandler } from "@innorules/ir-style";
...
};`,s="",r=`<div id="rect" class="border" style="height: 400px; position: relative;">
...
</div>`,g={title:"JS Utility/FloatingHandler"},n=()=>t.jsxs(e,{children:[t.jsx(o,{children:"createFloatingHandler"}),t.jsx(l,{css:s,htmlRaw:r,code:i})]});n.__docgenInfo={description:"",methods:[],displayName:"FloatingHandler"};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`() => {
  return <Doc>
