import{j as i,a as e,F as p}from"./jsx-runtime-KzWSGvcx.js";import{D as a,a as u,L as d}from"./doc-content-Bip4Hiu4.js";import"./index-DogsOklH.js";import"./index-xS4YNjdq.js";const M={title:"JS Utility/Create Split Container"},c=Array.from({length:20}).map((A,n)=>i("p",{children:["Panel ",n]},n)),o=e(p,{children:Array.from({length:100}).map((A,n)=>i("span",{children:["Panel ",n]},n))}),t=()=>i(a,{children:[e(u,{children:"createSplitContainer"}),i("p",{children:[e("code",{children:"createSplitContainer"}),"을 활용하여 구역 경계를 나누고, 사이즈를 변경할 수 있게 합니다."]}),e(d,{css:`
#live_editor_wrapper {
    padding: 0
}
`,fixedHeight:400,html:i(p,{children:[e("style",{children:".gutter{ background-color: var(--background-color) }"}),i("div",{className:"split-container",style:{display:"flex",height:"100%"},children:[e("div",{id:"split-0",className:"split-panel",children:"panel 1"}),e("div",{id:"split-1",className:"split-panel",children:"panel 2"}),i("div",{id:"split-2",className:"split-panel",children:[e("div",{id:"split-3",className:"split-panel",children:"panel 3"}),i("div",{id:"split-4",className:"split-panel",style:{display:"flex"},children:[e("div",{id:"split-5",className:"split-panel",children:c}),e("div",{id:"split-6",className:"split-panel",children:o})]})]})]})]}),code:`
...
createSplitContainer(['#split-5', '#split-6'])
                `})]}),r=()=>i(a,{children:[e(u,{children:"Size 설정"}),i("p",{children:[e("code",{children:"sizes"}),"를 이용하여 해당 패널의 백분율 배열로 지정할 수 있고,",e("br",{}),e("code",{children:"minSize(default: 100px), maxSize"}),"의 px를 지정하여 resize 가능한 크기 범위를 지정합니다.",e("br",{}),e("code",{children:"Infinity"}),"는 ",e("code",{children:"minSize"}),"에서 사용 시 설정된 패널 초기 크기로 지정되고, ",e("code",{children:"maxSize"}),"에서 사용 시 무한으로 늘어날 수 있습니다."]}),e(d,{css:`
#live_editor_wrapper {
    padding: 0
}
`,fixedHeight:400,html:i("div",{className:"split-container",style:{display:"flex",height:"100%"},children:[e("div",{id:"split-0",className:"split-panel",children:c}),e("div",{id:"split-1",className:"split-panel",children:o})]}),code:`
import { createSplitContainer } from "./dist/index.js";
...
createSplitContainer(['#split-0', '#split-1'], {
    ...
    maxSize: [700, Infinity]
                ...
                `})]}),s=()=>i(a,{children:[e(u,{children:"Event"}),i("p",{children:[e("code",{children:"onDrag"})," 이벤트를 이용하여 드래그 시 이벤트를 받을 수 있습니다.",e("br",{}),e("code",{children:"onDragStart"})," 이벤트를 이용하여 드래그 시작 시 이벤트를 받을 수 있습니다.",e("br",{}),e("code",{children:"onDragEnd"})," 이벤트를 이용하여 드래그 종료 시 이벤트를 받을 수 있습니다. "]}),e(d,{css:`
#live_editor_wrapper {
    padding: 0
}
`,fixedHeight:400,html:i("div",{className:"split-container",style:{display:"flex",height:"100%"},children:[e("div",{id:"split-0",className:"split-panel",children:c}),e("div",{id:"split-1",className:"split-panel",children:o})]}),code:`
...
createSplitContainer(['#split-0', '#split-1'], {
    ...
    onDragEnd: (sizes) => console.log("end : ", sizes),
                ...
                `})]}),l=()=>i(a,{children:[e(u,{children:"API"}),i("p",{children:[e("code",{children:"setSizes([25, 75])"})," 백분율 배열로, 분할 요소의 크기를 업데이트할 수 있습니다.",e("br",{}),e("code",{children:"getSizes"})," resize된 백분율 배열을 반환합니다.",e("br",{}),e("code",{children:"collapse(index)"})," 설정된 minSize의 크기로 요소의 크기를 변경합니다. (모든 요소는 앞쪽, 위쪽으로 축소됨)",e("br",{}),e("code",{children:"destroy(preserveStyles? = false, preserveGutters? = false)"})," split을 제거합니다. (preserveStyle: CSS 제거 여부, preserveGutters: gutter 제거 여부)"]}),e(d,{css:`
#live_editor_wrapper {
    padding: 0
}
`,fixedHeight:400,html:i(p,{children:[i("div",{className:"ir-flex ir-gap-x-xxs ir-p-xs",style:{borderBottom:"1px solid var(--border-color)"},children:[e("button",{id:"btn1",className:"button",children:"Get Size"}),e("button",{id:"btn2",className:"button",children:"Collapse"}),e("button",{id:"btn3",className:"button",children:"Destroy"})]}),i("div",{className:"split-container",style:{display:"flex",height:"100%"},children:[e("div",{id:"split-0",className:"split-panel",children:c}),e("div",{id:"split-1",className:"split-panel",children:o})]})]}),code:`
import { createSplitContainer } from "./dist/index.js";
...
split.setSizes([25, 75]);
                `})]});var C,B,m;t.parameters={...t.parameters,docs:{...(C=t.parameters)==null?void 0:C.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(g=(E=s.parameters)==null?void 0:E.docs)==null?void 0:g.source}}};var x,N,b;l.parameters={...l.parameters,docs:{...(x=l.parameters)==null?void 0:x.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(b=(N=l.parameters)==null?void 0:N.docs)==null?void 0:b.source}}};const T=["createSplitContainer","Size","Event","API"];export{l as API,s as Event,r as Size,T as __namedExportsOrder,t as createSplitContainer,M as default};
