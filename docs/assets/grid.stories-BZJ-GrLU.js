import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{D as n,a as e,L as t,c as l,V as o}from"./version-tag-1ISCo9iz.js";import"./iframe-DxH2WbHS.js";import"./preload-helper-PPVm8Dsz.js";import"./index-C-dz2EWN.js";const i=`import {\r
    IRGrid,\r
...
globalThis.rightGrid = rightGrid;`,R=`import { IRGridCellDropPlugin, IRGridSingleCellDragPlugin } from "@innorules/ir-style/lib/esm/grid.js";\r
\r
const leftGrid = globalThis.leftGrid;\r
...
</div>`,h=[["/classes/_innorules_ir-style.grid.IRGridSingleCellDragPlugin.html","IRGridSingleCellDragPlugin"],["/classes/_innorules_ir-style.grid.IRGridCellDropPlugin.html","IRGridCellDropPlugin"]];function p(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsxs("p",{children:[r.jsx("code",{children:"SingleCellDragPlugin"}),"을 이용하여 단일 셀 Drag 기능을 활성화 할 수 있습니다. 단, MouseCellSelectorPlugin과는 같이 사용할 수 없습니다.",r.jsx("br",{}),"셀의 ",r.jsx("code",{children:"draggable"})," 속성이 true로 지정된 셀에서 drag가 시작될 수 있으며, 기본 기능은 cell의 object 개체가 필요합니다."]}),r.jsx(l,{docList:h}),r.jsx(t,{htmlRaw:x,code:b,exampleCode:R})]})}p.__docgenInfo={description:"",methods:[],displayName:"CellDrag"};const C=`import {\r
    IRGrid,\r
...
\r
`,w='<div id="ir_grid" style="height: 500px; width: 1300px"></div>';function _(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsx(t,{htmlRaw:w,code:C})]})}_.__docgenInfo={description:"",methods:[],displayName:"CellFormatter"};const f=`import {\r
    IRGrid,\r
...
\r
grid.setCell( 2, 6, { label: "달디다고 달디달고 달디단 밤양갱" } );`,I=`<div class="mb--lg">\r
    <button id="btn_check_commands" class="button">Check commands</button>\r
</div>\r
<div id="ir_grid" style="height: 500px; width: 1300px"></div>`;function v(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsxs("p",{children:[r.jsx("code",{children:"cellRenderer"}),"를 재정의하여 여러 타입의 셀을 출력할 수 있습니다."]}),r.jsx(t,{htmlRaw:I,code:f})]})}v.__docgenInfo={description:"",methods:[],displayName:"CellRenderer"};const G=`import { IRSplitContainer } from "@innorules/ir-style";\r
import {\r
    IRGrid,\r
    IRGridRowNoHeaderCellRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
...
\r
globalThis.grid = grid;`,y=`import { IRGridColumnFillPlugin } from "@innorules/ir-style/lib/esm/grid.js";\r
\r
grid.addPlugin( new IRGridColumnFillPlugin( {\r
    columnWeight: ["120px", 1, 1, 1, 2],\r
} ) );`,T=`<button id="btn1" class='button'>visible on/off</button>\r
<div class="flex background--light" style="height: 520px;">\r
    <div id="split1">\r
        <div id="ir_grid" style="height: 400px; width: 100%; display: none"></div>\r
    </div>\r
    <div id="split2"></div>\r
</div>`,k=[["/classes/_innorules_ir-style.grid.IRGridColumnFillPlugin.html","IRGridColumnFillPlugin"]];function S(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid ColumnFill"}),r.jsxs("p",{children:["ColumnFill 플러그인을 등록하여 현재 Context 크기에 맞게 모든 열 크기를 균등 분배합니다. (추후 설정된 너비는 각 너비에 맞게 고루 분배됨)",r.jsx("br",{}),"colHeader의 ",r.jsx("code",{children:"maxSize"}),"를 9999로 설정해야 열 크기 제한 문제가 없습니다."]}),r.jsx(l,{docList:k}),r.jsx(t,{fixedHeight:600,htmlRaw:T,code:G,exampleCode:y})]})}S.__docgenInfo={description:"",methods:[],displayName:"ColumnFill"};const j=`import {\r
    IRGrid,\r
    IRGridRowNoHeaderCellRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
\r
...
\r
globalThis.grid = grid;`,P=`import { IRContextMenu } from "@innorules/ir-style";\r
\r
...
`,D='<div id="ir_grid" style="height: 500px; width: 800px"></div>',M=[["/classes/_innorules_ir-style.index.IRContextMenu.html","IRContextMenu"],["/classes/_innorules_ir-style.grid.IRGrid.html#oncontextmenu","IRGrid.onContextMenu"]];function A(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid ContextMenu"}),r.jsx(l,{docList:M}),r.jsx(t,{htmlRaw:D,code:j,exampleCode:P})]})}A.__docgenInfo={description:"",methods:[],displayName:"ContextMenu"};const z=`import {\r
    IRGrid,\r
    IRGridDefaultCellRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
\r
...
new IRGrid( {\r
    ...
    body: {\r
        ...
        {\r
            switch ( col )\r
            {\r
                case 3: return customRenderer( row, col, data );\r
...
} );`,E='<div id="ir_grid" style="height: 500px; width: 1300px"></div>',H=[["/classes/_innorules_ir-style.grid.CustomCellRenderer.html","CustomCellRenderer"]];function N(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsxs("p",{children:[r.jsx("code",{children:"cellRenderer"}),"인터페이스를 임의로 작성하여 다양한 셀 형태를 출력할 수 있습니다."]}),r.jsx(l,{docList:H}),r.jsx(t,{htmlRaw:E,exampleCode:z})]})}N.__docgenInfo={description:"",methods:[],displayName:"CustomRenderer"};const $=`import { IRTree } from "@innorules/ir-style";\r
import {\r
    IRGrid,\r
    IRGridDefaultCellRenderer,\r
    IRGridRowNoHeaderCellRenderer,\r
...
\r
tree.expandAll();`,B=`<div style="display: flex; height: 500px; column-gap: 8px">\r
    <div id="tree" style="width: 300px"></div>\r
    <div id="ir_grid" style="height: 100%; width: 100%"></div>\r
</div>`;function F(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsx("p",{children:"좌측 Tree 노드를 드래그하여 Grid Cell에 드롭할 수 있습니다."}),r.jsx(t,{htmlRaw:B,code:$})]})}F.__docgenInfo={description:"",methods:[],displayName:"DragDrop"};const O=`import {\r
    IRGrid,\r
    IRGridCheckboxRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
\r
...
\r
globalThis.grid = grid;`,L=`import { IRGridExchangeByHeaderCellPlugin } from "@innorules/ir-style/lib/esm/grid.js";\r
\r
const grid = globalThis.grid;\r
\r
...
};`,V=`<div class="flex mb--lg" style=" align-items:center; column-gap: 4px">\r
    source:\r
...
<div id="ir_grid" style=" height: 500px; width: 800px"></div>`,W=[["/classes/_innorules_ir-style.grid.IRGridExchangeByHeaderCellPlugin.html","IRGridExchangeByHeaderCellPlugin"]];function U(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsx("p",{children:"헤더를 드래그하여 셀 내용 교체할 수 있습니다."}),r.jsx(l,{docList:W}),r.jsx(t,{htmlRaw:V,code:O,exampleCode:L})]})}U.__docgenInfo={description:"",methods:[],displayName:"Exchange"};const X=`import {\r
    IRGrid,\r
    IRGridRowNoHeaderCellRenderer,\r
    IRGridDefaultCellRenderer,\r
    IRGridCheckboxRenderer,\r
...
\r
globalThis.grid = grid;`,q=`const grid = globalThis.grid;\r
\r
...
\r
<div id="ir_grid" style="height: 500px; width: 100%"></div>`,K=[["/classes/_innorules_ir-style.grid.IRGrid.html#createfinder","IRGrid.createFinder"]];function Y(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid Finder"}),r.jsx("p",{children:"Finder를 이용하여 셀 찾기 기능을 수행할 수 있습니다."}),r.jsx(l,{docList:K}),r.jsx(t,{htmlRaw:J,code:X,exampleCode:q})]})}Y.__docgenInfo={description:"",methods:[],displayName:"Finder"};const Z=`import {\r
    IRGrid,\r
    IRGridCheckboxRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
\r
...
\r
grid.addPlugin( moveRowPlugin );\r
grid.addPlugin( moveColPlugin );`,rr=`<div class="flex mb--lg" style="align-items: center; column-gap: 4px">\r
...
<div id="ir_grid" style="height: 500px; width: 800px"></div>`,nr=[["/classes/_innorules_ir-style.grid.IRGridMoveRowsPlugin.html","IRGridMoveRowsPlugin"],["/classes/_innorules_ir-style.grid.IRGridMoveColumnsPlugin.html","IRGridMoveColumnsPlugin"]];function er(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsx("p",{children:"헤더를 드래그하여 행/열을 이동할 수 있습니다."}),r.jsx(l,{docList:nr}),r.jsx(t,{htmlRaw:rr,code:Z,exampleCode:Q})]})}er.__docgenInfo={description:"",methods:[],displayName:"MoveAPI"};const tr=`import {\r
    IRGrid,\r
    IRGridDefaultCellRenderer,\r
    IRGridRowNoHeaderCellRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
...
\r
globalThis.grid = grid;`,lr=`import { IRGridOverflowPanelPlugin } from "@innorules/ir-style/lib/esm/grid.js";\r
\r
const grid = globalThis.grid;\r
\r
grid.addPlugin( new IRGridOverflowPanelPlugin( {\r
    ...
    className: "test-cls",\r
} ) );`,or=`<button type='button' id="btn_freeze_rows" class='button mb--sm'>행 고정</button>\r
...
</div>`,ir=[["/classes/_innorules_ir-style.grid.IRGridOverflowPanelPlugin.html","IRGridOverflowPanelPlugin"]];function dr(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid Overflow Panel"}),r.jsx("p",{children:"IRGrid가 overflow될 경우 Grid의 스크롤 제어를 간편하게 할 수 있는 편의 기능을 제공한다."}),r.jsx(l,{docList:ir}),r.jsx(t,{fixedHeight:550,htmlRaw:or,code:tr,exampleCode:lr})]})}dr.__docgenInfo={description:"",methods:[],displayName:"OverflowPanelPlugin"};const sr=`import { IRSelect, i18n } from "@innorules/ir-style";\r
import {\r
    IRGrid,\r
    IRGridCheckboxRenderer,\r
    IRGridDatePickerRenderer,\r
...
} );`,cr=`<div class="flex mb--lg gap-x--lg gap-y--lg align-items--center">\r
...
<div id="ir_grid" style="height: 500px; width: 800px"></div>`;function ar(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid Row Filter"}),r.jsx(o,{children:"ir-style@^2.17.0"}),r.jsx("p",{}),r.jsx(t,{htmlRaw:cr,code:sr})]})}ar.__docgenInfo={description:"",methods:[],displayName:"GridFilter"};const ur=`const items = [\r
    { value: "ko", text: "한국어" },\r
    { value: "en", text: "영어" },\r
...
globalThis.createBulkItems = createBulkItems;`,gr=`import {\r
    IRGrid,\r
    IRGridDefaultCellRenderer,\r
    IRGridSelectCellRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
...
\r
globalThis.setGrid( grid );`,mr='<div id="ir_grid" style="height: 500px; width: 1300px"></div>',br=[["/classes/_innorules_ir-style.grid.IRGridSelectCellRenderer.html","IRGridSelectCellRenderer"],["/types/_innorules_ir-style.grid.RenderGridSelectArgs.html","Type Alias RenderGridSelectArgs"]];function Rr(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid SelectCell"}),r.jsx(l,{docList:br}),r.jsx(t,{htmlRaw:mr,code:ur,exampleCode:gr})]})}Rr.__docgenInfo={description:"",methods:[],displayName:"SelectCell"};const xr=`import {\r
...
for( let i = 1; i < rowCnt; i++ )\r
    grid.setText( i, 0, i.toString() );`,hr=`<button type='button' id="btn_reset_sort" class='button mb--sm'>정렬 초기화</button>\r
...
<br />\r
<div id="ir_grid" style="height: 500px; width: 800px"></div>`;function pr(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsx("p",{children:"열을 클릭하여 정렬 실행"}),r.jsx(t,{htmlRaw:hr,code:xr})]})}pr.__docgenInfo={description:"",methods:[],displayName:"Sort"};const Cr=`import {\r
...
<br />
<div id="ir_grid" style="height: 500px; width: 800px"></div>`;function _r(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid"}),r.jsx("p",{children:"열을 클릭하여 정렬 실행"}),r.jsx(t,{htmlRaw:wr,code:Cr})]})}_r.__docgenInfo={description:"",methods:[],displayName:"SortRange"};const fr=`\r
...
\r
globalThis.setGrid( grid );`,vr=`<div>\r
...
</div>`,Gr=[["/classes/_innorules_ir-style.grid.IRGridTablePlugin.html","IRGridTablePlugin"],["/interfaces/_innorules_ir-style.grid.IRGridTablePluginAPI.html","IRGridTablePluginAPI"]];function yr(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGridTablePlugin"}),r.jsx(o,{children:"ir-style@^2.13.0"}),r.jsxs("p",{children:["IRGridTablePlugin은 IRGrid에 다양한 테이블 관련 기능을 추가하는 플러그인입니다.",r.jsx("br",{}),"이 플러그인을 사용하면 다중 행 선택, 마지막 열 고정, 드래그 앤 드롭 등 다양한 테이블 조작 기능을 구현할 수 있습니다."]}),r.jsx(l,{docList:Gr}),r.jsx(t,{defaultCodeFold:[55],htmlRaw:vr,code:fr,exampleCode:Ir})]})}yr.__docgenInfo={description:"",methods:[],displayName:"TablePlugin"};const Tr=`import {\r
    IRGrid,\r
    IRGridDefaultCellIconButtonRenderer,\r
    IRGridDefaultCellRenderer,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
...
\r
globalThis.rightGrid = rightGrid;`,kr=`import {\r
    IRGrid,\r
    IRGridPopoverPlugin,\r
    IRGridResizerPlugin,\r
    IRGridTablePlugin,\r
...
</div>`,jr=[["/classes/_innorules_ir-style.grid.IRGridTablePlugin.html","IRGridTablePlugin"],["/interfaces/_innorules_ir-style.grid.IRGridTablePluginAPI.html","IRGridTablePluginAPI"]];function Pr(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGridTablePlugin RowDraggable"}),r.jsx(o,{children:"ir-style@^2.22.0"}),r.jsxs("p",{children:["IRGridTablePlugin에서 ",r.jsx("code",{children:"rowDraggable"})," 속성을 사용하면 테이블 행 전체를 드래그 할 수 있다.",r.jsx("br",{}),"선택한 행은 드래그할 수 있으며, `Ctrl + Click`으로 선택을 해제할 수 있다. ",r.jsx("br",{}),r.jsx("code",{children:"multipleSelect"})," 속성과 같이 사용할 경우 다중 행 드래그가 가능하다.",r.jsx("br",{}),r.jsxs("b",{children:["※ 기본적으로 행을 드래그하려면, 선택된 행의 0번째 컬럼 중 최소 하나 이상 ",r.jsx("code",{children:"draggable: true"}),"와, cell의 object가 정의되어 있어야 한다."]})]}),r.jsx(l,{docList:jr}),r.jsx(t,{htmlRaw:Sr,code:Tr,exampleCode:kr})]})}Pr.__docgenInfo={description:"",methods:[],displayName:"TablePluginRowDraggable"};const Dr=`import { getThemeStore } from "@innorules/ir-style";\r
import {\r
    IRGrid,\r
    IRGridRowNoHeaderCellRenderer,\r
    IRGridCheckboxRenderer,\r
...
grid.setColumnWidth( 2, 120 );\r
grid.setColumnWidth( 3, 120 );\r
grid.setColumnWidth( 4, 160 );`,Mr='<div id="ir_grid" style="height: 500px"></div>';function Ar(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid Configuration"}),r.jsx("p",{children:"Grid 기본 내부 패딩을 조절할 수 있습니다."}),r.jsx(t,{fixedHeight:600,htmlRaw:Mr,code:Dr})]})}Ar.__docgenInfo={description:"",methods:[],displayName:"ThemeConfig"};const zr=`import {\r
    IRGrid,\r
    IRGridCheckboxRenderer,\r
    IRGridDatePickerRenderer,\r
    IRGridDefaultCellRenderer,\r
...
</div>`;function Hr(){return r.jsxs(n,{children:[r.jsx(e,{children:"MultiSelectCellPlugin"}),r.jsx(o,{children:"ir-style@^2.21.0"}),r.jsxs("p",{children:["IRGrid에 다중 셀 선택 기능을 제공한다.",r.jsx("br",{}),r.jsx("b",{children:"※ 단독 사용은 불가능하며 반드시 IRGridMouseCellSelectorPlugin과 함께 사용"})]}),r.jsxs("p",{children:[r.jsx("b",{children:"복사/붙여넣기 참고 사항"}),r.jsx("br",{}),"- 복사와 붙여넣기는 선택한 셀들이 행과 열 모두에서 동일한 개수일 때만 동작한다. (잘못된 영역인 경우 경고 메시지 출력)",r.jsx("br",{}),"- 붙여넣기 시 선택한 셀들은 빈칸 없이 연속된 형태로 붙어서 표시된다.",r.jsx("br",{}),"※ 엑셀의 다중 셀 선택 복사/붙여넣기 동작 참고",r.jsx("br",{})]}),r.jsx(t,{htmlRaw:Er,code:zr})]})}Hr.__docgenInfo={description:"",methods:[],displayName:"MultiSelectCellPlugin"};const Nr=`import {\r
    IRGrid,\r
} from "@innorules/ir-style/lib/esm/grid.js";\r
\r
const grid = new IRGrid( {\r
...
\r
globalThis.grid = grid;`,$r=`const grid = globalThis.grid;\r
\r
...
\r
grid.autoSizeColumns( 0, 2 );`,Br='<div id="ir_grid" style="height: 500px; width: 100%"></div>';function Fr(){return r.jsxs(n,{children:[r.jsx(e,{children:"IRGrid 각 행/열 Min/Max Size 조정"}),r.jsx("p",{children:"아래 IRGrid API를 이용하여 각 행/열의 최소/최대 사이즈를 지정할 수 있습니다."}),r.jsxs("ul",{children:[r.jsxs("li",{className:"ir-h-[15px]",children:[r.jsx("a",{className:"text-link",target:"_blank",href:"http://innorules.com:32108/classes/_innorules_ir-style.grid.IRGrid.html#setrowminsize",rel:"noreferrer",children:"setRowMinSize"}),": 특정 행에 최소 높이 지정"]}),r.jsxs("li",{className:"ir-h-[15px]",children:[r.jsx("a",{className:"text-link",target:"_blank",href:"http://innorules.com:32108/classes/_innorules_ir-style.grid.IRGrid.html#setrowmaxsize",rel:"noreferrer",children:"setRowMaxSize"}),": 특정 행에 최대 높이 지정"]}),r.jsxs("li",{className:"ir-h-[15px]",children:[r.jsx("a",{className:"text-link",target:"_blank",href:"http://innorules.com:32108/classes/_innorules_ir-style.grid.IRGrid.html#setcolumnminsize",rel:"noreferrer",children:"setColumnMinSize"}),": 특정 열에 최소 높이 지정"]}),r.jsxs("li",{className:"ir-h-[15px]",children:[r.jsx("a",{className:"text-link",target:"_blank",href:"http://innorules.com:32108/classes/_innorules_ir-style.grid.IRGrid.html#setcolumnminsize",rel:"noreferrer",children:"setColumnMaxSize"}),": 특정 열에 최대 높이 지정"]})]}),r.jsx(t,{htmlRaw:Br,code:Nr,exampleCode:$r})]})}Fr.__docgenInfo={description:"",methods:[],displayName:"MinMax"};const Xr={title:"JS Components/IRGrid"},qr=["APIDemo","BulkData","CellDrag","CellFormatter","CellRenderer","ColumnFill","ContextMenu","CustomRenderer","DragDrop","ExchangeAPI","Finder","MoveAPI","OverflowPanelPlugin","RowFilterPlugin","SelectCell","Sort","SortRange","TablePlugin","TablePluginRowDraggable","ThemeConfig","MultiSelectCellPlugin","MinMax"];export{s as APIDemo,m as BulkData,p as CellDrag,_ as CellFormatter,v as CellRenderer,S as ColumnFill,A as ContextMenu,N as CustomRenderer,F as DragDrop,U as ExchangeAPI,Y as Finder,Fr as MinMax,er as MoveAPI,Hr as MultiSelectCellPlugin,dr as OverflowPanelPlugin,ar as RowFilterPlugin,Rr as SelectCell,pr as Sort,_r as SortRange,yr as TablePlugin,Pr as TablePluginRowDraggable,Ar as ThemeConfig,qr as __namedExportsOrder,Xr as default};
