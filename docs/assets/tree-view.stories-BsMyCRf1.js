...
`})]})}x.__docgenInfo={description:"",methods:[],displayName:"StickyColumn"};function b(){return e.jsxs(n,{children:[e.jsx(t,{children:"IRTreeView"}),e.jsx(r,{children:"ir-style@^2.17.0"}),e.jsxs("p",{children:[e.jsx("code",{children:"IRTreeViewTooltipPlugin"}),"을 이용하여 tooltip 기능을 사용하실 수 있습니다.",e.jsx("br",{}),"※ 비활성화 노드와 빈 값은 툴팁이 적용되지 않습니다."]}),e.jsx(o,{html:e.jsxs(e.Fragment,{children:[e.jsx("button",{id:"remove_btn",className:"button mb--lg",children:"Remove Plugin"}),e.jsxs("div",{children:[e.jsx("div",{id:"treeview",style:{display:"grid",height:300,border:"1px solid var(--border-color)"}}),e.jsx("div",{id:"temp"})]})]}),code:`
import {
    IRTreeView,
    uuid,
    i18n,
...
createSplitContainer(["#treeview", "#temp"], { direction: "horizontal", sizes: [70, 30] })
...
`})]});d.__docgenInfo={description:"",methods:[],displayName:"Basic"};var i,l,a;d.parameters={...d.parameters,docs:{...(i=d.parameters)==null?void 0:i.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(a=(l=d.parameters)==null?void 0:l.docs)==null?void 0:a.source}}};const v=["Basic","Checkbox","BulkData","DragDrop","DragDropMove","CascadeChecking","StickyColumn","Tooltip"];export{d as Basic,s as BulkData,m as CascadeChecking,c as Checkbox,u as DragDrop,p as DragDropMove,x as StickyColumn,b as Tooltip,v as __namedExportsOrder,C as default};
