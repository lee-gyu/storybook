import{j as r,a as e}from"./jsx-runtime-CjohWU4o.js";import{D as d,a,L as i}from"./doc-content-CB4FAwiC.js";import"./index-CBqU2yxZ.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-Bl6ORisp.js";const D={title:"JS Components/Grid"},n=()=>r(d,{children:[e(a,{children:"IRGrid"}),r("p",{children:[e("code",{children:"SingleCellDragPlugin"}),"을 이용하여 단일 셀 Drag 기능을 활성화 할 수 있습니다. 단, MouseCellSelectorPlugin과는 같이 사용할 수 없습니다."]}),r("p",{children:["셀의 ",e("code",{children:"draggable"})," 속성이 true로 지정된 셀에서 drag가 시작될 수 있으며, 기본 기능은 cell의 object 개체가 필요합니다."]}),e(i,{html:r("div",{style:{display:"flex",flexDirection:"row",height:500,columnGap:8},children:[e("div",{id:"ir_grid1",style:{flex:1}}),e("div",{id:"ir_grid2",style:{flex:1}})]}),code:`
...
`})]});var l,o,t;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`() => {
  return <Doc>\r
...
}`,...(t=(o=n.parameters)==null?void 0:o.docs)==null?void 0:t.source}}};const w=["CellDrag"];export{n as CellDrag,w as __namedExportsOrder,D as default};
