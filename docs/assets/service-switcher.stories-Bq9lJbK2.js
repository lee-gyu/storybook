import{j as e}from"./jsx-runtime-DEdD30eg.js";import{D as t,a as s,L as n}from"./doc-content-TwLFnQmr.js";import"./index-RYns6xqu.js";const m={title:"Common UI/Service Switcher"},r=()=>e.jsxs(t,{children:[e.jsx(s,{children:"createServiceSwitcher"}),e.jsx("p",{children:"제품 전환을 위한 UI를 출력합니다. 이 모듈은 아래 제약 조건이 충족되어야 합니다."}),e.jsx("ul",{children:e.jsxs("li",{children:[e.jsx("code",{children:"sessionStorage"}),"의 ",e.jsx("code",{children:"com.innorules.webapi@entry-script-parameters"}),"에 사용자 세션이 초기화 되어 있어야 함."]})}),e.jsx(n,{fixedHeight:450,html:e.jsx(e.Fragment,{children:e.jsx("button",{className:"button",children:"제품 전환 UI 출력"})}),code:`
