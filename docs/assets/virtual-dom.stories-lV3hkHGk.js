import{j as t,a as n,F as a}from"./jsx-runtime-KzWSGvcx.js";import{D as l,a as d,L as s}from"./doc-content-Y1bYfLkc.js";import"./index-DogsOklH.js";import"./index-xS4YNjdq.js";const m={title:"JS Components/VirtualDOM"},e=()=>t(l,{children:[n(d,{children:"IRVirtualDOM"}),t("p",{children:[n("code",{children:"IRVirtualDOM"})," 클래스를 이용하여 bulk 데이터를 표시해야 하는 경우, 브라우저 성능 문제를 최소화 할 수 있습니다."]}),n(s,{fixedHeight:400,html:t(a,{children:[n("style",{children:`
                    #virtual_dom {
                        width: 750px;
                        height: 300px;
                    }
