...
import { L as En } from "./chunks/logger-tcVmqCe8.js";
...
import { I as wr } from "./chunks/index-B7zGscus.js";
...
Gt.prototype = ae.prototype = {
  constructor: Gt,
  on: function(n, t) {
    var e = this._, r = Sr(n + "", e), i, o = -1, s = r.length;
    ...
    for (; ++o < s; )
      if (i = (n = r[o]).type) e[i] = We(e[i], n.name, t);
      else if (t == null) for (i in e) e[i] = We(e[i], n.name, null);
    return this;
  },
  copy: function() {
    var n = {}, t = this._;
...
function We(n, t, e) {
  for (var r = 0, i = n.length; r < i; ++r)
    if (n[r].name === t) {
      n[r] = Or, n = n.slice(0, r).concat(n.slice(r + 1));
      break;
    }
...
function ce(n) {
  var t = n += "", e = t.indexOf(":");
  return e >= 0 && (t = n.slice(0, e)) !== "xmlns" && (n = n.slice(e + 1)), qe.hasOwnProperty(t) ? { space: qe[t], local: n } : n;
}
function Cr(n) {
  return function() {
...
function Ae(n) {
  var t = ce(n);
  return (t.local ? Er : Cr)(t);
}
function Ir() {
}
function Ne(n) {
  return n == null ? Ir : function() {
...
function kn(n) {
  return n == null ? Tr : function() {
    return this.querySelectorAll(n);
  };
}
function Ar(n) {
  return function() {
    return jr(n.apply(this, arguments));
  };
}
function Nr(n) {
  typeof n == "function" ? n = Ar(n) : n = kn(n);
...
var Dr = Array.prototype.find;
function zr(n) {
  return function() {
    return Dr.call(this.children, n);
  };
}
function Pr() {
...
function Rr(n) {
  return this.select(n == null ? Pr : zr(typeof n == "function" ? n : Tn(n)));
}
...
function Xr(n) {
  return function() {
    return $r.call(this.children, n);
  };
}
function Lr(n) {
  return this.selectAll(n == null ? Hr : Xr(typeof n == "function" ? n : Tn(n)));
}
function Yr(n) {
...
function qr(n, t) {
  ...
  var e = t ? Ur : Vr, r = this._parents, i = this._groups;
  typeof n != "function" && (n = Br(n));
  for (var o = i.length, s = new Array(o), a = new Array(o), c = new Array(o), l = 0; l < o; ++l) {
    var h = r[l], f = i[l], d = f.length, _ = Gr(n.call(h, h && h.__data__, l, r)), w = _.length, M = a[l] = new Array(w), k = s[l] = new Array(w), b = c[l] = new Array(d);
    e(h, f, M, k, b, _, t);
...
function gi(n, t) {
  ...
  return this.each((t == null ? e.local ? li : ci : typeof t == "function" ? e.local ? fi : ui : e.local ? di : hi)(e, t));
}
function Nn(n) {
...
function mi(n, t, e) {
  return arguments.length > 1 ? this.each((t == null ? pi : typeof t == "function" ? yi : _i)(n, t, e ?? "")) : St(this.node(), n);
}
function St(n, t) {
...
function vi(n, t) {
  return arguments.length > 1 ? this.each((t == null ? bi : typeof t == "function" ? xi : wi)(n, t)) : this.node()[n];
}
function Dn(n) {
...
function Pn(n, t) {
  for (var e = De(n), r = -1, i = t.length; ++r < i; ) e.add(t[r]);
}
function Rn(n, t) {
  for (var e = De(n), r = -1, i = t.length; ++r < i; ) e.remove(t[r]);
}
function Oi(n) {
  return function() {
    Pn(this, n);
...
function Ci(n, t) {
  ...
  return this.each((typeof t == "function" ? Mi : t ? Oi : Si)(e, t));
}
function Ei() {
  this.textContent = "";
}
...
function ji(n) {
  return arguments.length ? this.each(n == null ? Ei : (typeof n == "function" ? ki : Ii)(n)) : this.node().textContent;
}
function Ti() {
  this.innerHTML = "";
}
...
function Di(n) {
  return arguments.length ? this.each(n == null ? Ti : (typeof n == "function" ? Ni : Ai)(n)) : this.node().innerHTML;
}
function zi() {
...
function Hi(n) {
  var t = typeof n == "function" ? n : Ae(n);
...
function Li(n, t) {
  var e = typeof n == "function" ? n : Ae(n), r = t == null ? Xi : typeof t == "function" ? t : Ne(t);
  return this.select(function() {
...
function Ji(n, t, e) {
  ...
  for (a = t ? Zi : Ki, i = 0; i < o; ++i) this.each(a(r[i], t, e));
  return this;
}
function $n(n, t, e) {
...
function eo(n, t) {
  return this.each((typeof t == "function" ? to : Qi)(n, t));
}
function* no() {
  for (var n = this._groups, t = 0, e = n.length; t < e; ++t)
...
function F(n) {
  return Y(Ae(n).call(document.documentElement));
}
function io(n) {
  let t;
...
function et(n, t) {
  if (n = io(n), t === void 0 && (t = n.currentTarget), t) {
...
const oo = { passive: !1 }, At = { capture: !0, passive: !1 };
function pe(n) {
...
function at() {
  var n = so, t = ao, e = co, r = lo, i = {}, o = ae("start", "drag", "end"), s = 0, a, c, l, h, f = 0;
  function d(p) {
    p.on("mousedown.drag", _).filter(r).on("touchstart.drag", k).on("touchmove.drag", b, oo).on("touchend.drag touchcancel.drag", j).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  function _(p, S) {
  ...
  function T(p, S, C, E, N, R) {
    ...
    if ((u = e.call(p, new ve("beforestart", {
      ...
      return yt = u.x - $[0] || 0, mt = u.y - $[1] || 0, function y(g, m, x) {
        var v = $, O;
        switch (g) {
          case "start":
            i[N] = y, O = s++;
...
var Nt = 0.7, te = 1 / Nt, Ot = "\\s*([+-]?\\d+)\\s*", Dt = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", K = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", ho = /^#([0-9a-f]{3,8})$/, uo = new RegExp(`^rgb\\(${Ot},${Ot},${Ot}\\)$`), fo = new RegExp(`^rgb\\(${K},${K},${K}\\)$`), go = new RegExp(`^rgba\\(${Ot},${Ot},${Ot},${Dt}\\)$`), po = new RegExp(`^rgba\\(${K},${K},${K},${Dt}\\)$`), _o = new RegExp(`^hsl\\(${Dt},${K},${K}\\)$`), yo = new RegExp(`^hsla\\(${Dt},${K},${K},${Dt}\\)$`), Ge = {
  aliceblue: 15792383,
...
function zt(n) {
  var t, e;
  return n = (n + "").trim().toLowerCase(), (t = ho.exec(n)) ? (e = t[1].length, t = parseInt(t[1], 16), e === 6 ? Je(t) : e === 3 ? new H(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : e === 8 ? Xt(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : e === 4 ? Xt(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = uo.exec(n)) ? new H(t[1], t[2], t[3], 1) : (t = fo.exec(n)) ? new H(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = go.exec(n)) ? Xt(t[1], t[2], t[3], t[4]) : (t = po.exec(n)) ? Xt(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = _o.exec(n)) ? en(t[1], t[2] / 100, t[3] / 100, 1) : (t = yo.exec(n)) ? en(t[1], t[2] / 100, t[3] / 100, t[4]) : Ge.hasOwnProperty(n) ? Je(Ge[n]) : n === "transparent" ? new H(NaN, NaN, NaN, 0) : null;
}
function Je(n) {
...
function Oe(n, t, e, r) {
  return arguments.length === 1 ? wo(n) : new H(n, t, e, r ?? 1);
}
function H(n, t, e, r) {
...
ze(H, Oe, Yn($t, {
  ...
  clamp() {
    return new H(pt(this.r), pt(this.g), pt(this.b), ee(this.opacity));
  },
  displayable() {
...
ze(W, vo, Yn($t, {
  ...
  clamp() {
    return new W(nn(this.h), Lt(this.s), Lt(this.l), ee(this.opacity));
  },
  displayable() {
  ...
  formatHsl() {
    const n = ee(this.opacity);
    return `${n === 1 ? "hsl(" : "hsla("}${nn(this.h)}, ${Lt(this.s) * 100}%, ${Lt(this.l) * 100}%${n === 1 ? ")" : `, ${n})`}`;
  }
}));
function nn(n) {
...
function Mo(n) {
  return (n = +n) == 1 ? Vn : function(t, e) {
    return e - t ? So(t, e, n) : Bn(isNaN(t) ? e : t);
  };
}
function Vn(n, t) {
  var e = t - n;
  return e ? Oo(n, e) : Bn(isNaN(n) ? t : n);
}
...
function Io(n, t) {
  ...
  for (n = n + "", t = t + ""; (r = Se.exec(n)) && (i = ye.exec(t)); )
    (o = i.index) > e && (o = t.slice(e, o), a[s] ? a[s] += o : a[++s] = o), (r = r[0]) === (i = i[0]) ? a[s] ? a[s] += i : a[++s] = i : (a[++s] = null, c.push({ i: s, x: ct(r, i) })), e = ye.lastIndex;
  return e < t.length && (o = t.slice(e), a[s] ? a[s] += o : a[++s] = o), a.length < 2 ? c[0] ? Eo(c[0].x) : Co(t) : (t = c.length, function(l) {
    for (var h = 0, f; h < t; ++h) a[(f = c[h]).i] = f.x(l);
    return a.join("");
  });
}
var on = 180 / Math.PI, Me = {
  translateX: 0,
  translateY: 0,
  rotate: 0,
  skewX: 0,
...
function Un(n, t, e, r, i, o) {
  ...
  return (s = Math.sqrt(n * n + t * t)) && (n /= s, t /= s), (c = n * e + t * r) && (e -= n * c, r -= t * c), (a = Math.sqrt(e * e + r * r)) && (e /= a, r /= a, c /= a), n * r < t * e && (n = -n, t = -t, c = -c, s = -s), {
    translateX: i,
    translateY: o,
    rotate: Math.atan2(t, n) * on,
    skewX: Math.atan(c) * on,
    scaleX: s,
    scaleY: a
  };
}
...
function Wn(n, t, e, r) {
  ...
  function o(l, h, f, d, _, w) {
    if (l !== f || h !== d) {
      ...
      w.push({ i: M - 4, x: ct(l, f) }, { i: M - 2, x: ct(h, d) });
    } else (f || d) && _.push("translate(" + f + t + d + e);
  }
  function s(l, h, f, d) {
    l !== h ? (l - h > 180 ? h += 360 : h - l > 180 && (l += 360), d.push({ i: f.push(i(f) + "rotate(", null, r) - 2, x: ct(l, h) })) : h && f.push(i(f) + "rotate(" + h + r);
  }
  function a(l, h, f, d) {
    l !== h ? d.push({ i: f.push(i(f) + "skewX(", null, r) - 2, x: ct(l, h) }) : h && f.push(i(f) + "skewX(" + h + r);
  }
...
var To = Wn(ko, "px, ", "px)", "deg)"), Ao = Wn(jo, ", ", ")", ")"), No = 1e-12;
function sn(n) {
  ...
  function i(o, s) {
    ...
    if (M < No)
      ...
      b = (C - S) / t, k = function(E) {
        var N = E * b, R = sn(S), X = l / (e * j) * (R * zo(t * N + S) - Do(S));
        return [
          a + X * _,
          c + X * w,
          l * R / sn(t * N + S)
...
var Mt = 0, kt = 0, Et = 0, qn = 1e3, ne, jt, re = 0, _t = 0, le = 0, Pt = typeof performance == "object" && performance.now ? performance : Date, Gn = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(n) {
  setTimeout(n, 17);
};
function Pe() {
  return _t || (Gn(Ro), _t = Pt.now() + le);
}
function Ro() {
  _t = 0;
}
...
ie.prototype = Kn.prototype = {
  ...
  restart: function(n, t, e) {
    ...
    e = (e == null ? Pe() : +e) + (t == null ? 0 : +t), !this._next && jt !== this && (jt ? jt._next = this : ne = this, jt = this), this._call = n, this._time = e, Ce();
  },
  stop: function() {
...
function Ce(n) {
  if (!Mt) {
    ...
    var t = n - _t;
    t > 24 ? (n < 1 / 0 && (kt = setTimeout(an, n - Pt.now() - le)), Et && (Et = clearInterval(Et))) : (Et || (re = Pt.now(), Et = setInterval(Ho, qn)), Mt = 1, Gn(an));
  }
}
function oe(n, t, e) {
  var r = new ie();
...
var Lo = ae("start", "end", "cancel", "interrupt"), Yo = [], Zn = 0, cn = 1, Ee = 2, Kt = 3, ln = 4, Ie = 5, Zt = 6;
...
function Fo(n, t, e) {
  ...
  function o(l) {
    e.state = cn, e.timer.restart(s, e.delay, e.time), e.delay <= l && s(l - e.delay);
  }
  function s(l) {
    var h, f, d, _;
    if (e.state !== cn) return c();
    for (h in r)
      if (_ = r[h], _.name === e.name) {
        if (_.state === Kt) return oe(s);
        _.state === ln ? (_.state = Zt, _.timer.stop(), _.on.call("interrupt", n, n.__data__, _.index, _.group), delete r[h]) : +h < t && (_.state = Zt, _.timer.stop(), _.on.call("cancel", n, n.__data__, _.index, _.group), delete r[h]);
      }
    if (oe(function() {
      e.state === Kt && (e.state = ln, e.timer.restart(a, e.delay, e.time), a(l));
...
function Wo(n, t) {
  ...
  return this.each((t == null ? Vo : Uo)(e, n, t));
}
function $e(n, t, e) {
  var r = n._id;
...
function Jn(n, t) {
  var e;
  return (typeof t == "number" ? ct : t instanceof zt ? rn : (e = zt(t)) ? (t = e, rn) : Io)(n, t);
}
function qo(n) {
  return function() {
    this.removeAttribute(n);
...
function ts(n, t) {
  var e = ce(n), r = e === "transform" ? Ao : Jn;
  return this.attrTween(n, typeof t == "function" ? (e.local ? Qo : Jo)(e, r, $e(this, "attr." + n, t)) : t == null ? (e.local ? Go : qo)(e) : (e.local ? Zo : Ko)(e, r, t));
}
function es(n, t) {
  return function(e) {
...
function os(n, t) {
  ...
  var r = ce(n);
  return this.tween(e, (r.local ? rs : is)(r, t));
}
function ss(n, t) {
  return function() {
    Re(this, n).delay = +t.apply(this, arguments);
  };
}
function as(n, t) {
  return t = +t, function() {
...
function cs(n) {
  var t = this._id;
  return arguments.length ? this.each((typeof n == "function" ? ss : as)(t, n)) : q(this.node(), t).delay;
}
function ls(n, t) {
  return function() {
...
function ds(n) {
  var t = this._id;
  return arguments.length ? this.each((typeof n == "function" ? ls : hs)(t, n)) : q(this.node(), t).duration;
}
function us(n, t) {
  if (typeof t != "function") throw new Error();
  return function() {
...
function fs(n) {
  var t = this._id;
  return arguments.length ? this.each(us(t, n)) : q(this.node(), t).ease;
}
function gs(n, t) {
  return function() {
    var e = t.apply(this, arguments);
...
function ps(n) {
  ...
  return this.each(gs(this._id, n));
}
function _s(n) {
  typeof n != "function" && (n = jn(n));
  for (var t = this._groups, e = t.length, r = new Array(e), i = 0; i < e; ++i)
...
function ws(n, t) {
  var e = this._id;
  return arguments.length < 2 ? q(this.node(), e).on.on(n) : this.each(bs(e, n, t));
}
function xs(n) {
  return function() {
...
function Ss(n) {
  ...
  return new it(o, s, t, e);
}
var Ms = Rt.prototype.constructor;
function Cs() {
...
function Ts(n, t, e) {
  var r = (n += "") == "transform" ? To : Jn;
  return t == null ? this.styleTween(n, Es(n, r)).on("end.style." + n, Qn(n)) : typeof t == "function" ? this.styleTween(n, ks(n, r, $e(this, "style." + n, t))).each(js(this._id, n)) : this.styleTween(n, Is(n, r, t), e).on("end.style." + n, null);
}
function As(n, t, e) {
  return function(r) {
...
function Rs(n) {
  return this.tween("text", typeof n == "function" ? Ps($e(this, "text", n)) : zs(n == null ? "" : n + ""));
}
function $s(n) {
  return function(t) {
...
function Ls() {
  ...
  return new it(r, this._parents, n, e);
}
function Ys() {
...
function Ws(n) {
  var t, e;
  n instanceof it ? (t = n._id, n = n._name) : (t = tr(), (e = Vs).time = Pe(), n = n == null ? null : n + "");
  for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
    for (var s = r[o], a = s.length, c, l = 0; l < a; ++l)
      (c = s[l]) && he(c, n, t, l, s, e || Us(c, t));
  return new it(r, this._parents, n, t);
}
Rt.prototype.interrupt = Bo;
Rt.prototype.transition = Ws;
const Ft = (n) => () => n;
function qs(n, {
  sourceEvent: t,
  target: e,
...
rt.prototype = {
  constructor: rt,
  scale: function(n) {
    return n === 1 ? this : new rt(this.k * n, this.x, this.y);
  },
  translate: function(n, t) {
    return n === 0 & t === 0 ? this : new rt(this.k, this.x + this.k * n, this.y + this.k * t);
  },
  apply: function(n) {
...
var He = new rt(1, 0, 0);
er.prototype = rt.prototype;
function er(n) {
  for (; !n.__zoom; ) if (!(n = n.parentNode)) return He;
  return n.__zoom;
}
function me(n) {
  n.stopImmediatePropagation();
...
function ta() {
  var n = Gs, t = Ks, e = Qs, r = Zs, i = Js, o = [0, 1 / 0], s = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]], a = 250, c = Po, l = ae("start", "zoom", "end"), h, f, d, _ = 500, w = 150, M = 0, k = 10;
  function b(u) {
    u.property("__zoom", hn).on("wheel.zoom", N, { passive: !1 }).on("mousedown.zoom", R).on("dblclick.zoom", X).filter(i).on("touchstart.zoom", $).on("touchmove.zoom", yt).on("touchend.zoom touchcancel.zoom", mt).style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  b.transform = function(u, y, g, m) {
    var x = u.selection ? u.selection() : u;
    x.property("__zoom", hn), u !== x ? S(u, y, g, m) : x.interrupt().each(function() {
    ...
    b.transform(u, function() {
      ...
      return e(He.translate(I[0], I[1]).scale(O.k).translate(
        typeof y == "function" ? -y.apply(this, arguments) : -y,
        typeof g == "function" ? -g.apply(this, arguments) : -g
      ), v, s);
    }, m, x);
  ...
  function j(u, y) {
    return y = Math.max(o[0], Math.min(o[1], y)), y === u.k ? u : new rt(y, u.x, u.y);
  }
  function T(u, y, g) {
    var m = y[0] - g[0] * u.k, x = y[1] - g[1] * u.k;
    return m === u.x && x === u.y ? u : new rt(u.k, m, x);
  }
  function p(u) {
    ...
    u.on("start.zoom", function() {
      ...
      return function(V) {
        if (V === 1) V = B;
          ...
          var Q = J(V), fe = G / Q[2];
          V = new rt(fe, A[0] - Q[0] * fe, A[1] - Q[1] * fe);
        }
        O.zoom(null, V);
      };
    });
...
}, lt = 10, na = 10, ra = /* @__PURE__ */ new Set([
  // 공용
  "id",
  "type",
  "render",
...
class ia {
  ...
  get(t) {
    return ra.has(t) ? this.data[t] : this.data[`${t}${this._getPostFix()}`] ?? this.data[t];
  }
  _getPostFix() {
...
class Tt {
  ...
  getOrCreate(t) {
    ...
    return e || (e = new dt(() => this.creator(t)), this._map.set(t, e)), e.getOrCreate();
  }
  remove(t) {
...
`) {
    ...
    r.push(i);
    const o = r.join("");
    Xe(o, n).width >= n.width && (e.push(o), r.length = 0);
  }
...
`);
  return {
    ...
    width: t.reduce((e, r) => Math.max(e, Xe(r, n).width), 0)
  };
}, aa = (n, t) => {
  const e = Le(n), r = e.lineHeight * e.length;
  if (t < r) {
...
class Ye {
  ...
  container;
  group;
  _foreignObjMgr = new dt(this._createForeignObj.bind(this));
  _textareaWrapperMgr = new dt(this._createTextareaWrapper.bind(this));
  _textMgr = new dt(this._createText.bind(this));
  constructor(t, e, r) {
    this.data = t, this.className = e, this.containerInterface = r, this.textCache = new or(), this.dataWrapper = new ia(t), this.container = r.getSvg().select(".container"), this.group = this.container.append("g").attr("class", `ir-fw-${t.type}`).attr("data-type", e).attr("data-obj-id", this.data.id), this.data.fontFamily && this.group.style("font-family", this.data.fontFamily);
  }
  get width() {
  ...
  _renderText() {
    ...
    }, r = this.dataWrapper.get("visibleOverText") ? Le(t) : aa(t, this.height - je), i = this._getLabelXY(r), o = {
      text: t.text,
      width: this.width,
      height: this.height,
  ...
  observeProperties() {
    Object.keys(this.data).forEach((t) => {
      ...
      Object.defineProperty(this.data, t, {
        ...
        set: (r) => {
          const i = e;
          e = r, this.data.isMonitoring && (this.containerInterface.observerCallback(new ca(this, t, r, i)), this.render());
        }
      });
    });
  }
...
const la = /translate\((-?[\d.]+),\s*?(-?[\d.]+)\)/, ha = /scale\(([\d.]+),\s*?([\d.]+)\)/, dn = {
  top: 0,
  right: 1,
  bottom: 2,
  left: 3
...
function ya(n, t) {
  switch (_a(n, "fontFamily", t), n.type) {
    case "node": {
      ga(n);
      break;
    }
...
}, wa = (n) => new En(n), pn = (n) => Math.round(n / lt) * lt, _n = ["node.width", "node.height"];
class nt {
...
class Oa {
  ...
  moveStartHandler() {
    ...
    for (const t of this.objectManager.getSelectedObjIterator()) {
      const e = new nt(t.data);
      e.addMoveOldValues(), this.movedInfo.push(e);
    }
  }
  moveEndHandler() {
    this.iContainer.getLogger().debug("MoveHandler.moveEndHandler()", "end"), this.movedInfo.forEach((t) => t.updateMoveNewValues()), this.movedInfo.some((t) => t.propList.some((e) => In(e.oldValue, e.newValue) === !1)) && this.actionController.addAction(new ht(this.movedInfo));
  }
}
const D = {
...
class Sa {
  ...
  resizeDragEnd() {
    this.iContainer.getLogger().debug("ResizeHandler.resizeDragEnd()", "end"), this.resizeInfo.forEach((t) => t.updateSizeNewValues()), this.resizeInfo.some((t) => t.propList.some((e) => In(e.oldValue, e.newValue) === !1)) && this.actionController.addAction(new ht(this.resizeInfo));
  }
...
class Ct extends Ye {
  ...
  _createResizerElement(t) {
    const e = this._getResizerPosition(t), r = F("svg:rect").attr("x", e.x - bt / 2).attr("y", e.y - bt / 2).attr("width", bt).attr("height", bt).attr("fill", "rgb(173, 216, 230)").attr("stroke", "rgb(30, 144, 255)").attr("cursor", t).attr("class", "ir-fw-resizer").classed("ir-fw-active", !0);
...
class Fa extends Ct {
  ...
  _getPath() {
    ...
    return t.push(`M${i} ${o}`), t.push(`L${e - wt} ${o}`), t.push(`L${e},${o + wt}`), t.push(`L${e},${r}`), t.push(`L${i},${r}`), t.push("Z"), t.push(`M${e - wt} ${o}`), t.push(`L${e - (wt + La)} ${o + (wt + Ya)}`), t.push(`L${e} ${o + wt}`), t.join(" ");
  }
  _render() {
...
class fr extends Ye {
  ...
  _renderArrow(t, e) {
    ...
    let T = "";
    if (c === "triangle") {
      const p = h - M * a, S = f - k * a, C = p - M * b, E = S - k * b, N = -k, R = M, X = C + N * j, $ = E + R * j, yt = C - N * j, mt = E - R * j;
      T = `M${p},${S} L${X},${$} L${yt},${mt} Z`;
    } else if (c === "circle") {
  ...
  _getNodePositionLoc(t, e, r) {
    if (t && e) {
      ...
      {
        const o = this._getPosLocation(i, e), s = fa(i.renderer.group.attr("transform"));
        return {
          x: o.x + s.translateX,
          y: o.y + s.translateY
        };
...
class Wa extends fr {
  ...
  _textRectMgr = new dt(() => F("svg:rect"));
  constructor(t, e) {
...
class qa extends fr {
  ...
  */
  ...
  _createAdjustElement(t) {
    return F("svg:rect").attr("width", xt).attr("height", xt).attr("class", "adjuster").attr("cursor", "move");
  }
  _getPos(t, e) {
    const r = {
  ...
  _renderAdjustList(t) {
    ...
    this._adjustMgr.clear(), t.forEach((i, o) => {
      ...
      const a = !r;
      let c = 0, l = 0, h = null;
      r = !r, s.attr("x", i.x - xt / 2).attr("y", i.y - xt / 2).call(at().filter(() => this.containerInterface.getReadOnly() === !1).on("start", (f) => {
        st(f.sourceEvent.target), c = f.x, l = f.y, h = Te(this.data["connection.points"]), this.containerInterface.adjDragStartCallback();
      }).on("drag", (f) => {
        const d = e["connection.points"], _ = d[o + 1];
        if (a) {
          const w = c - f.x;
          _.x -= w, c = f.x, s.attr("x", _.x - xt / 2), o > 0 && (d[o].x -= w / 2), o + 3 < d.length && (d[o + 2].x -= w / 2);
        } else {
          const w = l - f.y;
          _.y -= w, l = f.y, s.attr("y", _.y - xt / 2), o > 0 && (d[o].y -= w / 2), o + 3 < d.length && (d[o + 2].y -= w / 2);
        }
        this._render();
      }).on("end", () => {
        this.containerInterface.adjDragEndCallback(
          this.data,
          h,
          Te(this.data["connection.points"])
        );
      }));
    });
  }
...
class Ga extends Ye {
  _rectMgr = new dt(this._createRectElement);
  _thickRectMgr = new dt(this._createThickRectElement);
  constructor(t, e) {
    super(t, "group", e);
  }
  _render() {
...
const oc = 255, vn = 8, On = 8, we = "ir-style/flowchart", Sn = 0.4, Mn = 3, qt = 5, sc = /* @__PURE__ */ new Set(["isHovered", "isSelected"]), ot = lt;
class yc extends wr {
  _defaultFontFamily;
  _wheelZoom = !0;
  _gridMode = !1;
  ...
  constructor(t) {
    ...
    this._fitSizeMode = s, this._logger = wa(this.uuid.substring(0, 4)), this.keyMap = {
  ...
  _onContextMenu(t) {
    const e = () => {
      ...
      const r = xr("[data-obj-id]", "svg", t.target);
      if (!r) return;
  ...
  _initD3Elements(t, e, r, i) {
    ...
    this.d3Div = Y(t).style("width", o).style("height", s), this.d3Svg = Y(e).on("mousemove", (c) => this._mouseMoveOnSheetHandler(c)).on("click", (c) => this._clickOnSheetHandler(c)).call(at().filter((c) => c.button === 0 && this._editMode === !1).on("start", (c) => {
    ...
    const a = ta().filter((c) => this._wheelZoom && c.type === "wheel" && c.ctrlKey).wheelDelta((c) => -c.deltaY * (c.deltaMode === 1 ? 0.05 : c.deltaMode ? 1 : 2e-3)).scaleExtent([Sn, Mn]).on("zoom", (c) => this.zoomTo(c.transform.k));
  ...
  addLinearGradientDefs(t, e, r, i) {
    ...
    s.id = t, s.setAttribute("gradientTransform", `rotate(${e})`), vr(r, i).forEach(([a, c]) => {
  ...
  recordNewObjectsAction(...t) {
    this._actionController.addAction(new ft(ut(t))), this._updateNegativePos();
  }
  /**
  ...
  editSelectedObjProp(t, e) {
    ...
    for (const i of this._objectManager.getSelectedObjIterator())
      i.isSelected && r.push(new nt(i.data, [
        {
          key: t,
          newValue: e
        }
  ...
  _setZIndexOnSelected(t) {
    ...
    this.emitChangedStatus(), this._actionController.addAction(new ur(e));
  }
  /**
  ...
  _addDragActionOnNode(t) {
    ...
    t.g.call(at().filter((d) => d.button === 0 && this._editMode === !1).on("start", (d) => {
      st(d.sourceEvent.target), this._isSingleSelection(d.sourceEvent.ctrlKey) && !t.isSelected && this.releaseAllObjects(t), e = !1, r = d.x, i = d.y, o = t.width - (t.endX - d.x), s = t.height - (t.endY - d.y), t.select(!1), a = t.x, c = t.y;
    }).on("drag", (d) => {
  ...
  _addDragActionOnConnectionConnector(t, e, r) {
    const i = (o, s, a) => at().filter((c) => c.button === 0 && this._editMode === !1 && this._readonly === !1).on("start", (c) => {
      st(c.sourceEvent.target), this._moveHandler.moveStartHandler(), this._initDrag("drag-con-connector");
    }).on("drag", (c) => {
  ...
  async copyToClipboard(t = "image/png") {
    ...
    const e = await Be(Ve(this.svgElement)), r = await Ue(e, t, this._getFlowchartRect(), vn), i = await mr(r);
    await nc(i);
  }
  _getFlowchartRect() {
  ...
  async getBlob(t = "image/png") {
    const e = await Be(Ve(this.svgElement));
    return await Ue(e, t, this._getFlowchartRect(), vn);
  }
  /**
  ...
  _createPastingObjs(t) {
    ...
    t.objects.forEach((s) => {
      ...
      s.select();
    }), this._actionController.addAction(new ft(ut(o)));
  }
  /**
  ...
  group(t = void 0) {
    ...
    const r = this.add(e);
    r.resize(), r.select(), this._actionController.addAction(new ft(ut([r])));
  }
  /**
  ...
  ungroup() {
    ...
    this._actionController.addAction(new ke(ut(t)));
  }
  ...
  _createAppendObj() {
    switch (this._appendMode.mode) {
      case "append": {
        ...
        this._actionController.addAction(new ft(ut([t])));
        break;
      }
    }
    this.clearAppendMode();
  ...
  changeRender(t, e) {
    ...
    this._changeObjRender(t, e), this._actionController.addAction(new dr(t, r, e));
  }
  ...
  _adjDragEndCallbackHandler(t, e, r) {
    this._logger.debug(
      ...
      new ht([new nt(t, [{ key: "connection.points", oldValue: e, newValue: r }])])
  ...
  _endAppendingConnection() {
    ...
    this._appendMode.dragged === !1 && (t = ma(this._appendingObject));
    const e = this.add({
      ...t,
      id: void 0,
      temp: !1,
    ...
    this._actionController.addAction(new ft(ut([e])));
  }
...
export {
  ea as ActionController,
  Ca as Connection,
  D as EVENT_TYPE,
  Ea as Group,
  yc as IRFlowchart,
  mc as IRFlowchartCommands,
  Na as Node,
  se as POSITION_LIST,
  Fe as RenderObject
};
