...
// src/version.ts
if (true) {
  if (window.__IR_STYLE_VERSION__ && window.__IR_STYLE_VERSION__ !== "1.0.0-rc2.25-dev-8db98b")
    console.warn(`ir-style version collision detected! currently loaded: ${window.__IR_STYLE_VERSION__}, and trying ${"1.0.0-rc2.25-dev-8db98b"}`);
  else
    window.__IR_STYLE_VERSION__ = "1.0.0-rc2.25-dev-8db98b";
}
...
//# sourceMappingURL=chunk-56RD7WBD.js.map
