...
import { v as l } from "./v4-Cgt9uYzN.js";
const r = {}, h = 12, c = [
  "has-both-scroll",
  "has-vertical-scroll",
...
class g {
  ...
  destroy() {
    var t;
    this._coreElements.forEach((e) => e.remove()), this._globalEvents.forEach(([e, s, i, n]) => e.removeEventListener(s, i, n)), (t = this._resizeObserver) == null || t.disconnect(), this.onDestroy(), this._coreElements.length = 0, this._globalEvents.length = 0, this._resizeObserver = void 0, r[this.uuid] = null;
  }
  resizeObserve(t) {
    var e;
  ...
  addGlobalEventListener(t, e, s, i) {
    this._globalEvents.push([t, e, s, i]), t.addEventListener(e, s, i);
  }
  onDestroy() {
  }
  getScrollCls(t, e) {
  ...
  generateScrollBarClass() {
    ...
    c.filter((i) => !s.includes(i)).forEach((i) => this.contextElement.classList.remove(i)), s !== "" && !this.contextElement.classList.contains(s) && this.contextElement.classList.add(s);
  }
  initUUID() {
    if (!this.hasUUID) {
      const t = l().replace(/-/g, "").substring(0, h);
...
//# sourceMappingURL=index-DDbI2a2F.js.map
