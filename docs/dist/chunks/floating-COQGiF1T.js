...
const Gt = ["top", "right", "bottom", "left"], vt = ["start", "end"], yt = /* @__PURE__ */ Gt.reduce((t, e) => t.concat(e, e + "-" + vt[0], e + "-" + vt[1]), []), ot = Math.min, I = Math.max, it = Math.round, et = Math.floor, M = (t) => ({
  x: t,
  y: t
}), Yt = {
  left: "right",
...
const re = function(t) {
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      }).sort((E, _) => E[1] - _[1]), B = ((i = Z.filter((E) => E[2].slice(
        0,
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if (E = [...E, {
        ...
        var _, Q;
        const H = (((_ = l.flip) == null ? void 0 : _.index) || 0) + 1, wt = Z[H];
        if (wt)
          return {
            data: {
              index: H,
...
function ve(t, e) {
  const n = z(t, !0, e === "fixed"), o = n.top + t.clientTop, i = n.left + t.clientLeft, l = C(t) ? $(t) : M(1), r = t.clientWidth * l.x, s = t.clientHeight * l.y, a = i * l.x, c = o * l.y;
  return {
    width: r,
    height: s,
    x: a,
...
function Mt(t, e) {
  const n = V(t);
  return n === e || !S(n) || U(n) ? !1 : T(n).position === "fixed" || Mt(n, e);
}
function ye(t, e) {
  const n = e.get(t);
  if (n)
  ...
  for (; S(r) && !U(r); ) {
    const s = T(r), a = ht(r);
    !a && s.position === "fixed" && (i = null), (l ? !a && !i : !a && s.position === "static" && !!i && ["absolute", "fixed"].includes(i.position) || Y(r) && !a && Mt(t, r)) ? o = o.filter((u) => u !== r) : i = s, r = V(r);
  }
  return e.set(t, o), o;
}
function xe(t) {
...
function Bt(t, e, n, o) {
  ...
  return n(), () => {
    ...
    }), f == null || f(), (m = d) == null || m.disconnect(), d = null, a && cancelAnimationFrame(g);
  };
}
const Ht = ce, Re = re, je = ae, Le = se, It = (t, e, n) => {
...
class Fe {
  constructor(e) {
    this.args = e, this._visible = !1, e.floatingTemplateElement.content.children.length > 1 && console.warn("floatingTemplateElement uses only first child element. others is ignored."), this._cachedElement = e.floatingTemplateElement.content.firstElementChild, this._popoverHandler = _e({
      type: "popover",
...
//# sourceMappingURL=floating-COQGiF1T.js.map
