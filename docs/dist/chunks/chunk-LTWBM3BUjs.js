...
// ../../node_modules/.pnpm/@floating-ui+core@1.2.5/node_modules/@floating-ui/core/dist/floating-ui.core.browser.min.mjs
function t(t2) {
  return t2.split("-")[1];
}
function e(t2) {
...
var r = (t2, e2, n3) => __async(void 0, null, function* () {
  const { placement: o3 = "bottom", strategy: r3 = "absolute", middleware: a3 = [], platform: l3 } = n3, s3 = a3.filter(Boolean), c3 = yield null == l3.isRTL ? void 0 : l3.isRTL(e2);
  let f3 = yield l3.getElementRects({ reference: t2, floating: e2, strategy: r3 }), { x: m3, y: u3 } = i(f3, o3, c3), g3 = o3, d3 = {}, p3 = 0;
  for (let n4 = 0; n4 < s3.length; n4++) {
    const { name: a4, fn: h3 } = s3[n4], { x: y3, y: x3, data: w3, reset: v3 } = yield h3({ x: m3, y: u3, initialPlacement: o3, placement: g3, strategy: r3, middlewareData: d3, rects: f3, platform: l3, elements: { reference: t2, floating: e2 } });
    m3 = null != y3 ? y3 : m3, u3 = null != x3 ? x3 : u3, d3 = __spreadProps(__spreadValues({}, d3), { [a4]: __spreadValues(__spreadValues({}, d3[a4]), w3) }), v3 && p3 <= 50 && (p3++, "object" == typeof v3 && (v3.placement && (g3 = v3.placement), v3.rects && (f3 = true === v3.rects ? yield l3.getElementRects({ reference: t2, floating: e2, strategy: r3 }) : v3.rects), { x: m3, y: u3 } = i(f3, g3, c3)), n4 = -1);
  }
...
function s(t2, e2) {
  return __async(this, null, function* () {
    var n3;
    void 0 === e2 && (e2 = {});
    const { x: o3, y: i3, platform: r3, rects: s3, elements: c3, strategy: f3 } = t2, { boundary: m3 = "clippingAncestors", rootBoundary: u3 = "viewport", elementContext: g3 = "floating", altBoundary: d3 = false, padding: p3 = 0 } = e2, h3 = a(p3), y3 = c3[d3 ? "floating" === g3 ? "reference" : "floating" : g3], x3 = l(yield r3.getClippingRect({ element: null == (n3 = yield null == r3.isElement ? void 0 : r3.isElement(y3)) || n3 ? y3 : y3.contextElement || (yield null == r3.getDocumentElement ? void 0 : r3.getDocumentElement(c3.floating)), boundary: m3, rootBoundary: u3, strategy: f3 })), w3 = "floating" === g3 ? __spreadProps(__spreadValues({}, s3.floating), { x: o3, y: i3 }) : s3.reference, v3 = yield null == r3.getOffsetParent ? void 0 : r3.getOffsetParent(c3.floating), b3 = (yield null == r3.isElement ? void 0 : r3.isElement(v3)) && (yield null == r3.getScale ? void 0 : r3.getScale(v3)) || { x: 1, y: 1 }, A2 = l(r3.convertOffsetParentRelativeRectToViewportRelativeRect ? yield r3.convertOffsetParentRelativeRectToViewportRelativeRect({ rect: w3, offsetParent: v3, strategy: f3 }) : w3);
...
var u = (n3) => ({ name: "arrow", options: n3, fn(i3) {
  return __async(this, null, function* () {
    const { element: r3, padding: l3 = 0 } = n3 || {}, { x: s3, y: c3, placement: f3, rects: u3, platform: g3, elements: d3 } = i3;
    if (null == r3)
      return {};
    const p3 = a(l3), h3 = { x: s3, y: c3 }, y3 = o(f3), x3 = e(y3), w3 = yield g3.getDimensions(r3), v3 = "y" === y3, b3 = v3 ? "top" : "left", A2 = v3 ? "bottom" : "right", R2 = v3 ? "clientHeight" : "clientWidth", P3 = u3.reference[x3] + u3.reference[y3] - h3[y3] - u3.floating[x3], E2 = h3[y3] - u3.reference[y3], T3 = yield null == g3.getOffsetParent ? void 0 : g3.getOffsetParent(r3);
    let D3 = T3 ? T3[R2] : 0;
    D3 && (yield null == g3.isElement ? void 0 : g3.isElement(T3)) || (D3 = d3.floating[R2] || u3.floating[x3]);
...
var b = function(e2) {
  return void 0 === e2 && (e2 = {}), { name: "flip", options: e2, fn(o3) {
    return __async(this, null, function* () {
      var i3;
      const { placement: r3, middlewareData: a3, rects: l3, initialPlacement: c3, platform: f3, elements: m3 } = o3, _a2 = e2, { mainAxis: u3 = true, crossAxis: g3 = true, fallbackPlacements: d3, fallbackStrategy: p3 = "bestFit", fallbackAxisSideDirection: x3 = "none", flipAlignment: v3 = true } = _a2, b3 = __objRest(_a2, ["mainAxis", "crossAxis", "fallbackPlacements", "fallbackStrategy", "fallbackAxisSideDirection", "flipAlignment"]), A2 = n(r3), R2 = n(c3) === c3, P3 = yield null == f3.isRTL ? void 0 : f3.isRTL(m3.floating), E2 = d3 || (R2 || !v3 ? [h(c3)] : function(t2) {
        const e3 = h(t2);
        return [w(t2), e3, w(e3)];
      }(c3));
      ...
      const T3 = [c3, ...E2], D3 = yield s(o3, b3), L3 = [];
  ...
  return void 0 === e2 && (e2 = 0), { name: "offset", options: e2, fn(i3) {
    return __async(this, null, function* () {
      const { x: r3, y: a3 } = i3, l3 = yield function(e3, i4) {
        return __async(this, null, function* () {
          const { placement: r4, platform: a4, elements: l4 } = e3, s3 = yield null == a4.isRTL ? void 0 : a4.isRTL(l4.floating), c3 = n(r4), f3 = t(r4), m3 = "x" === o(r4), u3 = ["left", "top"].includes(c3) ? -1 : 1, g3 = s3 && m3 ? -1 : 1, d3 = "function" == typeof i4 ? i4(e3) : i4;
...
var k = function(t2) {
  return void 0 === t2 && (t2 = {}), { name: "shift", options: t2, fn(e2) {
    return __async(this, null, function* () {
      const { x: i3, y: r3, placement: a3 } = e2, _a2 = t2, { mainAxis: l3 = true, crossAxis: c3 = false, limiter: f3 = { fn: (t3) => {
        let { x: e3, y: n3 } = t3;
        return { x: e3, y: n3 };
      } } } = _a2, u3 = __objRest(_a2, ["mainAxis", "crossAxis", "limiter"]), g3 = { x: i3, y: r3 }, d3 = yield s(e2, u3), p3 = o(n(a3)), h3 = L(p3);
      ...
      const w3 = f3.fn(__spreadProps(__spreadValues({}, e2), { [p3]: y3, [h3]: x3 }));
      return __spreadProps(__spreadValues({}, w3), { data: { x: w3.x - i3, y: w3.y - r3 } });
    });
  } };
};

// ../../node_modules/.pnpm/@floating-ui+dom@1.2.5/node_modules/@floating-ui/dom/dist/floating-ui.dom.browser.min.mjs
function n2(t2) {
  var e2;
...
var O2 = { getClippingRect: function(t2) {
  ...
  return w2(t2);
}, getOffsetParent: H, getDocumentElement: T2, getScale: L2, getElementRects(t2) {
  return __async(this, null, function* () {
    let { reference: e2, floating: n3, strategy: o3 } = t2;
    const i3 = this.getOffsetParent || H, r3 = this.getDimensions;
    return { reference: V(e2, yield i3(n3), o3), floating: __spreadValues({ x: 0, y: 0 }, yield r3(n3)) };
  });
...
var z = (t2, n3, o3) => {
  const i3 = /* @__PURE__ */ new Map(), r3 = __spreadValues({ platform: O2 }, o3), l3 = __spreadProps(__spreadValues({}, r3.platform), { _c: i3 });
...
var offsetBottomAutoUpdate = (refElement, floatingElement) => {
  ...
  return P2(refElement, floatingElement, offsetBottomUpdate);
};
...
var layer_default = __spreadValues({}, layerElements);
...
var createTooltip = (options) => {
  ...
  const cleanUp = P2(refElement, tooltipElement, updateTooltipOffset);
  return {
    destroy: () => {
      hideTooltip();
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LTWBM3BUjs.js.map
