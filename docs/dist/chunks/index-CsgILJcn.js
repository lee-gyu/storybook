import { c as f, o as p, f as g, s as M, a as o, i as I, g as x, b as C, d as b } from "./floating-BiWR08NB.js";
import { c as l } from "./clone-CMP76bLO.js";
import { c as _, a as D, b as y, d as E, e as v, f as N, g as T, h as w, i as L, j as O, k } from "./css-D8WWZA3p.js";
import { c as B } from "./clsx-OuTLNxxd.js";
import { v as A } from "./v4-BiqnG7FB.js";
function h(i) {
...
function R(i) {
  ...
  function t(s) {
    const n = document.createDocumentFragment(), r = o({ tag: "i", className: `${L} ir-icon` }), d = o({ tag: "span", className: O });
    return d.element.textContent = s.label ?? "", r.element.classList.add(s.icon ? s.icon : k.invisible), n.appendChild(r.element), n.appendChild(d.element), n;
  }
  function e(s) {
...
//# sourceMappingURL=index-CsgILJcn.js.map
