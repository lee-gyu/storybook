...
const Yt = ["top", "right", "bottom", "left"], bt = ["start", "end"], Et = /* @__PURE__ */ Yt.reduce((t, e) => t.concat(e, e + "-" + bt[0], e + "-" + bt[1]), []), ot = Math.min, z = Math.max, it = Math.round, et = Math.floor, S = (t) => ({
  x: t,
  y: t
}), Zt = {
  left: "right",
...
async function ht(t, e) {
  ...
  const {
    ...
    altBoundary: m = !1,
    padding: u = 0
  } = Y(e, t), g = oe(u), w = s[m ? f === "floating" ? "reference" : "floating" : f], h = lt(await l.getClippingRect({
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      const {
        ...
        autoAlignment: u = !0,
        ...g
      } = Y(t, e), p = f !== void 0 || m === Et ? re(f || null, u, m) : m, w = await ht(e, g), h = ((n = r.autoPlacement) == null ? void 0 : n.index) || 0, y = p[h];
      if (y == null)
        return {};
      ...
      }).sort((E, F) => E[1] - F[1]), H = ((i = O.filter((E) => E[2].slice(
        0,
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if ((n = l.arrow) != null && n.alignmentOffset)
        return {};
      const h = P(i), y = j(s), v = P(s) === s, b = await (a.isRTL == null ? void 0 : a.isRTL(c.floating)), x = m || (v || !p ? [st(s)] : Qt(s)), D = g !== "none";
      !m && D && x.push(...ee(s, p, g, b));
      const O = [s, ...x], J = await ht(e, w), H = [];
...
const ae = function(t) {
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if (r) {
        const w = f === "y" ? "top" : "left", h = f === "y" ? "bottom" : "right", y = g + d[w], v = g - d[h];
        g = At(y, g, v);
      }
      const p = s.fn({
        ...e,
...
function kt(t) {
  const e = V(t);
  return q(e) ? t.ownerDocument ? t.ownerDocument.body : t.body : T(e) && Z(e) ? e : kt(e);
}
function X(t, e, n) {
  var o;
...
function Bt(t) {
  ...
  const i = T(t), l = i ? t.offsetWidth : n, r = i ? t.offsetHeight : o, s = it(n) !== l || it(o) !== r;
  return s && (n = l, o = r), {
    width: n,
    height: o,
    $: s
...
function N(t, e, n, o) {
  ...
  let r = S(1);
  e && (o ? C(o) && (r = W(o)) : r = W(t));
  const s = he(l, n, o) ? Mt(l) : S(0);
  let a = (i.left + s.x) / r.x, c = (i.top + s.y) / r.y, d = i.width / r.x, f = i.height / r.y;
  if (l) {
    const m = A(l), u = o && C(o) ? A(o) : o;
    let g = m, p = dt(g);
    for (; p && o && u !== g; ) {
      const w = W(p), h = p.getBoundingClientRect(), y = R(p), v = h.left + (p.clientLeft + parseFloat(y.paddingLeft)) * w.x, b = h.top + (p.clientTop + parseFloat(y.paddingTop)) * w.y;
      a *= w.x, c *= w.y, d *= w.x, f *= w.y, a += v, c += b, g = A(p), p = dt(g);
    }
  }
  return lt({
    width: d,
...
function ge(t) {
  ...
  const d = S(0), f = T(o);
  if ((f || !f && !l) && ((K(o) !== "body" || Z(r)) && (a = ft(o)), T(o))) {
    const u = N(o);
    c = W(o), d.x = u.x + o.clientLeft, d.y = u.y + o.clientTop;
  }
  const m = r && !f && !l ? Vt(r, a, !0) : S(0);
  return {
    width: n.width * c.x,
    height: n.height * c.y,
...
function ve(t, e) {
  const n = N(t, !0, e === "fixed"), o = n.top + t.clientTop, i = n.left + t.clientLeft, l = T(t) ? W(t) : S(1), r = t.clientWidth * l.x, s = t.clientHeight * l.y, a = i * l.x, c = o * l.y;
  return {
    width: r,
    height: s,
    x: a,
...
function Ht(t, e) {
  const n = V(t);
  return n === e || !C(n) || q(n) ? !1 : R(n).position === "fixed" || Ht(n, e);
}
function xe(t, e) {
  const n = e.get(t);
  if (n)
  ...
  const l = R(t).position === "fixed";
  let r = l ? V(t) : t;
  for (; C(r) && !q(r); ) {
    const s = R(r), a = gt(r);
    !a && s.position === "fixed" && (i = null), (l ? !a && !i : !a && s.position === "static" && !!i && ["absolute", "fixed"].includes(i.position) || Z(r) && !a && Ht(t, r)) ? o = o.filter((d) => d !== r) : i = s, r = V(r);
  }
  return e.set(t, o), o;
}
function be(t) {
...
function Ae(t, e, n) {
  const o = T(e), i = L(e), l = n === "fixed", r = N(t, !0, l, e);
  let s = {
    scrollLeft: 0,
    scrollTop: 0
  };
  ...
  const c = i && !o && !l ? Vt(i, s) : S(0), d = r.left + s.scrollLeft - a.x - c.x, f = r.top + s.scrollTop - a.y - c.y;
  return {
    x: d,
    y: f,
    width: r.width,
...
function It(t, e) {
  ...
  for (; o && ue(o) && ut(o); )
    o = Tt(o, e);
  return o && q(o) && ut(o) && !gt(o) ? n : o || de(t) || n;
}
...
function Te(t, e) {
  ...
  function r(s, a) {
    ...
    if (s || e(), !m || !u)
      return;
    const g = et(f), p = et(i.clientWidth - (d + m)), w = et(i.clientHeight - (f + u)), h = et(d), v = {
      rootMargin: -g + "px " + -p + "px " + -w + "px " + -h + "px",
...
function Nt(t, e, n, o) {
  ...
  function w() {
    const h = N(t);
    p && !zt(p, h) && n(), p = h, g = requestAnimationFrame(w);
  }
  return n(), () => {
    var h;
    d.forEach((y) => {
