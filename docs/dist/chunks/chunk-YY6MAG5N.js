...
var IRStyleThemeStore = class {
  constructor(config = DEFAULT_VALUE) {
    this.config = config;
  }
  getStoreValue(key) {
...
function getThemeStoreValue(key) {
  return getThemeStore().getStoreValue(key);
}

// src/js-components/_config/index.ts
...
var keyMap = {};
function initDocumentKeyBinding() {
...
var offsetBottomAutoUpdate = (refElement, floatingElement, placement = "bottom") => {
...
//# sourceMappingURL=chunk-YY6MAG5N.js.map
