import { g as N, b as B, x as M, f as O, C as R, y as F, m as U, p as Y, u as $, k as W, a as G, e as j, s as K, c as Z, v as q, l as x, d as z, o as X, t as J } from "./_init-Cv3gCb_1.js";
import { c as H, g as _, o as A } from "./floating-fOdDS7jf.js";
import { I as Q } from "./index-C-Ilyvxg.js";
import { c as ee, a as V, b as P, d as te } from "./rx-state-wgOnLidQ.js";
import { i as T, d as ne } from "./ko-DexDDk13.js";
function S() {
...
function ce() {
  ...
  function d() {
    i.innerHTML = "", i.appendChild(P("ir-icon--check", "button__icon-prefix")), i.append(T.datePicker.btnToday), v.forEach((C) => D[C].innerText = T.common[C]);
  }
}
const le = /* @__PURE__ */ (() => {
  let s = null;
...
})(), L = (s) => (s.setHours(0), s.setMinutes(0), s.setSeconds(0), s.setMilliseconds(0), s), de = 6, ue = 7, he = 32, me = 0, De = ({ uuid: s, refElement: e, onClick: t, minDate: n, maxDate: c }) => {
  let r = !1, h = () => {
  }, m = null;
  L(n), L(c);
  const o = le(), g = V({
    ...
    update(a, u) {
      const v = L(/* @__PURE__ */ new Date()), f = L(new Date(a)), D = f.getMonth();
      ...
      w && i && m == null && (m = te({
        refElement: i,
        label: T.datePicker.disabledTodayTooltip,
        placement: "bottom"
      })), o.updateI18n(), o.headerTitle.innerText = ne(f).format(T.datePicker.titleFormat), f.setDate(1), f.setDate(-(f.getDay() - 1)), o.contentTableTbody.innerHTML = "";
      for (let d = 0; d < de; d++) {
        const C = document.createElement("tr");
        for (let b = 0; b < ue; b++) {
          const I = document.createElement("td"), y = new Date(f);
          I.className = x, I.innerText = `${f.getDate()}`, I.onclick = () => t(y), y < n || y > c ? I.classList.add("is-disabled") : f.getMonth() !== D ? I.classList.add("is-diff-month") : f.getTime() === u?.getTime() && I.classList.add(J), C.appendChild(I), f.setDate(f.getDate() + 1);
        }
...
//# sourceMappingURL=command-manager-VeiVFn1Y.js.map
