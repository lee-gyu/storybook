...
const Xi = A.forwardRef((e, t) => {
  const r = e.items.filter((o) => o.visible !== !1).reduce((o, i) => i.type === "divider" ? (o.dividerBuffer = !0, o.dividerKey = i.id ?? $c(), o) : (o.dividerBuffer && (o.elements.push(cs({ id: o.dividerKey, type: "divider" })), o.dividerBuffer = !1), o.elements.push(cs(i)), o), {
    elements: [],
    dividerBuffer: !1,
    dividerKey: ""
...
function Ip(e) {
  const n = Mc(Tp) === e.uuid, { x: r, y: l, refs: o, strategy: i } = zc({
    ...
    o.floating.current && (e.blurDisabled || (c.relatedTarget === null && e.onHide(), c.relatedTarget instanceof HTMLElement && (c.relatedTarget.closest(`.${Ut.contextMenu["&"]}`) || e.onHide(), o.floating.current.focus())));
  };
...
//# sourceMappingURL=react-components-Ewzo1H7m.js.map
